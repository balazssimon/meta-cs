...
using System.Linq;
using MetaDslx.Compiler.Errors;
...
namespace MetaDslx.Compiler
{
    ...
    public abstract class ParseOptions
    {
        ...
        /// </summary>
        internal abstract void ValidateOptionsCore(ArrayBuilder<Diagnostic> builder);
        ...
        internal void ValidateOptions(ArrayBuilder<Diagnostic> builder)
        {
            ...
            {
                builder.Add(Diagnostic.Create(DefaultDiagnosticDescriptors.ERR_BadSourceCodeKind, Location.None, SpecifiedKind.ToString()));
            }

            if (!DocumentationMode.IsValid())
            {
                builder.Add(Diagnostic.Create(DefaultDiagnosticDescriptors.ERR_BadDocumentationMode, Location.None, DocumentationMode.ToString()));
            }
        }
