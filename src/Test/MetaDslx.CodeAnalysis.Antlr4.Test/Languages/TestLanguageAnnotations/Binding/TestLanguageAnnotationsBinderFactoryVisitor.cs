...
{
    public class TestLanguageAnnotationsBinderFactoryVisitor : BinderFactoryVisitor, ITestLanguageAnnotationsSyntaxVisitor<Binder>
    {
        ...
        public TestLanguageAnnotationsBinderFactoryVisitor(BinderFactory symbolBuilder)
			: base(symbolBuilder)
        {
        ...
        {
            if (unit.Kind == TestLanguageAnnotationsSyntaxKind.Main)
            {
