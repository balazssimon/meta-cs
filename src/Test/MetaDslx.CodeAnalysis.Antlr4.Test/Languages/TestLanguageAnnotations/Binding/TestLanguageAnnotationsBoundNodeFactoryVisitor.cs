...
{
	// Make sure to keep this in sync with TestLanguageAnnotationsIsBindableNodeVisitor
    public class TestLanguageAnnotationsBoundNodeFactoryVisitor : BoundNodeFactoryVisitor, ITestLanguageAnnotationsSyntaxVisitor<ArrayBuilder<object>, BoundNode>
    {
        public TestLanguageAnnotationsBoundNodeFactoryVisitor(BoundTree boundTree)
			: base(boundTree)
        {
