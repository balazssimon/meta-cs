...
{
	public class TestLanguageAnnotationsSyntaxKind : TestLanguageAnnotationsTokensSyntaxKind
	{
        public static new readonly TestLanguageAnnotationsSyntaxKind __FirstToken;
        public static new readonly TestLanguageAnnotationsSyntaxKind __LastToken;
        public static new readonly TestLanguageAnnotationsSyntaxKind __FirstFixedToken;
        public static new readonly TestLanguageAnnotationsSyntaxKind __LastFixedToken;
        public static readonly TestLanguageAnnotationsSyntaxKind __FirstRule;
        public static readonly int __FirstRuleValue;
        public static readonly TestLanguageAnnotationsSyntaxKind __LastRule;
		...
		protected TestLanguageAnnotationsSyntaxKind(string name)
            : base(name)
        {
        }

        protected TestLanguageAnnotationsSyntaxKind(EnumObject retargetedValue)
            : base(retargetedValue)
        {
        }

        static TestLanguageAnnotationsSyntaxKind()
        {
            EnumObject.AutoInit<TestLanguageAnnotationsSyntaxKind>();
        ...
        public static implicit operator TestLanguageAnnotationsSyntaxKind(string name)
        {
            return FromString<TestLanguageAnnotationsSyntaxKind>(name);
        }

        public static explicit operator TestLanguageAnnotationsSyntaxKind(int value)
        {
            return FromIntUnsafe<TestLanguageAnnotationsSyntaxKind>(value);
        }
