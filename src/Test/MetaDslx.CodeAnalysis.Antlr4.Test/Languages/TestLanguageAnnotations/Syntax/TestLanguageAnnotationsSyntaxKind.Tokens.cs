...
{
	public class TestLanguageAnnotationsTokensSyntaxKind : SyntaxKind
	{
        public static readonly TestLanguageAnnotationsTokensSyntaxKind __FirstToken;
        public static readonly int __FirstTokenValue;
        public static readonly TestLanguageAnnotationsTokensSyntaxKind __LastToken;
        public static readonly int __LastTokenValue;
        public static readonly TestLanguageAnnotationsTokensSyntaxKind __FirstFixedToken;
        public static readonly int __FirstFixedTokenValue;
        public static readonly TestLanguageAnnotationsTokensSyntaxKind __LastFixedToken;
		...
		protected TestLanguageAnnotationsTokensSyntaxKind(string name)
            : base(name)
        {
        }

        protected TestLanguageAnnotationsTokensSyntaxKind(EnumObject retargetedValue)
            : base(retargetedValue)
        {
        }

        static TestLanguageAnnotationsTokensSyntaxKind()
        {
            EnumObject.AutoInit<TestLanguageAnnotationsTokensSyntaxKind>();
        ...
        public static implicit operator TestLanguageAnnotationsTokensSyntaxKind(string name)
        {
            return FromString<TestLanguageAnnotationsTokensSyntaxKind>(name);
        }

        public static explicit operator TestLanguageAnnotationsTokensSyntaxKind(int value)
        {
            return FromIntUnsafe<TestLanguageAnnotationsTokensSyntaxKind>(value);
        }
