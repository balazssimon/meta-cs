...
namespace MetaDslx.CodeAnalysis.Antlr4Test.Languages.TestLanguageOne
{
    ...
    /// </summary>
    public abstract partial class TestLangOneSyntaxTree : LanguageSyntaxTree
    {
        internal static readonly TestLangOneSyntaxTree Dummy = new DummySyntaxTree();
        /// <summary>
        /// The options used by the parser to produce the syntax tree.
        /// </summary>
        public new abstract TestLangOneParseOptions Options { get; }
        ...
        /// <summary>
        /// Produces a clone of a <see cref="TestLangOneSyntaxNode"/> which will have current syntax tree as its parent.
        /// 
        /// Caller must guarantee that if the same instance of <see cref="TestLangOneSyntaxNode"/> makes multiple calls
        ...
        protected T CloneNodeAsRoot<T>(T node) where T : TestLangOneSyntaxNode
        {
            return TestLangOneSyntaxNode.CloneNodeAsRoot(node, this);
        }
        /// <summary>
        /// Gets the root node of the syntax tree.
        /// </summary>
        public new abstract TestLangOneSyntaxNode GetRoot(CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets the root node of the syntax tree if it is already available.
        /// </summary>
        public abstract bool TryGetRoot(out TestLangOneSyntaxNode root);
        /// <summary>
        ...
        /// </remarks>
        public new virtual Task<TestLangOneSyntaxNode> GetRootAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            TestLangOneSyntaxNode node;
        ...
        /// </summary>
        public static TestLangOneSyntaxTree Create(TestLangOneSyntaxNode root, TestLangOneParseOptions options = null, string path = "", SourceText text = null, Encoding encoding = null, SourceHashAlgorithm checksumAlgorithm = SourceHashAlgorithm.Sha1)
        {
            if (root == null)
            {
                throw new ArgumentNullException(nameof(root));
            }
            var directives = root.Kind == TestLangOneSyntaxKind.Main && root is ICompilationUnitRootSyntax compilationUnitRoot ?
        ...
        internal static TestLangOneSyntaxTree CreateForDebugger(TestLangOneSyntaxNode root, SourceText text, TestLangOneParseOptions options)
        {
        ...
        /// <summary>
        /// <para>
        /// Internal helper for <see cref="TestLangOneSyntaxNode"/> class to create a new syntax tree rooted at the given root node.
        /// This method does not create a clone of the given root, but instead preserves it's reference identity.
        /// </para>
        /// <para>NOTE: This method is only intended to be used from <see cref="TestLangOneSyntaxNode.SyntaxTree"/> property.</para>
        /// <para>NOTE: Do not use this method elsewhere, instead use <see cref="Create(TestLangOneSyntaxNode, CSharpParseOptions, string, Encoding)"/> method for creating a syntax tree.</para>
        /// </summary>
        internal static TestLangOneSyntaxTree CreateWithoutClone(TestLangOneSyntaxNode root)
        {
            Debug.Assert(root != null);
            return new ParsedSyntaxTree(
                textOpt: null,
                ...
                path: "",
                options: TestLangOneParseOptions.Default,
                root: root,
        ...
        /// </summary>
        public static TestLangOneSyntaxTree ParseText(
            string text,
        ...
        #endregion
        internal sealed class DummySyntaxTree : TestLangOneSyntaxTree
        {
            private readonly TestLangOneSyntaxNode _node;
            ...
            public override TestLangOneParseOptions Options
            {
                get { return TestLangOneParseOptions.Default; }
            }
            ...
            public override TestLangOneSyntaxNode GetRoot(CancellationToken cancellationToken)
            {
                return _node;
            }
            public override bool TryGetRoot(out TestLangOneSyntaxNode root)
            {
                root = _node;
                return true;
            }
            ...
            {
                return TestLangOneLanguage.Instance.SyntaxFactory.SyntaxTree((LanguageSyntaxNode)root, options: (TestLangOneParseOptions)options, path: FilePath, encoding: null);
            }
            public override SyntaxTree WithFilePath(string path)
            {
                return TestLangOneLanguage.Instance.SyntaxFactory.SyntaxTree(_node, options: this.Options, path: path, encoding: null);
            }
        }
        private class ParsedSyntaxTree : TestLangOneSyntaxTree
        {
            private readonly TestLangOneParseOptions _options;
            private readonly string _path;
            private readonly TestLangOneSyntaxNode _root;
            private readonly bool _hasCompilationUnitRoot;
            private readonly Encoding _encodingOpt;
            private readonly SourceHashAlgorithm _checksumAlgorithm;
            private SourceText _lazyText;
            internal ParsedSyntaxTree(SourceText textOpt, Encoding encodingOpt, SourceHashAlgorithm checksumAlgorithm, string path, TestLangOneParseOptions options, TestLangOneSyntaxNode root, DirectiveStack directives, bool cloneRoot = true)
            {
                Debug.Assert(root != null);
                ...
                _hasCompilationUnitRoot = root.Kind == TestLangOneSyntaxKind.Main;
        ...
        {
            public DebuggerSyntaxTree(TestLangOneSyntaxNode root, SourceText text, TestLangOneParseOptions options)
                : base(
                    text,
                    text.Encoding,
