...
namespace MetaDslx.CodeAnalysis.Antlr4.Test.Language.TestLanguageOne.Syntax
{
    ...
    {
        protected TestLangOneSyntaxNode(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
            : base(green, syntaxTree, position)
        {
        }

        protected TestLangOneSyntaxNode(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
        ...
        {
            return TestLangOneSyntaxTree.CreateWithoutClone(this);
        }

        public override TResult Accept<TArg, TResult>(SyntaxVisitor<TArg, TResult> visitor, TArg argument)
        {
            if (visitor is ITestLangOneSyntaxVisitor<TArg, TResult> typedVisitor) return this.Accept(typedVisitor, argument);
            else return visitor.DefaultVisit(this, argument);
        }

        public abstract TResult Accept<TArg, TResult>(ITestLangOneSyntaxVisitor<TArg, TResult> visitor, TArg argument);

        public override TResult Accept<TResult>(SyntaxVisitor<TResult> visitor)
        {
            if (visitor is ITestLangOneSyntaxVisitor<TResult> typedVisitor) return this.Accept(typedVisitor);
            else return visitor.DefaultVisit(this);
        }

        public abstract TResult Accept<TResult>(ITestLangOneSyntaxVisitor<TResult> visitor);

        public override void Accept(SyntaxVisitor visitor)
        {
            if (visitor is ITestLangOneSyntaxVisitor typedVisitor) this.Accept(typedVisitor);
            else visitor.DefaultVisit(this);
        }
        public abstract void Accept(ITestLangOneSyntaxVisitor visitor);
    }

	
	public sealed class MainSyntax : TestLangOneSyntaxNode, ICompilationUnitSyntax
	{
	    private SyntaxNode test;
	
	    public MainSyntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public MainSyntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public MainSyntax Update(SyntaxList<TestSyntax> test, SyntaxToken eOF)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Main(test, eOF);
	    ...
	    public override TResult Accept<TArg, TResult>(ITestLangOneSyntaxVisitor<TArg, TResult> visitor, TArg argument)
	    {
	        return visitor.VisitMain(this, argument);
	    }
	
	    public override TResult Accept<TResult>(ITestLangOneSyntaxVisitor<TResult> visitor)
	    {
	        return visitor.VisitMain(this);
	    }
	
	    public override void Accept(ITestLangOneSyntaxVisitor visitor)
	    {
	        visitor.VisitMain(this);
	    }
	}
	
	public sealed class TestSyntax : TestLangOneSyntaxNode
	{
	    ...
	    public TestSyntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public TestSyntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public TestSyntax Update(Test01Syntax test01)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test(test01);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public TestSyntax Update(Test02Syntax test02)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test(test02);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (TestSyntax)newNode;
	    ...
	    public TestSyntax Update(Test03Syntax test03)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test(test03);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (TestSyntax)newNode;
	    ...
	    public TestSyntax Update(Test04Syntax test04)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test(test04);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (TestSyntax)newNode;
	    ...
	    public TestSyntax Update(Test05Syntax test05)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test(test05);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (TestSyntax)newNode;
	    ...
	    public TestSyntax Update(Test06Syntax test06)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test(test06);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (TestSyntax)newNode;
	    ...
	    public TestSyntax Update(Test07Syntax test07)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test(test07);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (TestSyntax)newNode;
	    ...
	    public TestSyntax Update(Test08Syntax test08)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test(test08);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (TestSyntax)newNode;
	    ...
	    public TestSyntax Update(Test09Syntax test09)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test(test09);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (TestSyntax)newNode;
	    ...
	    public TestSyntax Update(Test10Syntax test10)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test(test10);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (TestSyntax)newNode;
	    ...
	    public TestSyntax Update(Test11Syntax test11)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test(test11);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (TestSyntax)newNode;
	...
	public sealed class Test01Syntax : TestLangOneSyntaxNode
	{
	    private NamespaceDeclaration01Syntax namespaceDeclaration01;
	
	    public Test01Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Test01Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Test01Syntax Update(SyntaxToken kTest01, NamespaceDeclaration01Syntax namespaceDeclaration01)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test01(kTest01, namespaceDeclaration01);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceDeclaration01Syntax : TestLangOneSyntaxNode
	{
	    private QualifiedNameSyntax qualifiedName;
	    private NamespaceBody01Syntax namespaceBody01;
	
	    public NamespaceDeclaration01Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceDeclaration01Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceDeclaration01Syntax Update(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody01Syntax namespaceBody01)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceDeclaration01(kNamespace, qualifiedName, namespaceBody01);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceBody01Syntax : TestLangOneSyntaxNode
	{
	    private SyntaxNode declaration01;
	
	    public NamespaceBody01Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceBody01Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceBody01Syntax Update(SyntaxToken tOpenBrace, SyntaxList<Declaration01Syntax> declaration01, SyntaxToken tCloseBrace)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceBody01(tOpenBrace, declaration01, tCloseBrace);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Declaration01Syntax : TestLangOneSyntaxNode
	{
	    private Vertex01Syntax vertex01;
	    private Arrow01Syntax arrow01;
	
	    public Declaration01Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Declaration01Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Declaration01Syntax Update(Vertex01Syntax vertex01)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration01(vertex01);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public Declaration01Syntax Update(Arrow01Syntax arrow01)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration01(arrow01);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (Declaration01Syntax)newNode;
	...
	public sealed class Vertex01Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Vertex01Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Vertex01Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Vertex01Syntax Update(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Vertex01(kVertex, name, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Arrow01Syntax : TestLangOneSyntaxNode
	{
	    private QualifierSyntax source;
	    private QualifierSyntax target;
	
	    public Arrow01Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Arrow01Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Arrow01Syntax Update(SyntaxToken kArrow, QualifierSyntax source, SyntaxToken tArrow, QualifierSyntax target, SyntaxToken tSemicolon)
	    {
	        if (this.KArrow != kArrow ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Arrow01(kArrow, source, tArrow, target, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Test02Syntax : TestLangOneSyntaxNode
	{
	    private NamespaceDeclaration02Syntax namespaceDeclaration02;
	
	    public Test02Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Test02Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Test02Syntax Update(SyntaxToken kTest02, NamespaceDeclaration02Syntax namespaceDeclaration02)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test02(kTest02, namespaceDeclaration02);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceDeclaration02Syntax : TestLangOneSyntaxNode
	{
	    private QualifiedNameSyntax qualifiedName;
	    private NamespaceBody02Syntax namespaceBody02;
	
	    public NamespaceDeclaration02Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceDeclaration02Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceDeclaration02Syntax Update(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody02Syntax namespaceBody02)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceDeclaration02(kNamespace, qualifiedName, namespaceBody02);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceBody02Syntax : TestLangOneSyntaxNode
	{
	    private SyntaxNode declaration02;
	
	    public NamespaceBody02Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceBody02Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceBody02Syntax Update(SyntaxToken tOpenBrace, SyntaxList<Declaration02Syntax> declaration02, SyntaxToken tCloseBrace)
	    {
	        if (this.TOpenBrace != tOpenBrace ||
				...
				this.TCloseBrace != tCloseBrace)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceBody02(tOpenBrace, declaration02, tCloseBrace);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Declaration02Syntax : TestLangOneSyntaxNode
	{
	    private Vertex02Syntax vertex02;
	    private Arrow02Syntax arrow02;
	
	    public Declaration02Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Declaration02Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Declaration02Syntax Update(Vertex02Syntax vertex02)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration02(vertex02);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public Declaration02Syntax Update(Arrow02Syntax arrow02)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration02(arrow02);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (Declaration02Syntax)newNode;
	...
	public sealed class Vertex02Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Vertex02Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Vertex02Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Vertex02Syntax Update(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
	    {
	        if (this.KVertex != kVertex ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Vertex02(kVertex, name, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Arrow02Syntax : TestLangOneSyntaxNode
	{
	    private Source02Syntax source02;
	    private Target02Syntax target02;
	
	    public Arrow02Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Arrow02Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Arrow02Syntax Update(SyntaxToken kArrow, Source02Syntax source02, SyntaxToken tArrow, Target02Syntax target02, SyntaxToken tSemicolon)
	    {
	        if (this.KArrow != kArrow ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Arrow02(kArrow, source02, tArrow, target02, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Source02Syntax : TestLangOneSyntaxNode
	{
	    private QualifierSyntax qualifier;
	
	    public Source02Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Source02Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Source02Syntax Update(QualifierSyntax qualifier)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Source02(qualifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Target02Syntax : TestLangOneSyntaxNode
	{
	    private QualifierSyntax qualifier;
	
	    public Target02Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Target02Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Target02Syntax Update(QualifierSyntax qualifier)
	    {
	        if (this.Qualifier != qualifier)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Target02(qualifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Test03Syntax : TestLangOneSyntaxNode
	{
	    private NamespaceDeclaration03Syntax namespaceDeclaration03;
	
	    public Test03Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Test03Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Test03Syntax Update(SyntaxToken kTest03, NamespaceDeclaration03Syntax namespaceDeclaration03)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test03(kTest03, namespaceDeclaration03);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceDeclaration03Syntax : TestLangOneSyntaxNode
	{
	    private QualifiedNameSyntax qualifiedName;
	    private NamespaceBody03Syntax namespaceBody03;
	
	    public NamespaceDeclaration03Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceDeclaration03Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceDeclaration03Syntax Update(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody03Syntax namespaceBody03)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceDeclaration03(kNamespace, qualifiedName, namespaceBody03);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceBody03Syntax : TestLangOneSyntaxNode
	{
	    private SyntaxNode declaration03;
	
	    public NamespaceBody03Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceBody03Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceBody03Syntax Update(SyntaxToken tOpenBrace, SyntaxList<Declaration03Syntax> declaration03, SyntaxToken tCloseBrace)
	    {
	        if (this.TOpenBrace != tOpenBrace ||
				...
				this.TCloseBrace != tCloseBrace)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceBody03(tOpenBrace, declaration03, tCloseBrace);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Declaration03Syntax : TestLangOneSyntaxNode
	{
	    private Vertex03Syntax vertex03;
	    private Arrow03Syntax arrow03;
	
	    public Declaration03Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Declaration03Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Declaration03Syntax Update(Vertex03Syntax vertex03)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration03(vertex03);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public Declaration03Syntax Update(Arrow03Syntax arrow03)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration03(arrow03);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (Declaration03Syntax)newNode;
	...
	public sealed class Vertex03Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Vertex03Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Vertex03Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Vertex03Syntax Update(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
	    {
	        if (this.KVertex != kVertex ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Vertex03(kVertex, name, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Arrow03Syntax : TestLangOneSyntaxNode
	{
	    private Source03Syntax source03;
	    private Target03Syntax target03;
	
	    public Arrow03Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Arrow03Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Arrow03Syntax Update(SyntaxToken kArrow, Source03Syntax source03, SyntaxToken tArrow, Target03Syntax target03, SyntaxToken tSemicolon)
	    {
	        if (this.KArrow != kArrow ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Arrow03(kArrow, source03, tArrow, target03, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Source03Syntax : TestLangOneSyntaxNode
	{
	    private QualifierSyntax qualifier;
	
	    public Source03Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Source03Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Source03Syntax Update(QualifierSyntax qualifier)
	    {
	        if (this.Qualifier != qualifier)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Source03(qualifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Target03Syntax : TestLangOneSyntaxNode
	{
	    private QualifierSyntax qualifier;
	
	    public Target03Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Target03Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Target03Syntax Update(QualifierSyntax qualifier)
	    {
	        if (this.Qualifier != qualifier)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Target03(qualifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Test04Syntax : TestLangOneSyntaxNode
	{
	    private NamespaceDeclaration04Syntax namespaceDeclaration04;
	
	    public Test04Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Test04Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Test04Syntax Update(SyntaxToken kTest04, NamespaceDeclaration04Syntax namespaceDeclaration04)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test04(kTest04, namespaceDeclaration04);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceDeclaration04Syntax : TestLangOneSyntaxNode
	{
	    private QualifiedNameSyntax qualifiedName;
	    private NamespaceBody04Syntax namespaceBody04;
	
	    public NamespaceDeclaration04Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceDeclaration04Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceDeclaration04Syntax Update(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody04Syntax namespaceBody04)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceDeclaration04(kNamespace, qualifiedName, namespaceBody04);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceBody04Syntax : TestLangOneSyntaxNode
	{
	    private SyntaxNode declaration04;
	
	    public NamespaceBody04Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceBody04Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceBody04Syntax Update(SyntaxToken tOpenBrace, SyntaxList<Declaration04Syntax> declaration04, SyntaxToken tCloseBrace)
	    {
	        if (this.TOpenBrace != tOpenBrace ||
				...
				this.TCloseBrace != tCloseBrace)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceBody04(tOpenBrace, declaration04, tCloseBrace);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Declaration04Syntax : TestLangOneSyntaxNode
	{
	    private Vertex04Syntax vertex04;
	    private Arrow04Syntax arrow04;
	
	    public Declaration04Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Declaration04Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Declaration04Syntax Update(Vertex04Syntax vertex04)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration04(vertex04);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public Declaration04Syntax Update(Arrow04Syntax arrow04)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration04(arrow04);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (Declaration04Syntax)newNode;
	...
	public sealed class Vertex04Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Vertex04Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Vertex04Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Vertex04Syntax Update(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
	    {
	        if (this.KVertex != kVertex ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Vertex04(kVertex, name, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Arrow04Syntax : TestLangOneSyntaxNode
	{
	    private QualifierSyntax source;
	    private QualifierSyntax target;
	
	    public Arrow04Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Arrow04Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Arrow04Syntax Update(SyntaxToken kArrow, QualifierSyntax source, SyntaxToken tArrow, QualifierSyntax target, SyntaxToken tSemicolon)
	    {
	        if (this.KArrow != kArrow ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Arrow04(kArrow, source, tArrow, target, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Test05Syntax : TestLangOneSyntaxNode
	{
	    private NamespaceDeclaration05Syntax namespaceDeclaration05;
	
	    public Test05Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Test05Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Test05Syntax Update(SyntaxToken kTest05, NamespaceDeclaration05Syntax namespaceDeclaration05)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test05(kTest05, namespaceDeclaration05);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceDeclaration05Syntax : TestLangOneSyntaxNode
	{
	    private QualifiedNameSyntax qualifiedName;
	    private NamespaceBody05Syntax namespaceBody05;
	
	    public NamespaceDeclaration05Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceDeclaration05Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceDeclaration05Syntax Update(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody05Syntax namespaceBody05)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceDeclaration05(kNamespace, qualifiedName, namespaceBody05);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceBody05Syntax : TestLangOneSyntaxNode
	{
	    private SyntaxNode declaration05;
	
	    public NamespaceBody05Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceBody05Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceBody05Syntax Update(SyntaxToken tOpenBrace, SyntaxList<Declaration05Syntax> declaration05, SyntaxToken tCloseBrace)
	    {
	        if (this.TOpenBrace != tOpenBrace ||
				...
				this.TCloseBrace != tCloseBrace)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceBody05(tOpenBrace, declaration05, tCloseBrace);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Declaration05Syntax : TestLangOneSyntaxNode
	{
	    private Vertex05Syntax vertex05;
	    private Arrow05Syntax arrow05;
	
	    public Declaration05Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Declaration05Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Declaration05Syntax Update(Vertex05Syntax vertex05)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration05(vertex05);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public Declaration05Syntax Update(Arrow05Syntax arrow05)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration05(arrow05);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (Declaration05Syntax)newNode;
	...
	public sealed class Vertex05Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Vertex05Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Vertex05Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Vertex05Syntax Update(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
	    {
	        if (this.KVertex != kVertex ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Vertex05(kVertex, name, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Arrow05Syntax : TestLangOneSyntaxNode
	{
	    private QualifierSyntax source;
	    private QualifierSyntax target;
	
	    public Arrow05Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Arrow05Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Arrow05Syntax Update(SyntaxToken kArrow, QualifierSyntax source, SyntaxToken tArrow, QualifierSyntax target, SyntaxToken tSemicolon)
	    {
	        if (this.KArrow != kArrow ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Arrow05(kArrow, source, tArrow, target, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Test06Syntax : TestLangOneSyntaxNode
	{
	    private NamespaceDeclaration06Syntax namespaceDeclaration06;
	
	    public Test06Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Test06Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Test06Syntax Update(SyntaxToken kTest06, NamespaceDeclaration06Syntax namespaceDeclaration06)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test06(kTest06, namespaceDeclaration06);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceDeclaration06Syntax : TestLangOneSyntaxNode
	{
	    private QualifiedNameSyntax qualifiedName;
	    private NamespaceBody06Syntax namespaceBody06;
	
	    public NamespaceDeclaration06Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceDeclaration06Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceDeclaration06Syntax Update(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody06Syntax namespaceBody06)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceDeclaration06(kNamespace, qualifiedName, namespaceBody06);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceBody06Syntax : TestLangOneSyntaxNode
	{
	    private SyntaxNode declaration06;
	
	    public NamespaceBody06Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceBody06Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceBody06Syntax Update(SyntaxToken tOpenBrace, SyntaxList<Declaration06Syntax> declaration06, SyntaxToken tCloseBrace)
	    {
	        if (this.TOpenBrace != tOpenBrace ||
				...
				this.TCloseBrace != tCloseBrace)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceBody06(tOpenBrace, declaration06, tCloseBrace);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Declaration06Syntax : TestLangOneSyntaxNode
	{
	    private Vertex06Syntax vertex06;
	    private Arrow06Syntax arrow06;
	
	    public Declaration06Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Declaration06Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Declaration06Syntax Update(Vertex06Syntax vertex06)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration06(vertex06);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public Declaration06Syntax Update(Arrow06Syntax arrow06)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration06(arrow06);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (Declaration06Syntax)newNode;
	...
	public sealed class Vertex06Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Vertex06Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Vertex06Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Vertex06Syntax Update(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
	    {
	        if (this.KVertex != kVertex ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Vertex06(kVertex, name, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Arrow06Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax source;
	    private NameSyntax target;
	
	    public Arrow06Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Arrow06Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Arrow06Syntax Update(SyntaxToken kArrow, NameSyntax source, SyntaxToken tArrow, NameSyntax target, SyntaxToken tSemicolon)
	    {
	        if (this.KArrow != kArrow ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Arrow06(kArrow, source, tArrow, target, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Test07Syntax : TestLangOneSyntaxNode
	{
	    private NamespaceDeclaration07Syntax namespaceDeclaration07;
	
	    public Test07Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Test07Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Test07Syntax Update(SyntaxToken kTest07, NamespaceDeclaration07Syntax namespaceDeclaration07)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test07(kTest07, namespaceDeclaration07);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceDeclaration07Syntax : TestLangOneSyntaxNode
	{
	    private QualifiedNameSyntax qualifiedName;
	    private NamespaceBody07Syntax namespaceBody07;
	
	    public NamespaceDeclaration07Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceDeclaration07Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceDeclaration07Syntax Update(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody07Syntax namespaceBody07)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceDeclaration07(kNamespace, qualifiedName, namespaceBody07);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceBody07Syntax : TestLangOneSyntaxNode
	{
	    private SyntaxNode declaration07;
	
	    public NamespaceBody07Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceBody07Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceBody07Syntax Update(SyntaxToken tOpenBrace, SyntaxList<Declaration07Syntax> declaration07, SyntaxToken tCloseBrace)
	    {
	        if (this.TOpenBrace != tOpenBrace ||
				...
				this.TCloseBrace != tCloseBrace)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceBody07(tOpenBrace, declaration07, tCloseBrace);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Declaration07Syntax : TestLangOneSyntaxNode
	{
	    private Vertex07Syntax vertex07;
	    private Arrow07Syntax arrow07;
	
	    public Declaration07Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Declaration07Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Declaration07Syntax Update(Vertex07Syntax vertex07)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration07(vertex07);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public Declaration07Syntax Update(Arrow07Syntax arrow07)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration07(arrow07);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (Declaration07Syntax)newNode;
	...
	public sealed class Vertex07Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Vertex07Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Vertex07Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Vertex07Syntax Update(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
	    {
	        if (this.KVertex != kVertex ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Vertex07(kVertex, name, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Arrow07Syntax : TestLangOneSyntaxNode
	{
	    private Source07Syntax source07;
	    private Target07Syntax target07;
	
	    public Arrow07Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Arrow07Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Arrow07Syntax Update(SyntaxToken kArrow, Source07Syntax source07, SyntaxToken tArrow, Target07Syntax target07, SyntaxToken tSemicolon)
	    {
	        if (this.KArrow != kArrow ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Arrow07(kArrow, source07, tArrow, target07, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Source07Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Source07Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Source07Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Source07Syntax Update(NameSyntax name)
	    {
	        if (this.Name != name)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Source07(name);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Target07Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Target07Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Target07Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Target07Syntax Update(NameSyntax name)
	    {
	        if (this.Name != name)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Target07(name);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Test08Syntax : TestLangOneSyntaxNode
	{
	    private NamespaceDeclaration08Syntax namespaceDeclaration08;
	
	    public Test08Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Test08Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Test08Syntax Update(SyntaxToken kTest08, NamespaceDeclaration08Syntax namespaceDeclaration08)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test08(kTest08, namespaceDeclaration08);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceDeclaration08Syntax : TestLangOneSyntaxNode
	{
	    private QualifiedNameSyntax qualifiedName;
	    private NamespaceBody08Syntax namespaceBody08;
	
	    public NamespaceDeclaration08Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceDeclaration08Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceDeclaration08Syntax Update(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody08Syntax namespaceBody08)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceDeclaration08(kNamespace, qualifiedName, namespaceBody08);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceBody08Syntax : TestLangOneSyntaxNode
	{
	    private SyntaxNode declaration08;
	
	    public NamespaceBody08Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceBody08Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceBody08Syntax Update(SyntaxToken tOpenBrace, SyntaxList<Declaration08Syntax> declaration08, SyntaxToken tCloseBrace)
	    {
	        if (this.TOpenBrace != tOpenBrace ||
				...
				this.TCloseBrace != tCloseBrace)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceBody08(tOpenBrace, declaration08, tCloseBrace);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Declaration08Syntax : TestLangOneSyntaxNode
	{
	    private Vertex08Syntax vertex08;
	    private Arrow08Syntax arrow08;
	
	    public Declaration08Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Declaration08Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Declaration08Syntax Update(Vertex08Syntax vertex08)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration08(vertex08);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public Declaration08Syntax Update(Arrow08Syntax arrow08)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration08(arrow08);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (Declaration08Syntax)newNode;
	...
	public sealed class Vertex08Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Vertex08Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Vertex08Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Vertex08Syntax Update(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
	    {
	        if (this.KVertex != kVertex ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Vertex08(kVertex, name, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Arrow08Syntax : TestLangOneSyntaxNode
	{
	    private Source08Syntax source08;
	    private Target08Syntax target08;
	
	    public Arrow08Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Arrow08Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Arrow08Syntax Update(SyntaxToken kArrow, Source08Syntax source08, SyntaxToken tArrow, Target08Syntax target08, SyntaxToken tSemicolon)
	    {
	        if (this.KArrow != kArrow ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Arrow08(kArrow, source08, tArrow, target08, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Source08Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Source08Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Source08Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Source08Syntax Update(NameSyntax name)
	    {
	        if (this.Name != name)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Source08(name);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Target08Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Target08Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Target08Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Target08Syntax Update(NameSyntax name)
	    {
	        if (this.Name != name)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Target08(name);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Test09Syntax : TestLangOneSyntaxNode
	{
	    private NamespaceDeclaration09Syntax namespaceDeclaration09;
	
	    public Test09Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Test09Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Test09Syntax Update(SyntaxToken kTest09, NamespaceDeclaration09Syntax namespaceDeclaration09)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test09(kTest09, namespaceDeclaration09);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceDeclaration09Syntax : TestLangOneSyntaxNode
	{
	    private QualifiedNameSyntax qualifiedName;
	    private NamespaceBody09Syntax namespaceBody09;
	
	    public NamespaceDeclaration09Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceDeclaration09Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceDeclaration09Syntax Update(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody09Syntax namespaceBody09)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceDeclaration09(kNamespace, qualifiedName, namespaceBody09);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceBody09Syntax : TestLangOneSyntaxNode
	{
	    private SyntaxNode declaration09;
	
	    public NamespaceBody09Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceBody09Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceBody09Syntax Update(SyntaxToken tOpenBrace, SyntaxList<Declaration09Syntax> declaration09, SyntaxToken tCloseBrace)
	    {
	        if (this.TOpenBrace != tOpenBrace ||
				...
				this.TCloseBrace != tCloseBrace)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceBody09(tOpenBrace, declaration09, tCloseBrace);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Declaration09Syntax : TestLangOneSyntaxNode
	{
	    private Vertex09Syntax vertex09;
	    private Arrow09Syntax arrow09;
	
	    public Declaration09Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Declaration09Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Declaration09Syntax Update(Vertex09Syntax vertex09)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration09(vertex09);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public Declaration09Syntax Update(Arrow09Syntax arrow09)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration09(arrow09);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (Declaration09Syntax)newNode;
	...
	public sealed class Vertex09Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Vertex09Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Vertex09Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Vertex09Syntax Update(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
	    {
	        if (this.KVertex != kVertex ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Vertex09(kVertex, name, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Arrow09Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax source;
	    private NameSyntax target;
	
	    public Arrow09Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Arrow09Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Arrow09Syntax Update(SyntaxToken kArrow, NameSyntax source, SyntaxToken tArrow, NameSyntax target, SyntaxToken tSemicolon)
	    {
	        if (this.KArrow != kArrow ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Arrow09(kArrow, source, tArrow, target, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Test10Syntax : TestLangOneSyntaxNode
	{
	    private NamespaceDeclaration10Syntax namespaceDeclaration10;
	
	    public Test10Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Test10Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Test10Syntax Update(SyntaxToken kTest10, NamespaceDeclaration10Syntax namespaceDeclaration10)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test10(kTest10, namespaceDeclaration10);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceDeclaration10Syntax : TestLangOneSyntaxNode
	{
	    private QualifiedNameSyntax qualifiedName;
	    private NamespaceBody10Syntax namespaceBody10;
	
	    public NamespaceDeclaration10Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceDeclaration10Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceDeclaration10Syntax Update(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody10Syntax namespaceBody10)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceDeclaration10(kNamespace, qualifiedName, namespaceBody10);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceBody10Syntax : TestLangOneSyntaxNode
	{
	    private SyntaxNode declaration10;
	
	    public NamespaceBody10Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceBody10Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceBody10Syntax Update(SyntaxToken tOpenBrace, SyntaxList<Declaration10Syntax> declaration10, SyntaxToken tCloseBrace)
	    {
	        if (this.TOpenBrace != tOpenBrace ||
				...
				this.TCloseBrace != tCloseBrace)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceBody10(tOpenBrace, declaration10, tCloseBrace);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Declaration10Syntax : TestLangOneSyntaxNode
	{
	    private Vertex10Syntax vertex10;
	    private Arrow10Syntax arrow10;
	
	    public Declaration10Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Declaration10Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Declaration10Syntax Update(Vertex10Syntax vertex10)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration10(vertex10);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public Declaration10Syntax Update(Arrow10Syntax arrow10)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration10(arrow10);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (Declaration10Syntax)newNode;
	...
	public sealed class Vertex10Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Vertex10Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Vertex10Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Vertex10Syntax Update(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
	    {
	        if (this.KVertex != kVertex ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Vertex10(kVertex, name, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Arrow10Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax source;
	    private NameSyntax target;
	
	    public Arrow10Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Arrow10Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Arrow10Syntax Update(SyntaxToken kArrow, NameSyntax source, SyntaxToken tArrow, NameSyntax target, SyntaxToken tSemicolon)
	    {
	        if (this.KArrow != kArrow ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Arrow10(kArrow, source, tArrow, target, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Test11Syntax : TestLangOneSyntaxNode
	{
	    private SyntaxNode namespaceDeclaration11;
	
	    public Test11Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Test11Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Test11Syntax Update(SyntaxToken kTest11, SyntaxList<NamespaceDeclaration11Syntax> namespaceDeclaration11)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Test11(kTest11, namespaceDeclaration11);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceDeclaration11Syntax : TestLangOneSyntaxNode
	{
	    private QualifiedNameSyntax qualifiedName;
	    private NamespaceBody11Syntax namespaceBody11;
	
	    public NamespaceDeclaration11Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceDeclaration11Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceDeclaration11Syntax Update(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody11Syntax namespaceBody11)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceDeclaration11(kNamespace, qualifiedName, namespaceBody11);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceBody11Syntax : TestLangOneSyntaxNode
	{
	    private SyntaxNode declaration11;
	
	    public NamespaceBody11Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NamespaceBody11Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NamespaceBody11Syntax Update(SyntaxToken tOpenBrace, SyntaxList<Declaration11Syntax> declaration11, SyntaxToken tCloseBrace)
	    {
	        if (this.TOpenBrace != tOpenBrace ||
				...
				this.TCloseBrace != tCloseBrace)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NamespaceBody11(tOpenBrace, declaration11, tCloseBrace);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Declaration11Syntax : TestLangOneSyntaxNode
	{
	    private Vertex11Syntax vertex11;
	    private Arrow11Syntax arrow11;
	
	    public Declaration11Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Declaration11Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Declaration11Syntax Update(Vertex11Syntax vertex11)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration11(vertex11);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public Declaration11Syntax Update(Arrow11Syntax arrow11)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Declaration11(arrow11);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (Declaration11Syntax)newNode;
	...
	public sealed class Vertex11Syntax : TestLangOneSyntaxNode
	{
	    private NameSyntax name;
	
	    public Vertex11Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Vertex11Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Vertex11Syntax Update(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
	    {
	        if (this.KVertex != kVertex ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Vertex11(kVertex, name, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class Arrow11Syntax : TestLangOneSyntaxNode
	{
	    private QualifiedNameSyntax source;
	    private QualifiedNameSyntax target;
	
	    public Arrow11Syntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public Arrow11Syntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public Arrow11Syntax Update(SyntaxToken kArrow, QualifiedNameSyntax source, SyntaxToken tArrow, QualifiedNameSyntax target, SyntaxToken tSemicolon)
	    {
	        if (this.KArrow != kArrow ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Arrow11(kArrow, source, tArrow, target, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NameSyntax : TestLangOneSyntaxNode
	{
	    private IdentifierSyntax identifier;
	
	    public NameSyntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NameSyntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NameSyntax Update(IdentifierSyntax identifier)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Name(identifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class QualifiedNameSyntax : TestLangOneSyntaxNode
	{
	    private QualifierSyntax qualifier;
	
	    public QualifiedNameSyntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public QualifiedNameSyntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public QualifiedNameSyntax Update(QualifierSyntax qualifier)
	    {
	        if (this.Qualifier != qualifier)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.QualifiedName(qualifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class QualifierSyntax : TestLangOneSyntaxNode
	{
	    private SyntaxNode identifier;
	
	    public QualifierSyntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public QualifierSyntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public QualifierSyntax Update(SeparatedSyntaxList<IdentifierSyntax> identifier)
	    {
	        if (this.Identifier != identifier)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Qualifier(identifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class IdentifierSyntax : TestLangOneSyntaxNode
	{
	
	    public IdentifierSyntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public IdentifierSyntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public IdentifierSyntax Update(SyntaxToken identifier)
	    {
	        if (this.Identifier != identifier)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Identifier(identifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class LiteralSyntax : TestLangOneSyntaxNode
	{
	    ...
	    public LiteralSyntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public LiteralSyntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public LiteralSyntax Update(NullLiteralSyntax nullLiteral)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Literal(nullLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public LiteralSyntax Update(BooleanLiteralSyntax booleanLiteral)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Literal(booleanLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (LiteralSyntax)newNode;
	    ...
	    public LiteralSyntax Update(IntegerLiteralSyntax integerLiteral)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Literal(integerLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (LiteralSyntax)newNode;
	    ...
	    public LiteralSyntax Update(DecimalLiteralSyntax decimalLiteral)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Literal(decimalLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (LiteralSyntax)newNode;
	    ...
	    public LiteralSyntax Update(ScientificLiteralSyntax scientificLiteral)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Literal(scientificLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (LiteralSyntax)newNode;
	    ...
	    public LiteralSyntax Update(StringLiteralSyntax stringLiteral)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.Literal(stringLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (LiteralSyntax)newNode;
	...
	public sealed class NullLiteralSyntax : TestLangOneSyntaxNode
	{
	
	    public NullLiteralSyntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public NullLiteralSyntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public NullLiteralSyntax Update(SyntaxToken kNull)
	    {
	        if (this.KNull != kNull)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.NullLiteral(kNull);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class BooleanLiteralSyntax : TestLangOneSyntaxNode
	{
	
	    public BooleanLiteralSyntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public BooleanLiteralSyntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public BooleanLiteralSyntax Update(SyntaxToken booleanLiteral)
	    {
	        if (this.BooleanLiteral != booleanLiteral)
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.BooleanLiteral(booleanLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class IntegerLiteralSyntax : TestLangOneSyntaxNode
	{
	
	    public IntegerLiteralSyntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public IntegerLiteralSyntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public IntegerLiteralSyntax Update(SyntaxToken lInteger)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.IntegerLiteral(lInteger);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class DecimalLiteralSyntax : TestLangOneSyntaxNode
	{
	
	    public DecimalLiteralSyntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public DecimalLiteralSyntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public DecimalLiteralSyntax Update(SyntaxToken lDecimal)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.DecimalLiteral(lDecimal);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class ScientificLiteralSyntax : TestLangOneSyntaxNode
	{
	
	    public ScientificLiteralSyntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public ScientificLiteralSyntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public ScientificLiteralSyntax Update(SyntaxToken lScientific)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.ScientificLiteral(lScientific);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class StringLiteralSyntax : TestLangOneSyntaxNode
	{
	
	    public StringLiteralSyntax(InternalSyntaxNode green, TestLangOneSyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public StringLiteralSyntax(InternalSyntaxNode green, TestLangOneSyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public StringLiteralSyntax Update(SyntaxToken lRegularString)
	    {
	        ...
	        {
	            var newNode = TestLangOneLanguage.Instance.SyntaxFactory.StringLiteral(lRegularString);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
...
namespace MetaDslx.CodeAnalysis.Antlr4.Test.Language.TestLanguageOne
{
	...
	public class TestLangOneSyntaxVisitor : SyntaxVisitor, ITestLangOneSyntaxVisitor
	{
	...
	public interface ITestLangOneSyntaxVisitor<TArg, TResult> 
	{
	...
	public class TestLangOneSyntaxVisitor<TArg, TResult> : SyntaxVisitor<TArg, TResult>, ITestLangOneSyntaxVisitor<TArg, TResult>
	{
	...
	public interface ITestLangOneSyntaxVisitor<TResult> 
	{
	...
	public class TestLangOneSyntaxVisitor<TResult> : SyntaxVisitor<TResult>, ITestLangOneSyntaxVisitor<TResult>
	{
	...
	public class TestLangOneSyntaxRewriter : SyntaxRewriter, ITestLangOneSyntaxVisitor<SyntaxNode>
	{
	    public TestLangOneSyntaxRewriter(bool visitIntoStructuredTrivia = false)
			: base(TestLangOneLanguage.Instance, visitIntoStructuredTrivia)
	    {
	    }
	...
	public class TestLangOneSyntaxFactory : SyntaxFactory
	{
		internal TestLangOneSyntaxFactory(TestLangOneInternalSyntaxFactory internalSyntaxFactory) 
			: base(internalSyntaxFactory)
		{
		}
		public new TestLangOneLanguage Language
		{
			get { return TestLangOneLanguage.Instance; }
		}
		...
		/// </summary>
		public TestLangOneSyntaxTree SyntaxTree(SyntaxNode root, TestLangOneParseOptions options = null, string path = "", Encoding encoding = null)
		{
		...
		/// </summary>
		public TestLangOneSyntaxTree ParseSyntaxTree(
			string text,
			TestLangOneParseOptions options = null,
			string path = "",
			Encoding encoding = null,
			CancellationToken cancellationToken = default(CancellationToken))
		{
			return (TestLangOneSyntaxTree)this.ParseSyntaxTreeCore(SourceText.From(text, encoding), options, path, cancellationToken);
		}
		/// <summary>
		/// Produces a syntax tree by parsing the source text.
		/// </summary>
		public TestLangOneSyntaxTree ParseSyntaxTree(
			...
			CancellationToken cancellationToken = default(CancellationToken))
		{
			return (TestLangOneSyntaxTree)this.ParseSyntaxTreeCore(text, options, path, cancellationToken);
		}
	    ...
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.TAsterisk(text));
	    }
	
	    public SyntaxToken TAsterisk(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.TAsterisk(text, value));
	    }
	
	    public SyntaxToken IdentifierNormal(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.IdentifierNormal(text));
	    }
	
	    public SyntaxToken IdentifierNormal(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.IdentifierNormal(text, value));
	    }
	
	    public SyntaxToken IdentifierVerbatim(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.IdentifierVerbatim(text));
	    }
	
	    public SyntaxToken IdentifierVerbatim(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.IdentifierVerbatim(text, value));
	    }
	
	    public SyntaxToken LInteger(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LInteger(text));
	    }
	
	    public SyntaxToken LInteger(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LInteger(text, value));
	    }
	
	    public SyntaxToken LDecimal(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LDecimal(text));
	    }
	
	    public SyntaxToken LDecimal(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LDecimal(text, value));
	    }
	
	    public SyntaxToken LScientific(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LScientific(text));
	    }
	
	    public SyntaxToken LScientific(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LScientific(text, value));
	    }
	
	    public SyntaxToken LDateTimeOffset(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LDateTimeOffset(text));
	    }
	
	    public SyntaxToken LDateTimeOffset(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LDateTimeOffset(text, value));
	    }
	
	    public SyntaxToken LDateTime(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LDateTime(text));
	    }
	
	    public SyntaxToken LDateTime(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LDateTime(text, value));
	    }
	
	    public SyntaxToken LDate(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LDate(text));
	    }
	
	    public SyntaxToken LDate(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LDate(text, value));
	    }
	
	    public SyntaxToken LTime(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LTime(text));
	    }
	
	    public SyntaxToken LTime(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LTime(text, value));
	    }
	
	    public SyntaxToken LRegularString(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LRegularString(text));
	    }
	
	    public SyntaxToken LRegularString(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LRegularString(text, value));
	    }
	
	    public SyntaxToken LGuid(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LGuid(text));
	    }
	
	    public SyntaxToken LGuid(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LGuid(text, value));
	    }
	
	    public SyntaxToken LUtf8Bom(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LUtf8Bom(text));
	    }
	
	    public SyntaxToken LUtf8Bom(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LUtf8Bom(text, value));
	    }
	
	    public SyntaxToken LWhiteSpace(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LWhiteSpace(text));
	    }
	
	    public SyntaxToken LWhiteSpace(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LWhiteSpace(text, value));
	    }
	
	    public SyntaxToken LCrLf(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LCrLf(text));
	    }
	
	    public SyntaxToken LCrLf(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LCrLf(text, value));
	    }
	
	    public SyntaxToken LLineEnd(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LLineEnd(text));
	    }
	
	    public SyntaxToken LLineEnd(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LLineEnd(text, value));
	    }
	
	    public SyntaxToken LSingleLineComment(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LSingleLineComment(text));
	    }
	
	    public SyntaxToken LSingleLineComment(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LSingleLineComment(text, value));
	    }
	
	    public SyntaxToken LComment(string text)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LComment(text));
	    }
	
	    public SyntaxToken LComment(string text, object value)
	    {
	        return new SyntaxToken(TestLangOneLanguage.Instance.InternalSyntaxFactory.LComment(text, value));
	    }
		
		public MainSyntax Main(SyntaxList<TestSyntax> test, SyntaxToken eOF)
		{
		    if (eOF == null) throw new ArgumentNullException(nameof(eOF));
		    if (eOF.GetKind() != TestLangOneSyntaxKind.Eof) throw new ArgumentException(nameof(eOF));
		    return (MainSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Main(Microsoft.CodeAnalysis.Syntax.InternalSyntax.GreenNodeExtensions.ToGreenList<TestGreen>(test.Node), (InternalSyntaxToken)eOF.Node).CreateRed();
		}
		...
		public TestSyntax Test(Test01Syntax test01)
		{
		    ...
		    return (TestSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test((Syntax.InternalSyntax.Test01Green)test01.Green).CreateRed();
		}
		
		public TestSyntax Test(Test02Syntax test02)
		{
		    if (test02 == null) throw new ArgumentNullException(nameof(test02));
		    return (TestSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test((Syntax.InternalSyntax.Test02Green)test02.Green).CreateRed();
		}
		
		public TestSyntax Test(Test03Syntax test03)
		{
		    if (test03 == null) throw new ArgumentNullException(nameof(test03));
		    return (TestSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test((Syntax.InternalSyntax.Test03Green)test03.Green).CreateRed();
		}
		
		public TestSyntax Test(Test04Syntax test04)
		{
		    if (test04 == null) throw new ArgumentNullException(nameof(test04));
		    return (TestSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test((Syntax.InternalSyntax.Test04Green)test04.Green).CreateRed();
		}
		
		public TestSyntax Test(Test05Syntax test05)
		{
		    if (test05 == null) throw new ArgumentNullException(nameof(test05));
		    return (TestSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test((Syntax.InternalSyntax.Test05Green)test05.Green).CreateRed();
		}
		
		public TestSyntax Test(Test06Syntax test06)
		{
		    if (test06 == null) throw new ArgumentNullException(nameof(test06));
		    return (TestSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test((Syntax.InternalSyntax.Test06Green)test06.Green).CreateRed();
		}
		
		public TestSyntax Test(Test07Syntax test07)
		{
		    if (test07 == null) throw new ArgumentNullException(nameof(test07));
		    return (TestSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test((Syntax.InternalSyntax.Test07Green)test07.Green).CreateRed();
		}
		
		public TestSyntax Test(Test08Syntax test08)
		{
		    if (test08 == null) throw new ArgumentNullException(nameof(test08));
		    return (TestSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test((Syntax.InternalSyntax.Test08Green)test08.Green).CreateRed();
		}
		
		public TestSyntax Test(Test09Syntax test09)
		{
		    if (test09 == null) throw new ArgumentNullException(nameof(test09));
		    return (TestSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test((Syntax.InternalSyntax.Test09Green)test09.Green).CreateRed();
		}
		
		public TestSyntax Test(Test10Syntax test10)
		{
		    if (test10 == null) throw new ArgumentNullException(nameof(test10));
		    return (TestSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test((Syntax.InternalSyntax.Test10Green)test10.Green).CreateRed();
		}
		
		public TestSyntax Test(Test11Syntax test11)
		{
		    if (test11 == null) throw new ArgumentNullException(nameof(test11));
		    return (TestSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test((Syntax.InternalSyntax.Test11Green)test11.Green).CreateRed();
		}
		...
		public Test01Syntax Test01(SyntaxToken kTest01, NamespaceDeclaration01Syntax namespaceDeclaration01)
		{
		    ...
		    if (kTest01.GetKind() != TestLangOneSyntaxKind.KTest01) throw new ArgumentException(nameof(kTest01));
		    if (namespaceDeclaration01 == null) throw new ArgumentNullException(nameof(namespaceDeclaration01));
		    return (Test01Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test01((InternalSyntaxToken)kTest01.Node, (Syntax.InternalSyntax.NamespaceDeclaration01Green)namespaceDeclaration01.Green).CreateRed();
		}
		
		public Test01Syntax Test01(NamespaceDeclaration01Syntax namespaceDeclaration01)
		{
			return this.Test01(this.Token(TestLangOneSyntaxKind.KTest01), namespaceDeclaration01);
		}
		...
		public NamespaceDeclaration01Syntax NamespaceDeclaration01(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody01Syntax namespaceBody01)
		{
		    ...
		    if (kNamespace.GetKind() != TestLangOneSyntaxKind.KNamespace) throw new ArgumentException(nameof(kNamespace));
		    ...
		    return (NamespaceDeclaration01Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceDeclaration01((InternalSyntaxToken)kNamespace.Node, (Syntax.InternalSyntax.QualifiedNameGreen)qualifiedName.Green, (Syntax.InternalSyntax.NamespaceBody01Green)namespaceBody01.Green).CreateRed();
		}
		...
		{
			return this.NamespaceDeclaration01(this.Token(TestLangOneSyntaxKind.KNamespace), qualifiedName, namespaceBody01);
		}
		...
		public NamespaceBody01Syntax NamespaceBody01(SyntaxToken tOpenBrace, SyntaxList<Declaration01Syntax> declaration01, SyntaxToken tCloseBrace)
		{
		    ...
		    if (tOpenBrace.GetKind() != TestLangOneSyntaxKind.TOpenBrace) throw new ArgumentException(nameof(tOpenBrace));
		    if (tCloseBrace == null) throw new ArgumentNullException(nameof(tCloseBrace));
		    if (tCloseBrace.GetKind() != TestLangOneSyntaxKind.TCloseBrace) throw new ArgumentException(nameof(tCloseBrace));
		    return (NamespaceBody01Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceBody01((InternalSyntaxToken)tOpenBrace.Node, Microsoft.CodeAnalysis.Syntax.InternalSyntax.GreenNodeExtensions.ToGreenList<Declaration01Green>(declaration01.Node), (InternalSyntaxToken)tCloseBrace.Node).CreateRed();
		}
		
		public NamespaceBody01Syntax NamespaceBody01()
		{
			return this.NamespaceBody01(this.Token(TestLangOneSyntaxKind.TOpenBrace), default, this.Token(TestLangOneSyntaxKind.TCloseBrace));
		}
		...
		public Declaration01Syntax Declaration01(Vertex01Syntax vertex01)
		{
		    ...
		    return (Declaration01Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration01((Syntax.InternalSyntax.Vertex01Green)vertex01.Green).CreateRed();
		}
		...
		public Declaration01Syntax Declaration01(Arrow01Syntax arrow01)
		{
		    ...
		    return (Declaration01Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration01((Syntax.InternalSyntax.Arrow01Green)arrow01.Green).CreateRed();
		}
		...
		public Vertex01Syntax Vertex01(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
		{
		    ...
		    if (kVertex.GetKind() != TestLangOneSyntaxKind.KVertex) throw new ArgumentException(nameof(kVertex));
		    if (name == null) throw new ArgumentNullException(nameof(name));
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Vertex01Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Vertex01((InternalSyntaxToken)kVertex.Node, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Vertex01Syntax Vertex01(NameSyntax name)
		{
			return this.Vertex01(this.Token(TestLangOneSyntaxKind.KVertex), name, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Arrow01Syntax Arrow01(SyntaxToken kArrow, QualifierSyntax source, SyntaxToken tArrow, QualifierSyntax target, SyntaxToken tSemicolon)
		{
		    ...
		    if (kArrow.GetKind() != TestLangOneSyntaxKind.KArrow) throw new ArgumentException(nameof(kArrow));
		    if (source == null) throw new ArgumentNullException(nameof(source));
		    if (tArrow == null) throw new ArgumentNullException(nameof(tArrow));
		    if (tArrow.GetKind() != TestLangOneSyntaxKind.TArrow) throw new ArgumentException(nameof(tArrow));
		    if (target == null) throw new ArgumentNullException(nameof(target));
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Arrow01Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Arrow01((InternalSyntaxToken)kArrow.Node, (Syntax.InternalSyntax.QualifierGreen)source.Green, (InternalSyntaxToken)tArrow.Node, (Syntax.InternalSyntax.QualifierGreen)target.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Arrow01Syntax Arrow01(QualifierSyntax source, QualifierSyntax target)
		{
			return this.Arrow01(this.Token(TestLangOneSyntaxKind.KArrow), source, this.Token(TestLangOneSyntaxKind.TArrow), target, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Test02Syntax Test02(SyntaxToken kTest02, NamespaceDeclaration02Syntax namespaceDeclaration02)
		{
		    ...
		    if (kTest02.GetKind() != TestLangOneSyntaxKind.KTest02) throw new ArgumentException(nameof(kTest02));
		    if (namespaceDeclaration02 == null) throw new ArgumentNullException(nameof(namespaceDeclaration02));
		    return (Test02Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test02((InternalSyntaxToken)kTest02.Node, (Syntax.InternalSyntax.NamespaceDeclaration02Green)namespaceDeclaration02.Green).CreateRed();
		}
		
		public Test02Syntax Test02(NamespaceDeclaration02Syntax namespaceDeclaration02)
		{
			return this.Test02(this.Token(TestLangOneSyntaxKind.KTest02), namespaceDeclaration02);
		}
		...
		public NamespaceDeclaration02Syntax NamespaceDeclaration02(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody02Syntax namespaceBody02)
		{
		    ...
		    return (NamespaceDeclaration02Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceDeclaration02((InternalSyntaxToken)kNamespace.Node, (Syntax.InternalSyntax.QualifiedNameGreen)qualifiedName.Green, (Syntax.InternalSyntax.NamespaceBody02Green)namespaceBody02.Green).CreateRed();
		}
		...
		{
			return this.NamespaceDeclaration02(this.Token(TestLangOneSyntaxKind.KNamespace), qualifiedName, namespaceBody02);
		}
		...
		public NamespaceBody02Syntax NamespaceBody02(SyntaxToken tOpenBrace, SyntaxList<Declaration02Syntax> declaration02, SyntaxToken tCloseBrace)
		{
		    ...
		    if (tCloseBrace == null) throw new ArgumentNullException(nameof(tCloseBrace));
		    if (tCloseBrace.GetKind() != TestLangOneSyntaxKind.TCloseBrace) throw new ArgumentException(nameof(tCloseBrace));
		    return (NamespaceBody02Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceBody02((InternalSyntaxToken)tOpenBrace.Node, Microsoft.CodeAnalysis.Syntax.InternalSyntax.GreenNodeExtensions.ToGreenList<Declaration02Green>(declaration02.Node), (InternalSyntaxToken)tCloseBrace.Node).CreateRed();
		}
		
		public NamespaceBody02Syntax NamespaceBody02()
		{
			return this.NamespaceBody02(this.Token(TestLangOneSyntaxKind.TOpenBrace), default, this.Token(TestLangOneSyntaxKind.TCloseBrace));
		}
		...
		public Declaration02Syntax Declaration02(Vertex02Syntax vertex02)
		{
		    ...
		    return (Declaration02Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration02((Syntax.InternalSyntax.Vertex02Green)vertex02.Green).CreateRed();
		}
		...
		public Declaration02Syntax Declaration02(Arrow02Syntax arrow02)
		{
		    ...
		    return (Declaration02Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration02((Syntax.InternalSyntax.Arrow02Green)arrow02.Green).CreateRed();
		}
		...
		public Vertex02Syntax Vertex02(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Vertex02Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Vertex02((InternalSyntaxToken)kVertex.Node, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Vertex02Syntax Vertex02(NameSyntax name)
		{
			return this.Vertex02(this.Token(TestLangOneSyntaxKind.KVertex), name, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Arrow02Syntax Arrow02(SyntaxToken kArrow, Source02Syntax source02, SyntaxToken tArrow, Target02Syntax target02, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Arrow02Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Arrow02((InternalSyntaxToken)kArrow.Node, (Syntax.InternalSyntax.Source02Green)source02.Green, (InternalSyntaxToken)tArrow.Node, (Syntax.InternalSyntax.Target02Green)target02.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Arrow02Syntax Arrow02(Source02Syntax source02, Target02Syntax target02)
		{
			return this.Arrow02(this.Token(TestLangOneSyntaxKind.KArrow), source02, this.Token(TestLangOneSyntaxKind.TArrow), target02, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Source02Syntax Source02(QualifierSyntax qualifier)
		{
		    ...
		    return (Source02Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Source02((Syntax.InternalSyntax.QualifierGreen)qualifier.Green).CreateRed();
		}
		
		public Target02Syntax Target02(QualifierSyntax qualifier)
		{
		    if (qualifier == null) throw new ArgumentNullException(nameof(qualifier));
		    return (Target02Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Target02((Syntax.InternalSyntax.QualifierGreen)qualifier.Green).CreateRed();
		}
		...
		public Test03Syntax Test03(SyntaxToken kTest03, NamespaceDeclaration03Syntax namespaceDeclaration03)
		{
		    ...
		    if (kTest03.GetKind() != TestLangOneSyntaxKind.KTest03) throw new ArgumentException(nameof(kTest03));
		    if (namespaceDeclaration03 == null) throw new ArgumentNullException(nameof(namespaceDeclaration03));
		    return (Test03Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test03((InternalSyntaxToken)kTest03.Node, (Syntax.InternalSyntax.NamespaceDeclaration03Green)namespaceDeclaration03.Green).CreateRed();
		}
		
		public Test03Syntax Test03(NamespaceDeclaration03Syntax namespaceDeclaration03)
		{
			return this.Test03(this.Token(TestLangOneSyntaxKind.KTest03), namespaceDeclaration03);
		}
		...
		public NamespaceDeclaration03Syntax NamespaceDeclaration03(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody03Syntax namespaceBody03)
		{
		    ...
		    return (NamespaceDeclaration03Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceDeclaration03((InternalSyntaxToken)kNamespace.Node, (Syntax.InternalSyntax.QualifiedNameGreen)qualifiedName.Green, (Syntax.InternalSyntax.NamespaceBody03Green)namespaceBody03.Green).CreateRed();
		}
		...
		{
			return this.NamespaceDeclaration03(this.Token(TestLangOneSyntaxKind.KNamespace), qualifiedName, namespaceBody03);
		}
		...
		public NamespaceBody03Syntax NamespaceBody03(SyntaxToken tOpenBrace, SyntaxList<Declaration03Syntax> declaration03, SyntaxToken tCloseBrace)
		{
		    ...
		    if (tCloseBrace == null) throw new ArgumentNullException(nameof(tCloseBrace));
		    if (tCloseBrace.GetKind() != TestLangOneSyntaxKind.TCloseBrace) throw new ArgumentException(nameof(tCloseBrace));
		    return (NamespaceBody03Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceBody03((InternalSyntaxToken)tOpenBrace.Node, Microsoft.CodeAnalysis.Syntax.InternalSyntax.GreenNodeExtensions.ToGreenList<Declaration03Green>(declaration03.Node), (InternalSyntaxToken)tCloseBrace.Node).CreateRed();
		}
		
		public NamespaceBody03Syntax NamespaceBody03()
		{
			return this.NamespaceBody03(this.Token(TestLangOneSyntaxKind.TOpenBrace), default, this.Token(TestLangOneSyntaxKind.TCloseBrace));
		}
		...
		public Declaration03Syntax Declaration03(Vertex03Syntax vertex03)
		{
		    ...
		    return (Declaration03Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration03((Syntax.InternalSyntax.Vertex03Green)vertex03.Green).CreateRed();
		}
		...
		public Declaration03Syntax Declaration03(Arrow03Syntax arrow03)
		{
		    ...
		    return (Declaration03Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration03((Syntax.InternalSyntax.Arrow03Green)arrow03.Green).CreateRed();
		}
		...
		public Vertex03Syntax Vertex03(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Vertex03Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Vertex03((InternalSyntaxToken)kVertex.Node, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Vertex03Syntax Vertex03(NameSyntax name)
		{
			return this.Vertex03(this.Token(TestLangOneSyntaxKind.KVertex), name, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Arrow03Syntax Arrow03(SyntaxToken kArrow, Source03Syntax source03, SyntaxToken tArrow, Target03Syntax target03, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Arrow03Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Arrow03((InternalSyntaxToken)kArrow.Node, (Syntax.InternalSyntax.Source03Green)source03.Green, (InternalSyntaxToken)tArrow.Node, (Syntax.InternalSyntax.Target03Green)target03.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Arrow03Syntax Arrow03(Source03Syntax source03, Target03Syntax target03)
		{
			return this.Arrow03(this.Token(TestLangOneSyntaxKind.KArrow), source03, this.Token(TestLangOneSyntaxKind.TArrow), target03, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		
		public Source03Syntax Source03(QualifierSyntax qualifier)
		{
		    if (qualifier == null) throw new ArgumentNullException(nameof(qualifier));
		    return (Source03Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Source03((Syntax.InternalSyntax.QualifierGreen)qualifier.Green).CreateRed();
		}
		
		public Target03Syntax Target03(QualifierSyntax qualifier)
		{
		    if (qualifier == null) throw new ArgumentNullException(nameof(qualifier));
		    return (Target03Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Target03((Syntax.InternalSyntax.QualifierGreen)qualifier.Green).CreateRed();
		}
		...
		public Test04Syntax Test04(SyntaxToken kTest04, NamespaceDeclaration04Syntax namespaceDeclaration04)
		{
		    ...
		    if (kTest04.GetKind() != TestLangOneSyntaxKind.KTest04) throw new ArgumentException(nameof(kTest04));
		    if (namespaceDeclaration04 == null) throw new ArgumentNullException(nameof(namespaceDeclaration04));
		    return (Test04Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test04((InternalSyntaxToken)kTest04.Node, (Syntax.InternalSyntax.NamespaceDeclaration04Green)namespaceDeclaration04.Green).CreateRed();
		}
		
		public Test04Syntax Test04(NamespaceDeclaration04Syntax namespaceDeclaration04)
		{
			return this.Test04(this.Token(TestLangOneSyntaxKind.KTest04), namespaceDeclaration04);
		}
		...
		public NamespaceDeclaration04Syntax NamespaceDeclaration04(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody04Syntax namespaceBody04)
		{
		    ...
		    return (NamespaceDeclaration04Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceDeclaration04((InternalSyntaxToken)kNamespace.Node, (Syntax.InternalSyntax.QualifiedNameGreen)qualifiedName.Green, (Syntax.InternalSyntax.NamespaceBody04Green)namespaceBody04.Green).CreateRed();
		}
		...
		{
			return this.NamespaceDeclaration04(this.Token(TestLangOneSyntaxKind.KNamespace), qualifiedName, namespaceBody04);
		}
		...
		public NamespaceBody04Syntax NamespaceBody04(SyntaxToken tOpenBrace, SyntaxList<Declaration04Syntax> declaration04, SyntaxToken tCloseBrace)
		{
		    ...
		    if (tCloseBrace == null) throw new ArgumentNullException(nameof(tCloseBrace));
		    if (tCloseBrace.GetKind() != TestLangOneSyntaxKind.TCloseBrace) throw new ArgumentException(nameof(tCloseBrace));
		    return (NamespaceBody04Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceBody04((InternalSyntaxToken)tOpenBrace.Node, Microsoft.CodeAnalysis.Syntax.InternalSyntax.GreenNodeExtensions.ToGreenList<Declaration04Green>(declaration04.Node), (InternalSyntaxToken)tCloseBrace.Node).CreateRed();
		}
		
		public NamespaceBody04Syntax NamespaceBody04()
		{
			return this.NamespaceBody04(this.Token(TestLangOneSyntaxKind.TOpenBrace), default, this.Token(TestLangOneSyntaxKind.TCloseBrace));
		}
		...
		public Declaration04Syntax Declaration04(Vertex04Syntax vertex04)
		{
		    ...
		    return (Declaration04Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration04((Syntax.InternalSyntax.Vertex04Green)vertex04.Green).CreateRed();
		}
		...
		public Declaration04Syntax Declaration04(Arrow04Syntax arrow04)
		{
		    ...
		    return (Declaration04Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration04((Syntax.InternalSyntax.Arrow04Green)arrow04.Green).CreateRed();
		}
		...
		public Vertex04Syntax Vertex04(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Vertex04Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Vertex04((InternalSyntaxToken)kVertex.Node, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Vertex04Syntax Vertex04(NameSyntax name)
		{
			return this.Vertex04(this.Token(TestLangOneSyntaxKind.KVertex), name, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Arrow04Syntax Arrow04(SyntaxToken kArrow, QualifierSyntax source, SyntaxToken tArrow, QualifierSyntax target, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Arrow04Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Arrow04((InternalSyntaxToken)kArrow.Node, (Syntax.InternalSyntax.QualifierGreen)source.Green, (InternalSyntaxToken)tArrow.Node, (Syntax.InternalSyntax.QualifierGreen)target.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Arrow04Syntax Arrow04(QualifierSyntax source, QualifierSyntax target)
		{
			return this.Arrow04(this.Token(TestLangOneSyntaxKind.KArrow), source, this.Token(TestLangOneSyntaxKind.TArrow), target, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Test05Syntax Test05(SyntaxToken kTest05, NamespaceDeclaration05Syntax namespaceDeclaration05)
		{
		    ...
		    if (kTest05.GetKind() != TestLangOneSyntaxKind.KTest05) throw new ArgumentException(nameof(kTest05));
		    if (namespaceDeclaration05 == null) throw new ArgumentNullException(nameof(namespaceDeclaration05));
		    return (Test05Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test05((InternalSyntaxToken)kTest05.Node, (Syntax.InternalSyntax.NamespaceDeclaration05Green)namespaceDeclaration05.Green).CreateRed();
		}
		
		public Test05Syntax Test05(NamespaceDeclaration05Syntax namespaceDeclaration05)
		{
			return this.Test05(this.Token(TestLangOneSyntaxKind.KTest05), namespaceDeclaration05);
		}
		...
		public NamespaceDeclaration05Syntax NamespaceDeclaration05(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody05Syntax namespaceBody05)
		{
		    ...
		    return (NamespaceDeclaration05Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceDeclaration05((InternalSyntaxToken)kNamespace.Node, (Syntax.InternalSyntax.QualifiedNameGreen)qualifiedName.Green, (Syntax.InternalSyntax.NamespaceBody05Green)namespaceBody05.Green).CreateRed();
		}
		...
		{
			return this.NamespaceDeclaration05(this.Token(TestLangOneSyntaxKind.KNamespace), qualifiedName, namespaceBody05);
		}
		...
		public NamespaceBody05Syntax NamespaceBody05(SyntaxToken tOpenBrace, SyntaxList<Declaration05Syntax> declaration05, SyntaxToken tCloseBrace)
		{
		    ...
		    if (tCloseBrace == null) throw new ArgumentNullException(nameof(tCloseBrace));
		    if (tCloseBrace.GetKind() != TestLangOneSyntaxKind.TCloseBrace) throw new ArgumentException(nameof(tCloseBrace));
		    return (NamespaceBody05Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceBody05((InternalSyntaxToken)tOpenBrace.Node, Microsoft.CodeAnalysis.Syntax.InternalSyntax.GreenNodeExtensions.ToGreenList<Declaration05Green>(declaration05.Node), (InternalSyntaxToken)tCloseBrace.Node).CreateRed();
		}
		
		public NamespaceBody05Syntax NamespaceBody05()
		{
			return this.NamespaceBody05(this.Token(TestLangOneSyntaxKind.TOpenBrace), default, this.Token(TestLangOneSyntaxKind.TCloseBrace));
		}
		...
		public Declaration05Syntax Declaration05(Vertex05Syntax vertex05)
		{
		    ...
		    return (Declaration05Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration05((Syntax.InternalSyntax.Vertex05Green)vertex05.Green).CreateRed();
		}
		...
		public Declaration05Syntax Declaration05(Arrow05Syntax arrow05)
		{
		    ...
		    return (Declaration05Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration05((Syntax.InternalSyntax.Arrow05Green)arrow05.Green).CreateRed();
		}
		...
		public Vertex05Syntax Vertex05(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Vertex05Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Vertex05((InternalSyntaxToken)kVertex.Node, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Vertex05Syntax Vertex05(NameSyntax name)
		{
			return this.Vertex05(this.Token(TestLangOneSyntaxKind.KVertex), name, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Arrow05Syntax Arrow05(SyntaxToken kArrow, QualifierSyntax source, SyntaxToken tArrow, QualifierSyntax target, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Arrow05Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Arrow05((InternalSyntaxToken)kArrow.Node, (Syntax.InternalSyntax.QualifierGreen)source.Green, (InternalSyntaxToken)tArrow.Node, (Syntax.InternalSyntax.QualifierGreen)target.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Arrow05Syntax Arrow05(QualifierSyntax source, QualifierSyntax target)
		{
			return this.Arrow05(this.Token(TestLangOneSyntaxKind.KArrow), source, this.Token(TestLangOneSyntaxKind.TArrow), target, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Test06Syntax Test06(SyntaxToken kTest06, NamespaceDeclaration06Syntax namespaceDeclaration06)
		{
		    ...
		    if (kTest06.GetKind() != TestLangOneSyntaxKind.KTest06) throw new ArgumentException(nameof(kTest06));
		    if (namespaceDeclaration06 == null) throw new ArgumentNullException(nameof(namespaceDeclaration06));
		    return (Test06Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test06((InternalSyntaxToken)kTest06.Node, (Syntax.InternalSyntax.NamespaceDeclaration06Green)namespaceDeclaration06.Green).CreateRed();
		}
		
		public Test06Syntax Test06(NamespaceDeclaration06Syntax namespaceDeclaration06)
		{
			return this.Test06(this.Token(TestLangOneSyntaxKind.KTest06), namespaceDeclaration06);
		}
		...
		public NamespaceDeclaration06Syntax NamespaceDeclaration06(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody06Syntax namespaceBody06)
		{
		    ...
		    return (NamespaceDeclaration06Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceDeclaration06((InternalSyntaxToken)kNamespace.Node, (Syntax.InternalSyntax.QualifiedNameGreen)qualifiedName.Green, (Syntax.InternalSyntax.NamespaceBody06Green)namespaceBody06.Green).CreateRed();
		}
		...
		{
			return this.NamespaceDeclaration06(this.Token(TestLangOneSyntaxKind.KNamespace), qualifiedName, namespaceBody06);
		}
		...
		public NamespaceBody06Syntax NamespaceBody06(SyntaxToken tOpenBrace, SyntaxList<Declaration06Syntax> declaration06, SyntaxToken tCloseBrace)
		{
		    ...
		    if (tCloseBrace == null) throw new ArgumentNullException(nameof(tCloseBrace));
		    if (tCloseBrace.GetKind() != TestLangOneSyntaxKind.TCloseBrace) throw new ArgumentException(nameof(tCloseBrace));
		    return (NamespaceBody06Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceBody06((InternalSyntaxToken)tOpenBrace.Node, Microsoft.CodeAnalysis.Syntax.InternalSyntax.GreenNodeExtensions.ToGreenList<Declaration06Green>(declaration06.Node), (InternalSyntaxToken)tCloseBrace.Node).CreateRed();
		}
		
		public NamespaceBody06Syntax NamespaceBody06()
		{
			return this.NamespaceBody06(this.Token(TestLangOneSyntaxKind.TOpenBrace), default, this.Token(TestLangOneSyntaxKind.TCloseBrace));
		}
		...
		public Declaration06Syntax Declaration06(Vertex06Syntax vertex06)
		{
		    ...
		    return (Declaration06Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration06((Syntax.InternalSyntax.Vertex06Green)vertex06.Green).CreateRed();
		}
		...
		public Declaration06Syntax Declaration06(Arrow06Syntax arrow06)
		{
		    ...
		    return (Declaration06Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration06((Syntax.InternalSyntax.Arrow06Green)arrow06.Green).CreateRed();
		}
		...
		public Vertex06Syntax Vertex06(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Vertex06Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Vertex06((InternalSyntaxToken)kVertex.Node, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Vertex06Syntax Vertex06(NameSyntax name)
		{
			return this.Vertex06(this.Token(TestLangOneSyntaxKind.KVertex), name, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Arrow06Syntax Arrow06(SyntaxToken kArrow, NameSyntax source, SyntaxToken tArrow, NameSyntax target, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Arrow06Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Arrow06((InternalSyntaxToken)kArrow.Node, (Syntax.InternalSyntax.NameGreen)source.Green, (InternalSyntaxToken)tArrow.Node, (Syntax.InternalSyntax.NameGreen)target.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Arrow06Syntax Arrow06(NameSyntax source, NameSyntax target)
		{
			return this.Arrow06(this.Token(TestLangOneSyntaxKind.KArrow), source, this.Token(TestLangOneSyntaxKind.TArrow), target, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Test07Syntax Test07(SyntaxToken kTest07, NamespaceDeclaration07Syntax namespaceDeclaration07)
		{
		    ...
		    if (kTest07.GetKind() != TestLangOneSyntaxKind.KTest07) throw new ArgumentException(nameof(kTest07));
		    if (namespaceDeclaration07 == null) throw new ArgumentNullException(nameof(namespaceDeclaration07));
		    return (Test07Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test07((InternalSyntaxToken)kTest07.Node, (Syntax.InternalSyntax.NamespaceDeclaration07Green)namespaceDeclaration07.Green).CreateRed();
		}
		
		public Test07Syntax Test07(NamespaceDeclaration07Syntax namespaceDeclaration07)
		{
			return this.Test07(this.Token(TestLangOneSyntaxKind.KTest07), namespaceDeclaration07);
		}
		...
		public NamespaceDeclaration07Syntax NamespaceDeclaration07(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody07Syntax namespaceBody07)
		{
		    ...
		    return (NamespaceDeclaration07Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceDeclaration07((InternalSyntaxToken)kNamespace.Node, (Syntax.InternalSyntax.QualifiedNameGreen)qualifiedName.Green, (Syntax.InternalSyntax.NamespaceBody07Green)namespaceBody07.Green).CreateRed();
		}
		...
		{
			return this.NamespaceDeclaration07(this.Token(TestLangOneSyntaxKind.KNamespace), qualifiedName, namespaceBody07);
		}
		...
		public NamespaceBody07Syntax NamespaceBody07(SyntaxToken tOpenBrace, SyntaxList<Declaration07Syntax> declaration07, SyntaxToken tCloseBrace)
		{
		    ...
		    if (tCloseBrace == null) throw new ArgumentNullException(nameof(tCloseBrace));
		    if (tCloseBrace.GetKind() != TestLangOneSyntaxKind.TCloseBrace) throw new ArgumentException(nameof(tCloseBrace));
		    return (NamespaceBody07Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceBody07((InternalSyntaxToken)tOpenBrace.Node, Microsoft.CodeAnalysis.Syntax.InternalSyntax.GreenNodeExtensions.ToGreenList<Declaration07Green>(declaration07.Node), (InternalSyntaxToken)tCloseBrace.Node).CreateRed();
		}
		
		public NamespaceBody07Syntax NamespaceBody07()
		{
			return this.NamespaceBody07(this.Token(TestLangOneSyntaxKind.TOpenBrace), default, this.Token(TestLangOneSyntaxKind.TCloseBrace));
		}
		...
		public Declaration07Syntax Declaration07(Vertex07Syntax vertex07)
		{
		    ...
		    return (Declaration07Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration07((Syntax.InternalSyntax.Vertex07Green)vertex07.Green).CreateRed();
		}
		...
		public Declaration07Syntax Declaration07(Arrow07Syntax arrow07)
		{
		    ...
		    return (Declaration07Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration07((Syntax.InternalSyntax.Arrow07Green)arrow07.Green).CreateRed();
		}
		...
		public Vertex07Syntax Vertex07(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Vertex07Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Vertex07((InternalSyntaxToken)kVertex.Node, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Vertex07Syntax Vertex07(NameSyntax name)
		{
			return this.Vertex07(this.Token(TestLangOneSyntaxKind.KVertex), name, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Arrow07Syntax Arrow07(SyntaxToken kArrow, Source07Syntax source07, SyntaxToken tArrow, Target07Syntax target07, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Arrow07Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Arrow07((InternalSyntaxToken)kArrow.Node, (Syntax.InternalSyntax.Source07Green)source07.Green, (InternalSyntaxToken)tArrow.Node, (Syntax.InternalSyntax.Target07Green)target07.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Arrow07Syntax Arrow07(Source07Syntax source07, Target07Syntax target07)
		{
			return this.Arrow07(this.Token(TestLangOneSyntaxKind.KArrow), source07, this.Token(TestLangOneSyntaxKind.TArrow), target07, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		
		public Source07Syntax Source07(NameSyntax name)
		{
		    if (name == null) throw new ArgumentNullException(nameof(name));
		    return (Source07Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Source07((Syntax.InternalSyntax.NameGreen)name.Green).CreateRed();
		}
		
		public Target07Syntax Target07(NameSyntax name)
		{
		    if (name == null) throw new ArgumentNullException(nameof(name));
		    return (Target07Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Target07((Syntax.InternalSyntax.NameGreen)name.Green).CreateRed();
		}
		...
		public Test08Syntax Test08(SyntaxToken kTest08, NamespaceDeclaration08Syntax namespaceDeclaration08)
		{
		    ...
		    if (kTest08.GetKind() != TestLangOneSyntaxKind.KTest08) throw new ArgumentException(nameof(kTest08));
		    if (namespaceDeclaration08 == null) throw new ArgumentNullException(nameof(namespaceDeclaration08));
		    return (Test08Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test08((InternalSyntaxToken)kTest08.Node, (Syntax.InternalSyntax.NamespaceDeclaration08Green)namespaceDeclaration08.Green).CreateRed();
		}
		
		public Test08Syntax Test08(NamespaceDeclaration08Syntax namespaceDeclaration08)
		{
			return this.Test08(this.Token(TestLangOneSyntaxKind.KTest08), namespaceDeclaration08);
		}
		...
		public NamespaceDeclaration08Syntax NamespaceDeclaration08(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody08Syntax namespaceBody08)
		{
		    ...
		    return (NamespaceDeclaration08Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceDeclaration08((InternalSyntaxToken)kNamespace.Node, (Syntax.InternalSyntax.QualifiedNameGreen)qualifiedName.Green, (Syntax.InternalSyntax.NamespaceBody08Green)namespaceBody08.Green).CreateRed();
		}
		...
		{
			return this.NamespaceDeclaration08(this.Token(TestLangOneSyntaxKind.KNamespace), qualifiedName, namespaceBody08);
		}
		...
		public NamespaceBody08Syntax NamespaceBody08(SyntaxToken tOpenBrace, SyntaxList<Declaration08Syntax> declaration08, SyntaxToken tCloseBrace)
		{
		    ...
		    if (tCloseBrace == null) throw new ArgumentNullException(nameof(tCloseBrace));
		    if (tCloseBrace.GetKind() != TestLangOneSyntaxKind.TCloseBrace) throw new ArgumentException(nameof(tCloseBrace));
		    return (NamespaceBody08Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceBody08((InternalSyntaxToken)tOpenBrace.Node, Microsoft.CodeAnalysis.Syntax.InternalSyntax.GreenNodeExtensions.ToGreenList<Declaration08Green>(declaration08.Node), (InternalSyntaxToken)tCloseBrace.Node).CreateRed();
		}
		
		public NamespaceBody08Syntax NamespaceBody08()
		{
			return this.NamespaceBody08(this.Token(TestLangOneSyntaxKind.TOpenBrace), default, this.Token(TestLangOneSyntaxKind.TCloseBrace));
		}
		...
		public Declaration08Syntax Declaration08(Vertex08Syntax vertex08)
		{
		    ...
		    return (Declaration08Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration08((Syntax.InternalSyntax.Vertex08Green)vertex08.Green).CreateRed();
		}
		...
		public Declaration08Syntax Declaration08(Arrow08Syntax arrow08)
		{
		    ...
		    return (Declaration08Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration08((Syntax.InternalSyntax.Arrow08Green)arrow08.Green).CreateRed();
		}
		...
		public Vertex08Syntax Vertex08(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Vertex08Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Vertex08((InternalSyntaxToken)kVertex.Node, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Vertex08Syntax Vertex08(NameSyntax name)
		{
			return this.Vertex08(this.Token(TestLangOneSyntaxKind.KVertex), name, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Arrow08Syntax Arrow08(SyntaxToken kArrow, Source08Syntax source08, SyntaxToken tArrow, Target08Syntax target08, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Arrow08Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Arrow08((InternalSyntaxToken)kArrow.Node, (Syntax.InternalSyntax.Source08Green)source08.Green, (InternalSyntaxToken)tArrow.Node, (Syntax.InternalSyntax.Target08Green)target08.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Arrow08Syntax Arrow08(Source08Syntax source08, Target08Syntax target08)
		{
			return this.Arrow08(this.Token(TestLangOneSyntaxKind.KArrow), source08, this.Token(TestLangOneSyntaxKind.TArrow), target08, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		
		public Source08Syntax Source08(NameSyntax name)
		{
		    if (name == null) throw new ArgumentNullException(nameof(name));
		    return (Source08Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Source08((Syntax.InternalSyntax.NameGreen)name.Green).CreateRed();
		}
		
		public Target08Syntax Target08(NameSyntax name)
		{
		    if (name == null) throw new ArgumentNullException(nameof(name));
		    return (Target08Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Target08((Syntax.InternalSyntax.NameGreen)name.Green).CreateRed();
		}
		...
		public Test09Syntax Test09(SyntaxToken kTest09, NamespaceDeclaration09Syntax namespaceDeclaration09)
		{
		    ...
		    if (kTest09.GetKind() != TestLangOneSyntaxKind.KTest09) throw new ArgumentException(nameof(kTest09));
		    if (namespaceDeclaration09 == null) throw new ArgumentNullException(nameof(namespaceDeclaration09));
		    return (Test09Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test09((InternalSyntaxToken)kTest09.Node, (Syntax.InternalSyntax.NamespaceDeclaration09Green)namespaceDeclaration09.Green).CreateRed();
		}
		
		public Test09Syntax Test09(NamespaceDeclaration09Syntax namespaceDeclaration09)
		{
			return this.Test09(this.Token(TestLangOneSyntaxKind.KTest09), namespaceDeclaration09);
		}
		...
		public NamespaceDeclaration09Syntax NamespaceDeclaration09(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody09Syntax namespaceBody09)
		{
		    ...
		    return (NamespaceDeclaration09Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceDeclaration09((InternalSyntaxToken)kNamespace.Node, (Syntax.InternalSyntax.QualifiedNameGreen)qualifiedName.Green, (Syntax.InternalSyntax.NamespaceBody09Green)namespaceBody09.Green).CreateRed();
		}
		...
		{
			return this.NamespaceDeclaration09(this.Token(TestLangOneSyntaxKind.KNamespace), qualifiedName, namespaceBody09);
		}
		...
		public NamespaceBody09Syntax NamespaceBody09(SyntaxToken tOpenBrace, SyntaxList<Declaration09Syntax> declaration09, SyntaxToken tCloseBrace)
		{
		    ...
		    if (tCloseBrace == null) throw new ArgumentNullException(nameof(tCloseBrace));
		    if (tCloseBrace.GetKind() != TestLangOneSyntaxKind.TCloseBrace) throw new ArgumentException(nameof(tCloseBrace));
		    return (NamespaceBody09Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceBody09((InternalSyntaxToken)tOpenBrace.Node, Microsoft.CodeAnalysis.Syntax.InternalSyntax.GreenNodeExtensions.ToGreenList<Declaration09Green>(declaration09.Node), (InternalSyntaxToken)tCloseBrace.Node).CreateRed();
		}
		
		public NamespaceBody09Syntax NamespaceBody09()
		{
			return this.NamespaceBody09(this.Token(TestLangOneSyntaxKind.TOpenBrace), default, this.Token(TestLangOneSyntaxKind.TCloseBrace));
		}
		...
		public Declaration09Syntax Declaration09(Vertex09Syntax vertex09)
		{
		    ...
		    return (Declaration09Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration09((Syntax.InternalSyntax.Vertex09Green)vertex09.Green).CreateRed();
		}
		...
		public Declaration09Syntax Declaration09(Arrow09Syntax arrow09)
		{
		    ...
		    return (Declaration09Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration09((Syntax.InternalSyntax.Arrow09Green)arrow09.Green).CreateRed();
		}
		...
		public Vertex09Syntax Vertex09(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Vertex09Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Vertex09((InternalSyntaxToken)kVertex.Node, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Vertex09Syntax Vertex09(NameSyntax name)
		{
			return this.Vertex09(this.Token(TestLangOneSyntaxKind.KVertex), name, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Arrow09Syntax Arrow09(SyntaxToken kArrow, NameSyntax source, SyntaxToken tArrow, NameSyntax target, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Arrow09Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Arrow09((InternalSyntaxToken)kArrow.Node, (Syntax.InternalSyntax.NameGreen)source.Green, (InternalSyntaxToken)tArrow.Node, (Syntax.InternalSyntax.NameGreen)target.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Arrow09Syntax Arrow09(NameSyntax source, NameSyntax target)
		{
			return this.Arrow09(this.Token(TestLangOneSyntaxKind.KArrow), source, this.Token(TestLangOneSyntaxKind.TArrow), target, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Test10Syntax Test10(SyntaxToken kTest10, NamespaceDeclaration10Syntax namespaceDeclaration10)
		{
		    ...
		    if (kTest10.GetKind() != TestLangOneSyntaxKind.KTest10) throw new ArgumentException(nameof(kTest10));
		    if (namespaceDeclaration10 == null) throw new ArgumentNullException(nameof(namespaceDeclaration10));
		    return (Test10Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test10((InternalSyntaxToken)kTest10.Node, (Syntax.InternalSyntax.NamespaceDeclaration10Green)namespaceDeclaration10.Green).CreateRed();
		}
		
		public Test10Syntax Test10(NamespaceDeclaration10Syntax namespaceDeclaration10)
		{
			return this.Test10(this.Token(TestLangOneSyntaxKind.KTest10), namespaceDeclaration10);
		}
		...
		public NamespaceDeclaration10Syntax NamespaceDeclaration10(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody10Syntax namespaceBody10)
		{
		    ...
		    return (NamespaceDeclaration10Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceDeclaration10((InternalSyntaxToken)kNamespace.Node, (Syntax.InternalSyntax.QualifiedNameGreen)qualifiedName.Green, (Syntax.InternalSyntax.NamespaceBody10Green)namespaceBody10.Green).CreateRed();
		}
		...
		{
			return this.NamespaceDeclaration10(this.Token(TestLangOneSyntaxKind.KNamespace), qualifiedName, namespaceBody10);
		}
		...
		public NamespaceBody10Syntax NamespaceBody10(SyntaxToken tOpenBrace, SyntaxList<Declaration10Syntax> declaration10, SyntaxToken tCloseBrace)
		{
		    ...
		    if (tCloseBrace == null) throw new ArgumentNullException(nameof(tCloseBrace));
		    if (tCloseBrace.GetKind() != TestLangOneSyntaxKind.TCloseBrace) throw new ArgumentException(nameof(tCloseBrace));
		    return (NamespaceBody10Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceBody10((InternalSyntaxToken)tOpenBrace.Node, Microsoft.CodeAnalysis.Syntax.InternalSyntax.GreenNodeExtensions.ToGreenList<Declaration10Green>(declaration10.Node), (InternalSyntaxToken)tCloseBrace.Node).CreateRed();
		}
		
		public NamespaceBody10Syntax NamespaceBody10()
		{
			return this.NamespaceBody10(this.Token(TestLangOneSyntaxKind.TOpenBrace), default, this.Token(TestLangOneSyntaxKind.TCloseBrace));
		}
		...
		public Declaration10Syntax Declaration10(Vertex10Syntax vertex10)
		{
		    ...
		    return (Declaration10Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration10((Syntax.InternalSyntax.Vertex10Green)vertex10.Green).CreateRed();
		}
		...
		public Declaration10Syntax Declaration10(Arrow10Syntax arrow10)
		{
		    ...
		    return (Declaration10Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration10((Syntax.InternalSyntax.Arrow10Green)arrow10.Green).CreateRed();
		}
		...
		public Vertex10Syntax Vertex10(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Vertex10Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Vertex10((InternalSyntaxToken)kVertex.Node, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Vertex10Syntax Vertex10(NameSyntax name)
		{
			return this.Vertex10(this.Token(TestLangOneSyntaxKind.KVertex), name, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Arrow10Syntax Arrow10(SyntaxToken kArrow, NameSyntax source, SyntaxToken tArrow, NameSyntax target, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Arrow10Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Arrow10((InternalSyntaxToken)kArrow.Node, (Syntax.InternalSyntax.NameGreen)source.Green, (InternalSyntaxToken)tArrow.Node, (Syntax.InternalSyntax.NameGreen)target.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Arrow10Syntax Arrow10(NameSyntax source, NameSyntax target)
		{
			return this.Arrow10(this.Token(TestLangOneSyntaxKind.KArrow), source, this.Token(TestLangOneSyntaxKind.TArrow), target, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Test11Syntax Test11(SyntaxToken kTest11, SyntaxList<NamespaceDeclaration11Syntax> namespaceDeclaration11)
		{
		    ...
		    if (kTest11.GetKind() != TestLangOneSyntaxKind.KTest11) throw new ArgumentException(nameof(kTest11));
		    return (Test11Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Test11((InternalSyntaxToken)kTest11.Node, Microsoft.CodeAnalysis.Syntax.InternalSyntax.GreenNodeExtensions.ToGreenList<NamespaceDeclaration11Green>(namespaceDeclaration11.Node)).CreateRed();
		}
		
		public Test11Syntax Test11()
		{
			return this.Test11(this.Token(TestLangOneSyntaxKind.KTest11), default);
		}
		...
		public NamespaceDeclaration11Syntax NamespaceDeclaration11(SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBody11Syntax namespaceBody11)
		{
		    ...
		    return (NamespaceDeclaration11Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceDeclaration11((InternalSyntaxToken)kNamespace.Node, (Syntax.InternalSyntax.QualifiedNameGreen)qualifiedName.Green, (Syntax.InternalSyntax.NamespaceBody11Green)namespaceBody11.Green).CreateRed();
		}
		...
		{
			return this.NamespaceDeclaration11(this.Token(TestLangOneSyntaxKind.KNamespace), qualifiedName, namespaceBody11);
		}
		...
		public NamespaceBody11Syntax NamespaceBody11(SyntaxToken tOpenBrace, SyntaxList<Declaration11Syntax> declaration11, SyntaxToken tCloseBrace)
		{
		    ...
		    if (tCloseBrace == null) throw new ArgumentNullException(nameof(tCloseBrace));
		    if (tCloseBrace.GetKind() != TestLangOneSyntaxKind.TCloseBrace) throw new ArgumentException(nameof(tCloseBrace));
		    return (NamespaceBody11Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NamespaceBody11((InternalSyntaxToken)tOpenBrace.Node, Microsoft.CodeAnalysis.Syntax.InternalSyntax.GreenNodeExtensions.ToGreenList<Declaration11Green>(declaration11.Node), (InternalSyntaxToken)tCloseBrace.Node).CreateRed();
		}
		
		public NamespaceBody11Syntax NamespaceBody11()
		{
			return this.NamespaceBody11(this.Token(TestLangOneSyntaxKind.TOpenBrace), default, this.Token(TestLangOneSyntaxKind.TCloseBrace));
		}
		...
		public Declaration11Syntax Declaration11(Vertex11Syntax vertex11)
		{
		    ...
		    return (Declaration11Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration11((Syntax.InternalSyntax.Vertex11Green)vertex11.Green).CreateRed();
		}
		...
		public Declaration11Syntax Declaration11(Arrow11Syntax arrow11)
		{
		    ...
		    return (Declaration11Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Declaration11((Syntax.InternalSyntax.Arrow11Green)arrow11.Green).CreateRed();
		}
		...
		public Vertex11Syntax Vertex11(SyntaxToken kVertex, NameSyntax name, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Vertex11Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Vertex11((InternalSyntaxToken)kVertex.Node, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Vertex11Syntax Vertex11(NameSyntax name)
		{
			return this.Vertex11(this.Token(TestLangOneSyntaxKind.KVertex), name, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		...
		public Arrow11Syntax Arrow11(SyntaxToken kArrow, QualifiedNameSyntax source, SyntaxToken tArrow, QualifiedNameSyntax target, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.GetKind() != TestLangOneSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (Arrow11Syntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Arrow11((InternalSyntaxToken)kArrow.Node, (Syntax.InternalSyntax.QualifiedNameGreen)source.Green, (InternalSyntaxToken)tArrow.Node, (Syntax.InternalSyntax.QualifiedNameGreen)target.Green, (InternalSyntaxToken)tSemicolon.Node).CreateRed();
		}
		
		public Arrow11Syntax Arrow11(QualifiedNameSyntax source, QualifiedNameSyntax target)
		{
			return this.Arrow11(this.Token(TestLangOneSyntaxKind.KArrow), source, this.Token(TestLangOneSyntaxKind.TArrow), target, this.Token(TestLangOneSyntaxKind.TSemicolon));
		}
		
		public NameSyntax Name(IdentifierSyntax identifier)
		{
		    if (identifier == null) throw new ArgumentNullException(nameof(identifier));
		    return (NameSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Name((Syntax.InternalSyntax.IdentifierGreen)identifier.Green).CreateRed();
		}
		
		public QualifiedNameSyntax QualifiedName(QualifierSyntax qualifier)
		{
		    if (qualifier == null) throw new ArgumentNullException(nameof(qualifier));
		    return (QualifiedNameSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.QualifiedName((Syntax.InternalSyntax.QualifierGreen)qualifier.Green).CreateRed();
		}
		
		public QualifierSyntax Qualifier(SeparatedSyntaxList<IdentifierSyntax> identifier)
		{
		    if (identifier == null) throw new ArgumentNullException(nameof(identifier));
		    return (QualifierSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Qualifier(Microsoft.CodeAnalysis.Syntax.InternalSyntax.GreenNodeExtensions.ToGreenSeparatedList<IdentifierGreen>(identifier.Node)).CreateRed();
		}
		
		public IdentifierSyntax Identifier(SyntaxToken identifier)
		{
		    if (identifier == null) throw new ArgumentNullException(nameof(identifier));
		    return (IdentifierSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Identifier((InternalSyntaxToken)identifier.Node).CreateRed();
		}
		...
		public LiteralSyntax Literal(NullLiteralSyntax nullLiteral)
		{
		    ...
		    return (LiteralSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Literal((Syntax.InternalSyntax.NullLiteralGreen)nullLiteral.Green).CreateRed();
		}
		...
		public LiteralSyntax Literal(BooleanLiteralSyntax booleanLiteral)
		{
		    ...
		    return (LiteralSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Literal((Syntax.InternalSyntax.BooleanLiteralGreen)booleanLiteral.Green).CreateRed();
		}
		...
		public LiteralSyntax Literal(IntegerLiteralSyntax integerLiteral)
		{
		    ...
		    return (LiteralSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Literal((Syntax.InternalSyntax.IntegerLiteralGreen)integerLiteral.Green).CreateRed();
		}
		...
		public LiteralSyntax Literal(DecimalLiteralSyntax decimalLiteral)
		{
		    ...
		    return (LiteralSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Literal((Syntax.InternalSyntax.DecimalLiteralGreen)decimalLiteral.Green).CreateRed();
		}
		...
		public LiteralSyntax Literal(ScientificLiteralSyntax scientificLiteral)
		{
		    ...
		    return (LiteralSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Literal((Syntax.InternalSyntax.ScientificLiteralGreen)scientificLiteral.Green).CreateRed();
		}
		...
		public LiteralSyntax Literal(StringLiteralSyntax stringLiteral)
		{
		    ...
		    return (LiteralSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.Literal((Syntax.InternalSyntax.StringLiteralGreen)stringLiteral.Green).CreateRed();
		}
		
		public NullLiteralSyntax NullLiteral(SyntaxToken kNull)
		{
		    if (kNull == null) throw new ArgumentNullException(nameof(kNull));
		    if (kNull.GetKind() != TestLangOneSyntaxKind.KNull) throw new ArgumentException(nameof(kNull));
		    return (NullLiteralSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.NullLiteral((InternalSyntaxToken)kNull.Node).CreateRed();
		}
		
		public NullLiteralSyntax NullLiteral()
		{
			return this.NullLiteral(this.Token(TestLangOneSyntaxKind.KNull));
		}
		
		public BooleanLiteralSyntax BooleanLiteral(SyntaxToken booleanLiteral)
		{
		    if (booleanLiteral == null) throw new ArgumentNullException(nameof(booleanLiteral));
		    return (BooleanLiteralSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.BooleanLiteral((InternalSyntaxToken)booleanLiteral.Node).CreateRed();
		}
		...
		public IntegerLiteralSyntax IntegerLiteral(SyntaxToken lInteger)
		{
		    ...
		    if (lInteger.GetKind() != TestLangOneSyntaxKind.LInteger) throw new ArgumentException(nameof(lInteger));
		    return (IntegerLiteralSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.IntegerLiteral((InternalSyntaxToken)lInteger.Node).CreateRed();
		}
		...
		public DecimalLiteralSyntax DecimalLiteral(SyntaxToken lDecimal)
		{
		    ...
		    if (lDecimal.GetKind() != TestLangOneSyntaxKind.LDecimal) throw new ArgumentException(nameof(lDecimal));
		    return (DecimalLiteralSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.DecimalLiteral((InternalSyntaxToken)lDecimal.Node).CreateRed();
		}
		...
		public ScientificLiteralSyntax ScientificLiteral(SyntaxToken lScientific)
		{
		    ...
		    if (lScientific.GetKind() != TestLangOneSyntaxKind.LScientific) throw new ArgumentException(nameof(lScientific));
		    return (ScientificLiteralSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.ScientificLiteral((InternalSyntaxToken)lScientific.Node).CreateRed();
		}
		...
		public StringLiteralSyntax StringLiteral(SyntaxToken lRegularString)
		{
		    ...
		    if (lRegularString.GetKind() != TestLangOneSyntaxKind.LRegularString) throw new ArgumentException(nameof(lRegularString));
		    return (StringLiteralSyntax)TestLangOneLanguage.Instance.InternalSyntaxFactory.StringLiteral((InternalSyntaxToken)lRegularString.Node).CreateRed();
		}
