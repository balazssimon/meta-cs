...
{
	public class TestLexerModeTokensSyntaxKind : SyntaxKind
	{
        public static readonly TestLexerModeTokensSyntaxKind __FirstToken;
        public static readonly int __FirstTokenValue;
        public static readonly TestLexerModeTokensSyntaxKind __LastToken;
        public static readonly int __LastTokenValue;
        public static readonly TestLexerModeTokensSyntaxKind __FirstFixedToken;
        public static readonly int __FirstFixedTokenValue;
        public static readonly TestLexerModeTokensSyntaxKind __LastFixedToken;
		...
		public const string LInteger = nameof(LInteger); // 101
		public const string LDecimal = nameof(LDecimal); // 102
		public const string LScientific = nameof(LScientific); // 103
		public const string LDateTimeOffset = nameof(LDateTimeOffset); // 104
		public const string LDateTime = nameof(LDateTime); // 105
		public const string LDate = nameof(LDate); // 106
		public const string LTime = nameof(LTime); // 107
		public const string LChar = nameof(LChar); // 108
		...
		public const string LTemplateLineControl = nameof(LTemplateLineControl); // 121
		public const string LTemplateOutput = nameof(LTemplateOutput); // 122
		public const string LTemplateCrLf = nameof(LTemplateCrLf); // 123
		public const string LTemplateLineBreak = nameof(LTemplateLineBreak); // 124
		public const string TTemplateStatementStart = nameof(TTemplateStatementStart); // 125
		public const string TTemplateStatementEnd = nameof(TTemplateStatementEnd); // 126
		...
		protected TestLexerModeTokensSyntaxKind(string name)
            : base(name)
        {
        }

        protected TestLexerModeTokensSyntaxKind(EnumObject retargetedValue)
            : base(retargetedValue)
        {
        }

        static TestLexerModeTokensSyntaxKind()
        {
            EnumObject.AutoInit<TestLexerModeTokensSyntaxKind>();
        ...
        public static implicit operator TestLexerModeTokensSyntaxKind(string name)
        {
            return FromString<TestLexerModeTokensSyntaxKind>(name);
        }

        public static explicit operator TestLexerModeTokensSyntaxKind(int value)
        {
            return FromIntUnsafe<TestLexerModeTokensSyntaxKind>(value);
        }
