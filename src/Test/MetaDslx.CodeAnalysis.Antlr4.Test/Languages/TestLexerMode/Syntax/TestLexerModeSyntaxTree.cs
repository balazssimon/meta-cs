...
namespace MetaDslx.CodeAnalysis.Antlr4Test
{
    ...
    /// </summary>
    public abstract partial class TestLexerModeSyntaxTree : LanguageSyntaxTree
    {
        internal static readonly TestLexerModeSyntaxTree Dummy = new DummySyntaxTree();
        /// <summary>
        /// The options used by the parser to produce the syntax tree.
        /// </summary>
        public new abstract TestLexerModeParseOptions Options { get; }
        ...
        /// <summary>
        /// Produces a clone of a <see cref="TestLexerModeSyntaxNode"/> which will have current syntax tree as its parent.
        /// 
        /// Caller must guarantee that if the same instance of <see cref="TestLexerModeSyntaxNode"/> makes multiple calls
        ...
        protected T CloneNodeAsRoot<T>(T node) where T : TestLexerModeSyntaxNode
        {
            return TestLexerModeSyntaxNode.CloneNodeAsRoot(node, this);
        }
        /// <summary>
        /// Gets the root node of the syntax tree.
        /// </summary>
        public new abstract TestLexerModeSyntaxNode GetRoot(CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets the root node of the syntax tree if it is already available.
        /// </summary>
        public abstract bool TryGetRoot(out TestLexerModeSyntaxNode root);
        /// <summary>
        ...
        /// </remarks>
        public new virtual Task<TestLexerModeSyntaxNode> GetRootAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            TestLexerModeSyntaxNode node;
        ...
        /// </summary>
        public static TestLexerModeSyntaxTree Create(TestLexerModeSyntaxNode root, TestLexerModeParseOptions options = null, string path = "", SourceText text = null, Encoding encoding = null, SourceHashAlgorithm checksumAlgorithm = SourceHashAlgorithm.Sha1)
        {
            if (root == null)
            {
                throw new ArgumentNullException(nameof(root));
            }
            var directives = root.Kind == TestLexerModeSyntaxKind.Main && root is ICompilationUnitRootSyntax compilationUnitRoot ?
            ...
            return new ParsedSyntaxTree(
                ...
                path: path,
                options: options ?? TestLexerModeParseOptions.Default,
                root: root,
        ...
        internal static TestLexerModeSyntaxTree CreateForDebugger(TestLexerModeSyntaxNode root, SourceText text, TestLexerModeParseOptions options)
        {
        ...
        /// <summary>
        /// <para>
        /// Internal helper for <see cref="TestLexerModeSyntaxNode"/> class to create a new syntax tree rooted at the given root node.
        /// This method does not create a clone of the given root, but instead preserves it's reference identity.
        /// </para>
        /// <para>NOTE: This method is only intended to be used from <see cref="TestLexerModeSyntaxNode.SyntaxTree"/> property.</para>
        /// <para>NOTE: Do not use this method elsewhere, instead use <see cref="Create(TestLexerModeSyntaxNode, CSharpParseOptions, string, Encoding)"/> method for creating a syntax tree.</para>
        /// </summary>
        internal static TestLexerModeSyntaxTree CreateWithoutClone(TestLexerModeSyntaxNode root)
        {
            Debug.Assert(root != null);
            return new ParsedSyntaxTree(
                textOpt: null,
                ...
                path: "",
                options: TestLexerModeParseOptions.Default,
                root: root,
        ...
        /// </summary>
        public static TestLexerModeSyntaxTree ParseText(
            string text,
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            options = options ?? TestLexerModeParseOptions.Default;
            using (var parser = new TestLexerModeSyntaxParser(text, options, oldTree: null, changes: null, cancellationToken: cancellationToken))
            {
        ...
        {
            return new Antlr4CompletionSource(this.GetRoot(cancellationToken), TestLexerModeParser._ATN).GetTokenSuggestions(position, cancellationToken);
        }
        public new ImmutableArray<TestLexerModeSyntaxKind> LookupTokens(int position, CancellationToken cancellationToken)
        {
            return this.LookupTokensCore(position, cancellationToken).SelectAsArray(kind => (TestLexerModeSyntaxKind)kind);
        }
        #endregion
        #region Changes
        /// <summary>
        ...
        private SyntaxTree WithChanges(SourceText newText, IReadOnlyList<TextChangeRange> changes)
        {
            ...
            using (var parser = new TestLexerModeSyntaxParser(newText, this.Options, oldTree?.GetRoot(), changes))
            {
                var compilationUnit = (MainSyntax)parser.Parse();
        ...
        #endregion
        internal sealed class DummySyntaxTree : TestLexerModeSyntaxTree
        {
            private readonly TestLexerModeSyntaxNode _node;
            ...
            public override TestLexerModeParseOptions Options
            {
                get { return TestLexerModeParseOptions.Default; }
            }
            ...
            public override TestLexerModeSyntaxNode GetRoot(CancellationToken cancellationToken)
            {
                return _node;
            }
            public override bool TryGetRoot(out TestLexerModeSyntaxNode root)
            {
                root = _node;
                return true;
            }
            ...
            {
                return TestLexerModeLanguage.Instance.SyntaxFactory.SyntaxTree((LanguageSyntaxNode)root, options: (TestLexerModeParseOptions)options, path: FilePath, encoding: null);
            }
            public override SyntaxTree WithFilePath(string path)
            {
                return TestLexerModeLanguage.Instance.SyntaxFactory.SyntaxTree(_node, options: this.Options, path: path, encoding: null);
            }
        }
        private class ParsedSyntaxTree : TestLexerModeSyntaxTree
        {
            private readonly TestLexerModeParseOptions _options;
            private readonly string _path;
            private readonly TestLexerModeSyntaxNode _root;
            private readonly bool _hasCompilationUnitRoot;
            private readonly Encoding _encodingOpt;
            private readonly SourceHashAlgorithm _checksumAlgorithm;
            private SourceText _lazyText;
            internal ParsedSyntaxTree(SourceText textOpt, Encoding encodingOpt, SourceHashAlgorithm checksumAlgorithm, string path, TestLexerModeParseOptions options, TestLexerModeSyntaxNode root, DirectiveStack directives, bool cloneRoot = true)
            {
                Debug.Assert(root != null);
                ...
                _hasCompilationUnitRoot = root.Kind == TestLexerModeSyntaxKind.Main;
        ...
        {
            public DebuggerSyntaxTree(TestLexerModeSyntaxNode root, SourceText text, TestLexerModeParseOptions options)
                : base(
                    text,
                    text.Encoding,
