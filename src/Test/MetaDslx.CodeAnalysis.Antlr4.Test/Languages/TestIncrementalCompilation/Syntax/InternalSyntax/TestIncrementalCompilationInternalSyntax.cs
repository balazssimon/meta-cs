...
namespace MetaDslx.CodeAnalysis.Antlr4Test.Languages.TestIncrementalCompilation.Syntax.InternalSyntax
{
	...
	internal abstract class GreenSyntaxNode : InternalSyntaxNode
    {
		...
		/// </summary>
		/// <returns>
		/// A TestIncrementalCompilationSyntaxNode derived from StructuredTriviaSyntax, with the structured view of this trivia node. 
			...
			if (trivia.HasStructure)
			{
				...
				if (parent != null)
				{
					...
					lock (structsInParent)
					{
						...
						{
							structure = TestIncrementalCompilationStructuredTriviaSyntax.Create(trivia);
				...
				{
					return TestIncrementalCompilationStructuredTriviaSyntax.Create(trivia);
				}
			}
    ...
    {
        internal GreenStructuredTriviaSyntax(TestIncrementalCompilationSyntaxKind kind, DiagnosticInfo[] diagnostics = null, SyntaxAnnotation[] annotations = null)
            : base(kind, diagnostics, annotations)
        {
            this.Initialize();
        }
    ...
    internal sealed partial class GreenSkippedTokensTriviaSyntax : GreenStructuredTriviaSyntax
    {
        ...
        internal GreenSkippedTokensTriviaSyntax(TestIncrementalCompilationSyntaxKind kind, GreenNode tokens, DiagnosticInfo[] diagnostics = null, SyntaxAnnotation[] annotations = null)
            : base(kind, diagnostics, annotations)
        {
            this.SlotCount = 1;
            if (tokens != null)
        ...
        protected override SyntaxNode CreateRed(SyntaxNode parent, int position) => new TestIncrementalCompilationSkippedTokensTriviaSyntax(this, (TestIncrementalCompilationSyntaxNode)parent, position);

        public override TResult Accept<TResult>(TestIncrementalCompilationSyntaxVisitor<TResult> visitor) => visitor.VisitSkippedTokensTrivia(this);

        public override void Accept(TestIncrementalCompilationSyntaxVisitor visitor) => visitor.VisitSkippedTokensTrivia(this);
	...
	internal class TestIncrementalCompilationInternalSyntaxFactory : InternalSyntaxFactory, MetaDslx.Languages.Antlr4Roslyn.IAntlr4SyntaxFactory
	{
		...
		{
			return new GreenSkippedTokensTriviaSyntax(ToTestIncrementalCompilationSyntaxKind(SyntaxKind.SkippedTokensTrivia), token);
		}
