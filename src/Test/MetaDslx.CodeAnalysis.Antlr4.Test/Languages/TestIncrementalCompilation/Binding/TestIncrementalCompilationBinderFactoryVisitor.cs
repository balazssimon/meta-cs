...
{
    public class TestIncrementalCompilationBinderFactoryVisitor : BinderFactoryVisitor, ITestIncrementalCompilationSyntaxVisitor<Binder>
    {
        ...
        public TestIncrementalCompilationBinderFactoryVisitor(BinderFactory symbolBuilder)
			: base(symbolBuilder)
        {
        ...
        {
            if (unit.Kind == TestIncrementalCompilationSyntaxKind.Main)
            {
