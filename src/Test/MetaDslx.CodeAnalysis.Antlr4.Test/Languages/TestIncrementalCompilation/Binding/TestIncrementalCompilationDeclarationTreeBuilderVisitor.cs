...
{
	public class TestIncrementalCompilationDeclarationTreeBuilderVisitor : DeclarationTreeBuilderVisitor, ITestIncrementalCompilationSyntaxVisitor
	{
        protected TestIncrementalCompilationDeclarationTreeBuilderVisitor(TestIncrementalCompilationSyntaxTree syntaxTree, string scriptClassName, bool isSubmission)
            : base(syntaxTree, scriptClassName, isSubmission)
        {
        }

        public static RootSingleDeclaration ForTree(
            TestIncrementalCompilationSyntaxTree syntaxTree,
