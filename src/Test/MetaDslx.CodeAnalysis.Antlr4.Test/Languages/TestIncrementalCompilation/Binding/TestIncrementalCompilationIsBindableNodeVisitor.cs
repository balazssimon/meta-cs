...
{
	// Make sure to keep this in sync with TestIncrementalCompilationBoundNodeFactoryVisitor
    public class TestIncrementalCompilationIsBindableNodeVisitor : IsBindableNodeVisitor, ITestIncrementalCompilationSyntaxVisitor<bool>
    {
        public TestIncrementalCompilationIsBindableNodeVisitor(BoundTree boundTree)
			: base(boundTree)
        {
