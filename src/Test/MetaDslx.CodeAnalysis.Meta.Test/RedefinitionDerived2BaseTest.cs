...
{
    public class RedefinitionDerived2BaseTest
    {
        [Fact]
        public void TestSingle2Single()
        {
            ...
            var redef = factory.RedefinitionDerived2Base();
        ...
        public void TestSingle2SingleBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.Single2SingleDerived = base1);
        ...
        public void TestSet2SetBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.Set2SetDerived.Add(base1));
        ...
        public void TestList2ListBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.List2ListDerived.Add(base1));
        ...
        public void TestSingle2SetBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.Single2SetDerived.Add(base1));
        ...
        public void TestSet2SingleBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.Set2SingleDerived = base1);
        ...
        public void TestSet2SingleBaseMany()
        {
            ...
            Assert.Contains(derived1, redef.Set2SingleBase);
            Assert.Equal(derived1, redef.Set2SingleDerived);
            redef.Set2SingleBase.Add(derived2);
            Assert.True(redef.Set2SingleBase.Count == 1);
            Assert.Contains(derived2, redef.Set2SingleBase);
            Assert.Equal(derived2, redef.Set2SingleDerived);
            var imodel = model.ToImmutable();
            var ibase1 = base1.ToImmutable(imodel);
            var iderived1 = derived1.ToImmutable(imodel);
        ...
        public void TestSingle2ListBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.Single2ListDerived.Add(base1));
        ...
        public void TestList2SingleBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.List2SingleDerived = base1);
        ...
        public void TestList2SingleBaseMany()
        {
            ...
            Assert.Contains(derived1, redef.List2SingleBase);
            Assert.Equal(derived1, redef.List2SingleDerived);
            redef.List2SingleBase.Add(derived2);
            Assert.True(redef.List2SingleBase.Count == 1);
            Assert.Contains(derived2, redef.List2SingleBase);
            Assert.Equal(derived2, redef.List2SingleDerived);
            var imodel = model.ToImmutable();
            var ibase1 = base1.ToImmutable(imodel);
            var iderived1 = derived1.ToImmutable(imodel);
            var iderived2 = derived2.ToImmutable(imodel);
        ...
        public void TestSet2ListBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.Set2ListDerived.Add(base1));
        ...
        public void TestList2SetBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.List2SetDerived.Add(base1));
        ...
        public void TestSet2MultiSetBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.Set2MultiSetDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.Set2MultiSetDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.Set2MultiSetDerived.Add(base1));
        ...
        public void TestSet2MultiListBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.Set2MultiListDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.Set2MultiListDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.Set2MultiListDerived.Add(base1));
        ...
        public void TestList2MultiSetBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.List2MultiSetDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.List2MultiSetDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.List2MultiSetDerived.Add(base1));
        ...
        public void TestList2MultiListBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.List2MultiListDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.List2MultiListDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.List2MultiListDerived.Add(base1));
        ...
        public void TestMultiSet2SetBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.MultiSet2SetDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.MultiSet2SetDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.MultiSet2SetDerived.Add(base1));
        ...
        public void TestMultiList2SetBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.MultiList2SetDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.MultiList2SetDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.MultiList2SetDerived.Add(base1));
        ...
        public void TestMultiSet2ListBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.MultiSet2ListDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.MultiSet2ListDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.MultiSet2ListDerived.Add(base1));
        ...
        public void TestMultiList2ListBaseError()
        {
            ...
            var derived1 = factory.DerivedClass();
            var redef = factory.RedefinitionDerived2Base();
            Assert.Throws<ModelException>(() => redef.MultiList2ListDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.MultiList2ListDerived.Add(base1));
            Assert.Throws<ModelException>(() => redef.MultiList2ListDerived.Add(base1));
