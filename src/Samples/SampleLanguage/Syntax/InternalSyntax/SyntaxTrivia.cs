...
namespace MetaDslx.Compiler.CSharp.Syntax.InternalSyntax
{
    internal class SyntaxTrivia : CSharpSyntaxNode
    {
        ...
        public static implicit operator MetaDslx.Compiler.SyntaxTrivia(SyntaxTrivia trivia)
        {
            return new MetaDslx.Compiler.SyntaxTrivia(default(MetaDslx.Compiler.SyntaxToken), trivia, position: 0, index: 0);
        }
