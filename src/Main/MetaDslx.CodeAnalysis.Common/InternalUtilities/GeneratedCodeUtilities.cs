...
namespace Roslyn.Utilities
{
    internal static class GeneratedCodeUtilities
    {
        ...
        internal static bool IsGeneratedSymbolWithGeneratedCodeAttribute(
            IDeclaredSymbol symbol, INamedTypeSymbol generatedCodeAttribute)
        {
            ...
            return symbol.ContainingSymbol is IDeclaredSymbol declSymbol && IsGeneratedSymbolWithGeneratedCodeAttribute(declSymbol, generatedCodeAttribute);
        }
