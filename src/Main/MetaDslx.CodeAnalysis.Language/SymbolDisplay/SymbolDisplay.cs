...
#pragma warning restore CA1200 // Avoid using cref tags with a prefix
    public class SymbolDisplay
    {
        ...
        /// The return value is not expected to be syntactically valid C#.
        /// </remarks>
        public virtual string ToMinimalDisplayString(
            ISymbol symbol,
        ...
        /// </remarks>
        public virtual ImmutableArray<SymbolDisplayPart> ToDisplayParts(
            ISymbol symbol,
            SymbolDisplayFormat format = null)
        {
        ...
        /// Parts are not localized until they are converted to strings.
        /// </remarks>
        public virtual ImmutableArray<SymbolDisplayPart> ToMinimalDisplayParts(
            ISymbol symbol,
            SemanticModel semanticModel,
            int position,
            SymbolDisplayFormat format = null)
