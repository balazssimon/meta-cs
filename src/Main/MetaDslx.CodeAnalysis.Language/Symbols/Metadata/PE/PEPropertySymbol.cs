...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
        ...
        : PropertySymbol
    {
            ...
            PEMethodSymbol setMethod)
        {
            ...
            {
                result._lazyUseSiteDiagnostic = new LanguageDiagnosticInfo(ErrorCode.ERR_BindToBogus, result);
            }
            ...
            MetadataDecoder metadataDecoder)
        {
            ...
            {
                _lazyUseSiteDiagnostic = new LanguageDiagnosticInfo(ErrorCode.ERR_BindToBogus, this);
            }
