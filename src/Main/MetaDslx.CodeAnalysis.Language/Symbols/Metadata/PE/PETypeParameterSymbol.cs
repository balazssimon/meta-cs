...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
        ...
        : TypeParameterSymbol
    {
        ...
        /// </summary>
        private DiagnosticInfo _lazyConstraintsUseSiteErrorInfo = LanguageDiagnosticInfo.EmptyErrorInfo; // Indicates unknown state.
            ...
            GenericParameterHandle handle)
        {
            ...
            catch (BadImageFormatException)
            {
                ...
                _lazyConstraintsUseSiteErrorInfo = new LanguageDiagnosticInfo(ErrorCode.ERR_BindToBogus, this);
            }
        ...
        private ImmutableArray<TypeWithAnnotations> GetDeclaredConstraintTypes()
        {
            if (_lazyDeclaredConstraintTypes.IsDefault)
            {
                ...
                catch (BadImageFormatException)
                {
                    ...
                    Interlocked.CompareExchange(ref _lazyConstraintsUseSiteErrorInfo, new LanguageDiagnosticInfo(ErrorCode.ERR_BindToBogus, this), LanguageDiagnosticInfo.EmptyErrorInfo);
                }
        ...
        private TypeParameterBounds GetBounds(ConsList<TypeParameterSymbol> inProgress, bool early)
        {
            ...
            if (!currentBounds.IsSet(early))
            {
                ...
                Interlocked.CompareExchange(ref _lazyConstraintsUseSiteErrorInfo, errorInfo, LanguageDiagnosticInfo.EmptyErrorInfo);
                Interlocked.CompareExchange(ref _lazyBounds, bounds, currentBounds);
            }
        ...
        internal override DiagnosticInfo GetConstraintsUseSiteErrorInfo()
        {
            ...
            Debug.Assert(!ReferenceEquals(_lazyConstraintsUseSiteErrorInfo, LanguageDiagnosticInfo.EmptyErrorInfo));
