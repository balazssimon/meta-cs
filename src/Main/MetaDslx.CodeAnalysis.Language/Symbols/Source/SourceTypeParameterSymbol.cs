...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract class SourceTypeParameterSymbolBase : TypeParameterSymbol, IAttributeTargetSymbol
    {
        ...
        internal ImmutableArray<SyntaxList<CSharpSyntaxNode>> MergedAttributeDeclarationSyntaxLists
        {
            get
            {
        ...
        internal override sealed void DecodeWellKnownAttribute(ref DecodeWellKnownAttributeArguments<CSharpSyntaxNode, CSharpAttributeData, AttributeLocation> arguments)
        {
            throw new System.NotImplementedException("TODO:MetaDslx");
        }
