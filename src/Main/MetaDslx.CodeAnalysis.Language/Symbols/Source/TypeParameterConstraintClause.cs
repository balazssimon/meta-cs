...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal sealed class TypeParameterConstraintClause
    {
        ...
        internal static TypeParameterConstraintClause Create(
            ...
            ImmutableArray<CSharpSyntaxNode> typeConstraintsSyntax = default)
        {
        ...
        private TypeParameterConstraintClause(
            TypeParameterConstraintKind constraints,
            ImmutableArray<TypeWithAnnotations> constraintTypes,
            ImmutableArray<CSharpSyntaxNode> typeConstraintsSyntax,
        ...
        /// </summary>
        internal readonly ImmutableArray<CSharpSyntaxNode> TypeConstraintsSyntax;
