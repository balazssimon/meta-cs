...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal static partial class TypeSymbolExtensions
    {
        static public NamedTypeSymbol AsUnboundGenericType(this NamedTypeSymbol type)
        {
            ...
            var typeArguments = UnboundArgumentErrorTypeSymbol.CreateTypeArguments(
                ...
                n,
                new LanguageDiagnosticInfo(ErrorCode.ERR_UnexpectedUnboundGenericName));
    ...
    internal sealed class UnboundArgumentErrorTypeSymbol : ErrorTypeSymbol
    {
        ...
        public static readonly ErrorTypeSymbol Instance = new UnboundArgumentErrorTypeSymbol(string.Empty, new LanguageDiagnosticInfo(ErrorCode.ERR_UnexpectedUnboundGenericName));
