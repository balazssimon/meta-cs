        ...
        internal override DiagnosticInfo ErrorInfo
        {
            get
            {
                ...
                if (containingAssembly.IsMissing)
                {
                    ...
                    return new LanguageDiagnosticInfo(ErrorCode.ERR_NoTypeDef, this, containingAssembly.Identity);
                }
                else
                {
                    ...
                    if (containingModule.IsMissing)
                    {
                        ...
                        return new LanguageDiagnosticInfo(ErrorCode.ERR_NoTypeDefFromModule, this, containingModule.Name);
                    }
                    ...
                    if (containingAssembly.Dangerous_IsFromSomeCompilation)
                    {
                        ...
                        return new LanguageDiagnosticInfo(ErrorCode.ERR_MissingTypeInSource, this);
                    }
                    else
                    {
                        ...
                        return new LanguageDiagnosticInfo(ErrorCode.ERR_MissingTypeInAssembly, this, containingAssembly.Name);
                    }
                }
            }
        }
        ...
        internal class TopLevel : MissingMetadataTypeSymbol
        {
            ...
            internal override DiagnosticInfo ErrorInfo
            {
                get
                {
                    ...
                    {
                        return new LanguageDiagnosticInfo(ErrorCode.ERR_PredefinedTypeNotFound, MetadataHelpers.BuildQualifiedName(_namespaceName, MetadataName));
                    }
