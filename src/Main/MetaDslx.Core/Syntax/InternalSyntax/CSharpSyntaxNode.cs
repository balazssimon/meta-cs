...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.InternalSyntax
{
    ...
    public abstract class CSharpSyntaxNode : SyntaxNodeAdapter
    {
        protected CSharpSyntaxNode(int kind)
            : base(kind)
        {
            GreenStats.NoteGreen(this);
        }

        protected CSharpSyntaxNode(int kind, int fullWidth)
            : base(kind, fullWidth)
        {
            GreenStats.NoteGreen(this);
        }

        protected CSharpSyntaxNode(int kind, DiagnosticInfo[] diagnostics)
            : base(kind, diagnostics)
        {
            GreenStats.NoteGreen(this);
        }

        protected CSharpSyntaxNode(int kind, DiagnosticInfo[] diagnostics, int fullWidth)
            : base(kind, diagnostics, fullWidth)
        {
            GreenStats.NoteGreen(this);
        }

        protected CSharpSyntaxNode(int kind, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations)
            : base(kind, diagnostics, annotations)
        {
            GreenStats.NoteGreen(this);
        }

        protected CSharpSyntaxNode(int kind, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations, int fullWidth)
