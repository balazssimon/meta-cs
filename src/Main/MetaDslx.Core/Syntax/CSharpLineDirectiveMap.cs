...
namespace Microsoft.CodeAnalysis.CSharp.Syntax
{
    ...
    /// </summary>
    internal class CSharpLineDirectiveMap : LineDirectiveMap<CSharpSyntaxNode>
    {
        ...
        protected override bool ShouldAddDirective(CSharpSyntaxNode directiveNode)
        {
        ...
        protected override LineMappingEntry GetEntry(CSharpSyntaxNode directiveNode, SourceText sourceText, LineMappingEntry previous)
        {
