...
{
    internal struct LanguageTypeInfo : IEquatable<LanguageTypeInfo>
    {
        internal static readonly LanguageTypeInfo None = new LanguageTypeInfo(null, null, Conversion.Identity);
        ...
        internal LanguageTypeInfo(TypeSymbol type, TypeSymbol convertedType, Conversion implicitConversion)
        {
        ...
        public static implicit operator TypeInfo(LanguageTypeInfo info)
        {
        ...
        {
            return obj is LanguageTypeInfo && Equals((LanguageTypeInfo)obj);
        }

        public bool Equals(LanguageTypeInfo other)
        {
