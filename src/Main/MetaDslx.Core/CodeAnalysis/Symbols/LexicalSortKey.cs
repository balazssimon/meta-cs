...
namespace MetaDslx.CodeAnalysis.Symbols
{
    ...
    public struct LexicalSortKey
    {
        ...
        public LexicalSortKey(SyntaxReference syntaxRef, LanguageCompilation compilation)
            : this((LanguageSyntaxTree)syntaxRef.SyntaxTree, syntaxRef.Span.Start, compilation)
        {
        }
        ...
        public LexicalSortKey(Location location, LanguageCompilation compilation)
            : this((LanguageSyntaxTree)location.SourceTree, location.SourceSpan.Start, compilation)
        {
        }
        ...
        // if the node is stored in the constructor of the symbol. In particular, do not call this on the result of a GetSyntax()
        // call on a SyntaxReference.
        public LexicalSortKey(SyntaxToken token, LanguageCompilation compilation)
            : this((LanguageSyntaxTree)token.SyntaxTree, token.SpanStart, compilation)
        {
        }
