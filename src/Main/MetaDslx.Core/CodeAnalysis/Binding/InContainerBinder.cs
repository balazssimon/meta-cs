...
namespace MetaDslx.CodeAnalysis.Binding
{
    ...
    internal sealed class InContainerBinder : Binder
    {
        ...
        private readonly SyntaxList<SyntaxNode> _usingsSyntax;
        ...
        /// </summary>
        internal InContainerBinder(INamespaceOrTypeSymbol container, Binder next, SyntaxNode declarationSyntax, bool inUsing)
            : base(next)
        {
