...
{
    public partial class InternalSyntaxRewriter : InternalSyntaxVisitor<InternalSyntaxNode>
    {
        ...
        public SyntaxList<TNode> VisitList<TNode>(SyntaxList<TNode> list) where TNode : InternalSyntaxNode
        {
            ...
            for (int i = 0, n = list.Count; i < n; i++)
            {
                ...
                if (alternate != null)
                {
                    Debug.Assert(visited != null && visited.RawKind != (int)SyntaxKind.None, "Cannot remove node using Syntax.InternalSyntax.SyntaxRewriter.");
        ...
        public SeparatedSyntaxList<TNode> VisitList<TNode>(SeparatedSyntaxList<TNode> list) where TNode : InternalSyntaxNode
        {
            ...
            // derive from InternalSyntax.GreenNode.  So this cast is appropriately
            // typesafe.
