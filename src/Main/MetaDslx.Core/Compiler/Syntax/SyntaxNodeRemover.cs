                    ...
                    else
                    {
                        ...
                        if (this.IsForRemoval(node))
                        {
                            ...
                            CommonSyntaxNodeRemover.GetSeparatorInfo(
                                withSeps, i, this.Language.SyntaxFactory.DefaultEndOfLineTrivia.RawKind,
                ...
                if (node.ContainsDirectives)
                {
                    ...
                    foreach (var directive in directivesInSpan)
                    {
                        ...
                        else 
                        {
                            ...
                            var relatedDirectives = ((IDirectiveTriviaSyntax)directive).GetRelatedDirectives().Cast<SyntaxNode>();
