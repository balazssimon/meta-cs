...
namespace MetaDslx.Compiler.Text
{
    ...
    public sealed class EmbeddedText
    {
        ...
        public static EmbeddedText FromSource(string filePath, SourceText text)
        {
            ...
            {
                throw new ArgumentException(CompilerResources.SourceTextCannotBeEmbedded, nameof(text));
            }
        ...
        private static void ValidateFilePath(string filePath)
        {
            ...
            {
                throw new ArgumentException(CompilerResources.ArgumentCannotBeEmpty, nameof(filePath));
            }
        }
