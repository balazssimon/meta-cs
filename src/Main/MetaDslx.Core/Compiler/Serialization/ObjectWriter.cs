    ...
    public sealed partial class ObjectWriter : IDisposable
    {
        ...
        public void WriteValue(object value)
        {
            ...
            else if (type.IsArray)
            {
                ...
                if (instance.Rank > 1)
                {
                    throw new InvalidOperationException(CompilerResources.Arrays_with_more_than_one_dimension_cannot_be_serialized);
                }
        ...
        internal void WriteCompressedUInt(uint value)
        {
            ...
            {
                throw new ArgumentException(CompilerResources.Value_too_large_to_be_represented_as_a_30_bit_unsigned_integer);
            }
        }
        ...
        {
            return new InvalidOperationException(string.Format(CompilerResources.The_type_0_is_not_understood_by_the_serialization_binder, typeName));
        }

        private static Exception NoSerializationWriterException(string typeName)
        {
            return new InvalidOperationException(string.Format(CompilerResources.Cannot_serialize_type_0, typeName));
        }
