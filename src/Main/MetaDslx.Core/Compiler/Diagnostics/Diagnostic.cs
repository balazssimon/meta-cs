...
namespace MetaDslx.Compiler
{
    ...
    public abstract partial class Diagnostic : IEquatable<Diagnostic>, IFormattable
    {
        ...
        {
            return Create(new DiagnosticInfo(descriptor));
        }

        internal static Diagnostic Create(DiagnosticDescriptor descriptor, params object[] arguments)
        {
            return Create(new DiagnosticInfo(descriptor, arguments));
        }
