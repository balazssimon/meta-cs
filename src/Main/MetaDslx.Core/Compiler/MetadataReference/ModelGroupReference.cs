...
namespace MetaDslx.Compiler
{
    public sealed class ModelGroupReference : MetadataReference, IEquatable<ModelGroupReference>
    {
        ...
        internal ModelGroupReference(ImmutableModelGroup modelGroup, MetadataReferenceProperties properties = default)
            : base(properties)
        {
        ...
        {
            return new ModelGroupReference(this.ModelGroup, properties);
        }
    }
}
