...
namespace MetaDslx.Compiler
{
    ...
    public abstract class SemanticModel
    {
        ...
        internal ISymbol0 GetDeclaredSymbolForNode(SyntaxNode declaration, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The symbol declared by the node or null if the node is not a declaration.</returns>
        protected abstract ISymbol0 GetDeclaredSymbolCore(SyntaxNode declaration, CancellationToken cancellationToken = default(CancellationToken));
        ...
        internal ImmutableArray<ISymbol0> GetDeclaredSymbolsForNode(SyntaxNode declaration, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The symbols declared by the node.</returns>
        protected abstract ImmutableArray<ISymbol0> GetDeclaredSymbolsCore(SyntaxNode declaration, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </remarks>
        public ImmutableArray<ISymbol0> LookupSymbols(
            int position,
        ...
        /// </summary>
        protected abstract ImmutableArray<ISymbol0> LookupSymbolsCore(
            int position,
        ...
        /// </remarks>
        public ImmutableArray<ISymbol0> LookupBaseMembers(
            int position,
            string name = null)
        {
        ...
        /// </summary>
        protected abstract ImmutableArray<ISymbol0> LookupBaseMembersCore(
            int position,
            string name);
        ...
        /// </remarks>
        public ImmutableArray<ISymbol0> LookupStaticMembers(
            int position,
            INamespaceOrTypeSymbol container = null,
            string name = null)
        {
        ...
        /// </summary>
        protected abstract ImmutableArray<ISymbol0> LookupStaticMembersCore(
            int position,
            INamespaceOrTypeSymbol container,
            string name);
        ...
        /// </remarks>
        public ImmutableArray<ISymbol0> LookupNamespacesAndTypes(
            int position,
            INamespaceOrTypeSymbol container = null,
            string name = null)
        {
        ...
        /// </summary>
        protected abstract ImmutableArray<ISymbol0> LookupNamespacesAndTypesCore(
            int position,
            INamespaceOrTypeSymbol container,
            string name);
        ...
        /// accessible.
        /// </remarks>
        public ImmutableArray<ISymbol0> LookupLabels(
            int position,
            string name = null)
        {
        ...
        /// </summary>
        protected abstract ImmutableArray<ISymbol0> LookupLabelsCore(
            int position,
            string name);
        ...
        /// </summary>
        internal ImmutableArray<ISymbol0> GetMemberGroup(SyntaxNode node, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// all methods in the group that was consulted are placed in this property.
        /// </summary>
        protected abstract ImmutableArray<ISymbol0> GetMemberGroupCore(SyntaxNode node, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </summary>
        public ISymbol0 GetEnclosingSymbol(int position, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// that the position is considered inside of.
        /// </summary>
        protected abstract ISymbol0 GetEnclosingSymbolCore(int position, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </remarks>
        public bool IsAccessible(int position, ISymbol0 symbol)
        {
        ...
        /// may not be able to be referenced for other reasons, such as name hiding.
        /// </remarks>
        protected abstract bool IsAccessibleCore(int position, ISymbol0 symbol);
        ...
        /// </summary>
        protected internal virtual SyntaxNode GetTopmostNodeForDiagnosticAnalysis(ISymbol0 symbol, SyntaxNode declaringSyntax)
        {
