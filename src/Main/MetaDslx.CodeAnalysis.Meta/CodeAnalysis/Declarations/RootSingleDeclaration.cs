...
namespace MetaDslx.CodeAnalysis.Declarations
{
    public sealed class RootSingleDeclaration : SingleDeclaration
    {
        ...
        public RootSingleDeclaration(
            ...
            : base(string.Empty, string.Empty, symbolType, modelObjectType, treeNode, new SourceLocation(treeNode), true, false, false, null, children, ImmutableArray<DeclarationTreeInfo.Property>.Empty, diagnostics)
        {
