...
namespace MetaDslx.CodeAnalysis.Declarations
{
    ...
    public sealed partial class DeclarationTable
    {
        ...
        private sealed class RootNamespaceLocationComparer : IComparer<SingleDeclaration>
        {
            ...
            internal RootNamespaceLocationComparer(LanguageCompilation compilation)
            {
            ...
            [PerformanceSensitive(
                ...
                Constraint = "Avoid " + nameof(SingleDeclaration.Location) + " since it has a costly allocation on this fast path.")]
