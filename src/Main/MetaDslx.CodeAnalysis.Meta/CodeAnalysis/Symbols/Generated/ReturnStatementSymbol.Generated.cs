...
{
	public abstract partial class ReturnStatementSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_ReturnedValue = new CompletionPart(nameof(StartComputingProperty_ReturnedValue));
            public static readonly CompletionPart FinishComputingProperty_ReturnedValue = new CompletionPart(nameof(FinishComputingProperty_ReturnedValue));
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_ReturnedValue, FinishComputingProperty_ReturnedValue, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
            public static readonly ImmutableHashSet<CompletionPart> All = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_ReturnedValue, FinishComputingProperty_ReturnedValue, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties, CompletionGraph.ChildrenCompleted);
...
{
	public abstract partial class CompletionReturnStatementSymbol : MetaDslx.CodeAnalysis.Symbols.ReturnStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        private global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol _returnedValue;

        public CompletionReturnStatementSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol ReturnedValue
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_ReturnedValue, null, default);
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_ReturnedValue || incompletePart == CompletionParts.FinishComputingProperty_ReturnedValue)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_ReturnedValue))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _returnedValue = CompleteSymbolProperty_ReturnedValue(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_ReturnedValue);
                    }
                }
        ...
        protected abstract global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_ReturnedValue(DiagnosticBag diagnostics, CancellationToken cancellationToken);
...
{
	public partial class MetadataReturnStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionReturnStatementSymbol
	{
        public MetadataReturnStatementSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_ReturnedValue(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(ReturnedValue), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : MetadataReturnStatementSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceReturnStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionReturnStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceReturnStatementSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_ReturnedValue(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(ReturnedValue), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : SourceReturnStatementSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
