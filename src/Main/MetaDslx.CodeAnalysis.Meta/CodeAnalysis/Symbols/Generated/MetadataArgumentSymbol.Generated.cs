...
namespace MetaDslx.CodeAnalysis.Symbols.Metadata
{
	...
	{
        public MetadataArgumentSymbol(Symbol container, object modelObject)
        ...
        {
            return ModelSymbolImplementation.AssignSymbolPropertyValue<string>(this, nameof(ParameterName), diagnostics, cancellationToken);
        }
