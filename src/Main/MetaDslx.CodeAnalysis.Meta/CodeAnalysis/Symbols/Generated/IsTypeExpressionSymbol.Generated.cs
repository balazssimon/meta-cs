...
namespace MetaDslx.CodeAnalysis.Symbols.Completion
{
	public abstract partial class CompletionIsTypeExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.IsTypeExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        protected virtual global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_ValueOperand(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(ValueOperand), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol CompleteSymbolProperty_TypeOperand(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol>(this, nameof(TypeOperand), diagnostics, cancellationToken, out var result);
            return result;
        }
