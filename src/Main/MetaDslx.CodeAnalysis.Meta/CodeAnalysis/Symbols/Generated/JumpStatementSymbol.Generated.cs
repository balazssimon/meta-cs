...
{
	public abstract partial class JumpStatementSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_JumpKind = new CompletionPart(nameof(StartComputingProperty_JumpKind));
            public static readonly CompletionPart FinishComputingProperty_JumpKind = new CompletionPart(nameof(FinishComputingProperty_JumpKind));
...
{
	public abstract partial class CompletionJumpStatementSymbol : MetaDslx.CodeAnalysis.Symbols.JumpStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.JumpKind JumpKind
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_JumpKind, null, default);
                return _jumpKind;
            }
        }

        public override global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol Target
        {
            get
            {
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_JumpKind || incompletePart == CompletionParts.FinishComputingProperty_JumpKind)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_JumpKind))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _jumpKind = CompleteSymbolProperty_JumpKind(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_JumpKind);
                    }
                }
        ...
        protected abstract global::MetaDslx.CodeAnalysis.Symbols.JumpKind CompleteSymbolProperty_JumpKind(DiagnosticBag diagnostics, CancellationToken cancellationToken);
        protected abstract global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol CompleteSymbolProperty_Target(DiagnosticBag diagnostics, CancellationToken cancellationToken);
...
{
	public partial class MetadataJumpStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionJumpStatementSymbol
	{
        public MetadataJumpStatementSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.JumpKind>(this, nameof(JumpKind), diagnostics, cancellationToken);
        }
        ...
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol>(this, nameof(Target), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : MetadataJumpStatementSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceJumpStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionJumpStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceJumpStatementSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.JumpKind CompleteSymbolProperty_JumpKind(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.JumpKind>(this, nameof(JumpKind), diagnostics, cancellationToken);
        }
        protected override global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol CompleteSymbolProperty_Target(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol>(this, nameof(Target), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : SourceJumpStatementSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
