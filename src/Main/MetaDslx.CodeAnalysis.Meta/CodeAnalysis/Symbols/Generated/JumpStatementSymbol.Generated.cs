...
namespace MetaDslx.CodeAnalysis.Symbols.Completion
{
	public abstract partial class CompletionJumpStatementSymbol : MetaDslx.CodeAnalysis.Symbols.JumpStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        protected virtual global::MetaDslx.CodeAnalysis.Symbols.JumpKind CompleteSymbolProperty_JumpKind(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.JumpKind>(this, nameof(JumpKind), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol CompleteSymbolProperty_Target(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol>(this, nameof(Target), diagnostics, cancellationToken, out var result);
            return result;
        }
