...
{
	public partial class ErrorConversionOperatorSymbol : MetaDslx.CodeAnalysis.Symbols.ConversionOperatorSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly Symbol _container;
        private readonly MergedDeclaration? _declaration;
        private readonly object? _modelObject;

        public ErrorConversionOperatorSymbol(Symbol container, object? modelObject = null, MergedDeclaration? declaration = null)
        {
        ...
        public override bool IsStatic => default;

        public override bool IsVirtual => default;

        public override bool IsOverride => default;
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol TargetType => default;

        public override bool IsImplicit => default;
