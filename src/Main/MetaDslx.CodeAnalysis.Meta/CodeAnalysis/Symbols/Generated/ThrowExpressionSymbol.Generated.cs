...
{
	public abstract partial class ThrowExpressionSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_Exception = new CompletionPart(nameof(StartComputingProperty_Exception));
            public static readonly CompletionPart FinishComputingProperty_Exception = new CompletionPart(nameof(FinishComputingProperty_Exception));
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_Exception, FinishComputingProperty_Exception, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
...
{
	public abstract partial class CompletionThrowExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.ThrowExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        private global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol _exception;

        public CompletionThrowExpressionSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol Exception
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_Exception, null, default);
                return _exception;
            }
        }
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_Exception || incompletePart == CompletionParts.FinishComputingProperty_Exception)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_Exception))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _exception = CompleteSymbolProperty_Exception(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_Exception);
                    }
                }
        ...
        protected abstract global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_Exception(DiagnosticBag diagnostics, CancellationToken cancellationToken);
...
{
	public partial class MetadataThrowExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionThrowExpressionSymbol
	{
        public MetadataThrowExpressionSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_Exception(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(Exception), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : MetadataThrowExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceThrowExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionThrowExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceThrowExpressionSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_Exception(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(Exception), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : SourceThrowExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
