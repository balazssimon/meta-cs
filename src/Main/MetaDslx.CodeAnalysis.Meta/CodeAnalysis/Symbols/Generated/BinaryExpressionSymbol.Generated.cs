...
{
	public abstract partial class BinaryExpressionSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_OperatorKind = new CompletionPart(nameof(StartComputingProperty_OperatorKind));
            public static readonly CompletionPart FinishComputingProperty_OperatorKind = new CompletionPart(nameof(FinishComputingProperty_OperatorKind));
            public static readonly CompletionPart StartComputingProperty_LeftOperand = new CompletionPart(nameof(StartComputingProperty_LeftOperand));
            public static readonly CompletionPart FinishComputingProperty_LeftOperand = new CompletionPart(nameof(FinishComputingProperty_LeftOperand));
            public static readonly CompletionPart StartComputingProperty_RightOperand = new CompletionPart(nameof(StartComputingProperty_RightOperand));
            public static readonly CompletionPart FinishComputingProperty_RightOperand = new CompletionPart(nameof(FinishComputingProperty_RightOperand));
...
{
	public abstract partial class CompletionBinaryExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.BinaryExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        private global::MetaDslx.CodeAnalysis.Symbols.BinaryOperatorKind _operatorKind;
        private global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol _leftOperand;
        private global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol _rightOperand;
        private bool _isChecked;
        private global::MetaDslx.CodeAnalysis.Symbols.BinaryOperatorSymbol _operatorMethod;
        private bool _isLifted;

        public CompletionBinaryExpressionSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.BinaryOperatorKind OperatorKind
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_OperatorKind, null, default);
                return _operatorKind;
            }
        }

        public override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol LeftOperand
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_LeftOperand, null, default);
                return _leftOperand;
            }
        }

        public override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol RightOperand
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_RightOperand, null, default);
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.BinaryOperatorSymbol OperatorMethod
        {
            get
            {
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_OperatorKind || incompletePart == CompletionParts.FinishComputingProperty_OperatorKind)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_OperatorKind))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _operatorKind = CompleteSymbolProperty_OperatorKind(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_OperatorKind);
                    }
                }
                else if (incompletePart == CompletionParts.StartComputingProperty_LeftOperand || incompletePart == CompletionParts.FinishComputingProperty_LeftOperand)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_LeftOperand))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _leftOperand = CompleteSymbolProperty_LeftOperand(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_LeftOperand);
                    }
                }
                else if (incompletePart == CompletionParts.StartComputingProperty_RightOperand || incompletePart == CompletionParts.FinishComputingProperty_RightOperand)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_RightOperand))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _rightOperand = CompleteSymbolProperty_RightOperand(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_RightOperand);
                    }
                }
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_OperatorMethod || incompletePart == CompletionParts.FinishComputingProperty_OperatorMethod)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_OperatorMethod))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _operatorMethod = CompleteSymbolProperty_OperatorMethod(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
        ...
        protected abstract global::MetaDslx.CodeAnalysis.Symbols.BinaryOperatorKind CompleteSymbolProperty_OperatorKind(DiagnosticBag diagnostics, CancellationToken cancellationToken);
        protected abstract global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_LeftOperand(DiagnosticBag diagnostics, CancellationToken cancellationToken);
        protected abstract global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_RightOperand(DiagnosticBag diagnostics, CancellationToken cancellationToken);
        protected abstract bool CompleteSymbolProperty_IsChecked(DiagnosticBag diagnostics, CancellationToken cancellationToken);
        protected abstract global::MetaDslx.CodeAnalysis.Symbols.BinaryOperatorSymbol CompleteSymbolProperty_OperatorMethod(DiagnosticBag diagnostics, CancellationToken cancellationToken);
        protected abstract bool CompleteSymbolProperty_IsLifted(DiagnosticBag diagnostics, CancellationToken cancellationToken);
...
{
	public partial class MetadataBinaryExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionBinaryExpressionSymbol
	{
        public MetadataBinaryExpressionSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.BinaryOperatorKind CompleteSymbolProperty_OperatorKind(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.BinaryOperatorKind>(this, nameof(OperatorKind), diagnostics, cancellationToken);
        }

        protected override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_LeftOperand(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(LeftOperand), diagnostics, cancellationToken);
        }

        protected override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_RightOperand(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(RightOperand), diagnostics, cancellationToken);
        }
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.BinaryOperatorSymbol CompleteSymbolProperty_OperatorMethod(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.BinaryOperatorSymbol>(this, nameof(OperatorMethod), diagnostics, cancellationToken);
        }

        protected override bool CompleteSymbolProperty_IsLifted(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(IsLifted), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : MetadataBinaryExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceBinaryExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionBinaryExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceBinaryExpressionSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.BinaryOperatorKind CompleteSymbolProperty_OperatorKind(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.BinaryOperatorKind>(this, nameof(OperatorKind), diagnostics, cancellationToken);
        }
        protected override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_LeftOperand(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(LeftOperand), diagnostics, cancellationToken);
        }
        protected override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_RightOperand(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(RightOperand), diagnostics, cancellationToken);
        }
        protected override bool CompleteSymbolProperty_IsChecked(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.BinaryOperatorSymbol CompleteSymbolProperty_OperatorMethod(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.BinaryOperatorSymbol>(this, nameof(OperatorMethod), diagnostics, cancellationToken);
        }
        protected override bool CompleteSymbolProperty_IsLifted(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
        ...
        public partial class Error : SourceBinaryExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
