...
{
	public abstract partial class MemberReferenceExpressionSymbol
	{
...
namespace MetaDslx.CodeAnalysis.Symbols.Completion
{
	public abstract partial class CompletionMemberReferenceExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.MemberReferenceExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        public CompletionMemberReferenceExpressionSymbol(Symbol container, object? modelObject, bool isError = false)
        {
...
{
	public partial class MetadataMemberReferenceExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionMemberReferenceExpressionSymbol
	{
        public MetadataMemberReferenceExpressionSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(Instance), diagnostics, cancellationToken);
        }

        protected override string CompleteSymbolProperty_MemberName(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<string>(this, nameof(MemberName), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : MetadataMemberReferenceExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceMemberReferenceExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionMemberReferenceExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceMemberReferenceExpressionSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        protected override string CompleteSymbolProperty_MemberName(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<string>(this, nameof(MemberName), diagnostics, cancellationToken);
        }
        protected override bool CompleteSymbolProperty_IsNullConditional(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
        ...
        public partial class Error : SourceMemberReferenceExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
