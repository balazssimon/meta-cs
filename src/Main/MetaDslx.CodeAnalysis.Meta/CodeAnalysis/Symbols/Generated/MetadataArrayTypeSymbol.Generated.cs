...
namespace MetaDslx.CodeAnalysis.Symbols.Metadata
{
	...
	{
        public MetadataArrayTypeSymbol(Symbol container, object modelObject)
        ...
        {
            return ModelSymbolImplementation.AssignSymbolPropertyValue<int>(this, nameof(LowerBound), diagnostics, cancellationToken);
        }

        protected override int CompleteSymbolProperty_Size(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return ModelSymbolImplementation.AssignSymbolPropertyValue<int>(this, nameof(Size), diagnostics, cancellationToken);
        }
        ...
        {
            return ModelSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol>(this, nameof(ElementType), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : MetadataArrayTypeSymbol
        {
