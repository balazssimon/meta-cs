...
namespace MetaDslx.CodeAnalysis.Symbols.Metadata
{
	public partial class MetadataIsTypeExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionIsTypeExpressionSymbol
	{
        ...
        {
            return ModelSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(ValueOperand), diagnostics, cancellationToken);
        }
        ...
        {
            return ModelSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol>(this, nameof(TypeOperand), diagnostics, cancellationToken);
        }

        protected override bool CompleteSymbolProperty_IsNegated(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return ModelSymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(IsNegated), diagnostics, cancellationToken);
        }
