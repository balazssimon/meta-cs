...
{
	public abstract partial class NameOfExpressionSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_Argument = new CompletionPart(nameof(StartComputingProperty_Argument));
            public static readonly CompletionPart FinishComputingProperty_Argument = new CompletionPart(nameof(FinishComputingProperty_Argument));
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_Argument, FinishComputingProperty_Argument, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
...
{
	public abstract partial class CompletionNameOfExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.NameOfExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        private global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol _argument;

        public CompletionNameOfExpressionSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol Argument
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_Argument, null, default);
                return _argument;
            }
        }
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_Argument || incompletePart == CompletionParts.FinishComputingProperty_Argument)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_Argument))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _argument = CompleteSymbolProperty_Argument(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_Argument);
                    }
                }
        ...
        protected abstract global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_Argument(DiagnosticBag diagnostics, CancellationToken cancellationToken);
...
namespace MetaDslx.CodeAnalysis.Symbols.Metadata
{
	...
	{
        public MetadataNameOfExpressionSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(Argument), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : MetadataNameOfExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceNameOfExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionNameOfExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceNameOfExpressionSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_Argument(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(Argument), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : SourceNameOfExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
