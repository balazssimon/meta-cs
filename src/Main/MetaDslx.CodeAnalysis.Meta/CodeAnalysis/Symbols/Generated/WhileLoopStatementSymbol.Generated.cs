...
namespace MetaDslx.CodeAnalysis.Symbols.Metadata
{
	public partial class MetadataWhileLoopStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionWhileLoopStatementSymbol
	{
        ...
        protected override bool CompleteSymbolProperty_ConditionIsTop(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(ConditionIsTop), diagnostics, cancellationToken);
        }

        protected override bool CompleteSymbolProperty_ConditionIsUntil(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(ConditionIsUntil), diagnostics, cancellationToken);
        }
...
namespace MetaDslx.CodeAnalysis.Symbols.Source
{
	public partial class SourceWhileLoopStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionWhileLoopStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        ...
        protected override bool CompleteSymbolProperty_ConditionIsTop(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(ConditionIsTop), diagnostics, cancellationToken);
        }
        protected override bool CompleteSymbolProperty_ConditionIsUntil(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(ConditionIsUntil), diagnostics, cancellationToken);
        }
