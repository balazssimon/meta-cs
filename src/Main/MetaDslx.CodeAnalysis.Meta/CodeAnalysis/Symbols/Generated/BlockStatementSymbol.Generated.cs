...
{
	public abstract partial class BlockStatementSymbol
	{
...
{
	public abstract partial class CompletionBlockStatementSymbol : MetaDslx.CodeAnalysis.Symbols.BlockStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        public static class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_Statements = new CompletionPart(nameof(StartComputingProperty_Statements));
            public static readonly CompletionPart FinishComputingProperty_Statements = new CompletionPart(nameof(FinishComputingProperty_Statements));
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_Statements, FinishComputingProperty_Statements, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
            public static readonly ImmutableHashSet<CompletionPart> All = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_Statements, FinishComputingProperty_Statements, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties, CompletionGraph.ChildrenCompleted);
        ...
        private global::System.Collections.Immutable.ImmutableArray<global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol> _statements;

        public CompletionBlockStatementSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override global::System.Collections.Immutable.ImmutableArray<global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol> Statements
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_Statements, null, default);
                return _statements;
            }
        }
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_Statements || incompletePart == CompletionParts.FinishComputingProperty_Statements)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_Statements))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _statements = CompleteSymbolProperty_Statements(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_Statements);
                    }
                }
        ...
        protected abstract global::System.Collections.Immutable.ImmutableArray<global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol> CompleteSymbolProperty_Statements(DiagnosticBag diagnostics, CancellationToken cancellationToken);
...
{
	public partial class MetadataBlockStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionBlockStatementSymbol
	{
        public MetadataBlockStatementSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        protected override global::System.Collections.Immutable.ImmutableArray<global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol> CompleteSymbolProperty_Statements(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValues<global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol>(this, nameof(Statements), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : MetadataBlockStatementSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceBlockStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionBlockStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceBlockStatementSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        protected override global::System.Collections.Immutable.ImmutableArray<global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol> CompleteSymbolProperty_Statements(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValues<global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol>(this, nameof(Statements), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : SourceBlockStatementSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
