...
{
	public abstract partial class LockStatementSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_LockedValue = new CompletionPart(nameof(StartComputingProperty_LockedValue));
            public static readonly CompletionPart FinishComputingProperty_LockedValue = new CompletionPart(nameof(FinishComputingProperty_LockedValue));
            ...
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_LockedValue, FinishComputingProperty_LockedValue, StartComputingProperty_Body, FinishComputingProperty_Body, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
            public static readonly ImmutableHashSet<CompletionPart> All = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_LockedValue, FinishComputingProperty_LockedValue, StartComputingProperty_Body, FinishComputingProperty_Body, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties, CompletionGraph.ChildrenCompleted);
...
{
	public abstract partial class CompletionLockStatementSymbol : MetaDslx.CodeAnalysis.Symbols.LockStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        private global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol _lockedValue;
        private global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol _body;

        public CompletionLockStatementSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol LockedValue
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_LockedValue, null, default);
                return _lockedValue;
            }
        }
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_LockedValue || incompletePart == CompletionParts.FinishComputingProperty_LockedValue)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_LockedValue))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _lockedValue = CompleteSymbolProperty_LockedValue(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_LockedValue);
                    }
                }
        ...
        protected abstract global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_LockedValue(DiagnosticBag diagnostics, CancellationToken cancellationToken);
...
namespace MetaDslx.CodeAnalysis.Symbols.Metadata
{
	public partial class MetadataLockStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionLockStatementSymbol
	{
        ...
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(LockedValue), diagnostics, cancellationToken);
        }
...
{
	public partial class SourceLockStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionLockStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceLockStatementSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_LockedValue(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(LockedValue), diagnostics, cancellationToken);
        }
        protected override global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol CompleteSymbolProperty_Body(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
        ...
        public partial class Error : SourceLockStatementSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
