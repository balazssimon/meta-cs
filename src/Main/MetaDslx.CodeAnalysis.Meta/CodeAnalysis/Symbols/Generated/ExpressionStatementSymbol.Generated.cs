...
{
	public abstract partial class ExpressionStatementSymbol
	{
...
{
	public abstract partial class CompletionExpressionStatementSymbol : MetaDslx.CodeAnalysis.Symbols.ExpressionStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        public static class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_Expression = new CompletionPart(nameof(StartComputingProperty_Expression));
            public static readonly CompletionPart FinishComputingProperty_Expression = new CompletionPart(nameof(FinishComputingProperty_Expression));
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_Expression, FinishComputingProperty_Expression, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
        ...
        private global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol _expression;

        public CompletionExpressionStatementSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol Expression
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_Expression, null, default);
                return _expression;
            }
        }
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_Expression || incompletePart == CompletionParts.FinishComputingProperty_Expression)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_Expression))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _expression = CompleteSymbolProperty_Expression(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_Expression);
                    }
                }
        ...
        protected abstract global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_Expression(DiagnosticBag diagnostics, CancellationToken cancellationToken);
...
{
	public partial class MetadataExpressionStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionExpressionStatementSymbol
	{
        public MetadataExpressionStatementSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_Expression(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(Expression), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : MetadataExpressionStatementSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceExpressionStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionExpressionStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceExpressionStatementSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_Expression(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(Expression), diagnostics, cancellationToken);
        }
        ...
        public partial class Error : SourceExpressionStatementSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
