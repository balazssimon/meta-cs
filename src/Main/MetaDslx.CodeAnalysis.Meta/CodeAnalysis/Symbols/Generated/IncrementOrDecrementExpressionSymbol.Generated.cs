...
namespace MetaDslx.CodeAnalysis.Symbols.Completion
{
	public abstract partial class CompletionIncrementOrDecrementExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.IncrementOrDecrementExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        protected abstract bool CompleteSymbolProperty_IsPostfix(DiagnosticBag diagnostics, CancellationToken cancellationToken);
        protected abstract bool CompleteSymbolProperty_IsChecked(DiagnosticBag diagnostics, CancellationToken cancellationToken);
        protected abstract global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_Target(DiagnosticBag diagnostics, CancellationToken cancellationToken);
...
namespace MetaDslx.CodeAnalysis.Symbols.Metadata
{
	public partial class MetadataIncrementOrDecrementExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionIncrementOrDecrementExpressionSymbol
	{
        ...
        protected override bool CompleteSymbolProperty_IsPostfix(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(IsPostfix), diagnostics, cancellationToken);
        }
...
namespace MetaDslx.CodeAnalysis.Symbols.Source
{
	public partial class SourceIncrementOrDecrementExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionIncrementOrDecrementExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        ...
        protected override bool CompleteSymbolProperty_IsPostfix(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(IsPostfix), diagnostics, cancellationToken);
        }
        protected override bool CompleteSymbolProperty_IsChecked(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_Target(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(Target), diagnostics, cancellationToken);
        }
