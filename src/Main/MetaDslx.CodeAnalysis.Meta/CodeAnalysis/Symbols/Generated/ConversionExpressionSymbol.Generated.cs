...
namespace MetaDslx.CodeAnalysis.Symbols.Metadata
{
	public partial class MetadataConversionExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionConversionExpressionSymbol
	{
        ...
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol>(this, nameof(TargetType), diagnostics, cancellationToken);
        }

        protected override bool CompleteSymbolProperty_IsTryCast(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return MetadataSymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(IsTryCast), diagnostics, cancellationToken);
        }
...
namespace MetaDslx.CodeAnalysis.Symbols.Source
{
	public partial class SourceConversionExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionConversionExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        ...
        protected override global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol CompleteSymbolProperty_TargetType(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol>(this, nameof(TargetType), diagnostics, cancellationToken);
        }
        protected override bool CompleteSymbolProperty_IsTryCast(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            return SourceSymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(IsTryCast), diagnostics, cancellationToken);
        }
        protected override bool CompleteSymbolProperty_IsChecked(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
