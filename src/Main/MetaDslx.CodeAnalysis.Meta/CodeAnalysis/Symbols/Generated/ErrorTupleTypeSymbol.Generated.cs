...
{
	public abstract partial class ErrorTupleTypeSymbol : MetaDslx.CodeAnalysis.Symbols.TupleTypeSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        private readonly Symbol _container;
        private readonly object? _modelObject;

        public ErrorTupleTypeSymbol(Symbol container, object? modelObject)
        {
