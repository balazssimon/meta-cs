...
{
	public partial class SourceDiscardExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionDiscardExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceDiscardExpressionSymbol(Symbol containingSymbol, MergedDeclaration declaration, bool isError = false)
        ...
        public partial class Error : SourceDiscardExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            ...
            public Error AsUnreported()
            {
                return this.IsUnreported ? this :
                    Update(this.ContainingSymbol, this.MergedDeclaration, _kind, ErrorInfo, CandidateSymbols, true);
            }

            public Error AsKind(MetaDslx.CodeAnalysis.Symbols.ErrorKind kind)
            {
                return _kind == kind ? this :
                    Update(this.ContainingSymbol, this.MergedDeclaration, kind, ErrorInfo, CandidateSymbols, _unreported);
            }
            ...
            public Error WithErrorInfo(DiagnosticInfo errorInfo)
            {
                return ErrorInfo == errorInfo ? this :
                    Update(this.ContainingSymbol, this.MergedDeclaration, _kind, errorInfo, CandidateSymbols, _unreported);
            }

            protected virtual Error Update(Symbol container, MergedDeclaration declaration, MetaDslx.CodeAnalysis.Symbols.ErrorKind kind, DiagnosticInfo? errorInfo, ImmutableArray<DeclaredSymbol> candidateSymbols, bool unreported)
            {
