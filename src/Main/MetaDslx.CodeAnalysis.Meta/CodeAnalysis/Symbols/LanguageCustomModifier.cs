...
namespace MetaDslx.CodeAnalysis.Symbols
{
    ...
    /// </summary>
    internal abstract partial class LanguageCustomModifier : CustomModifier
    {
        protected readonly NamedTypeSymbol modifier;

        private LanguageCustomModifier(NamedTypeSymbol modifier)
        {
        ...
        private class OptionalCustomModifier : LanguageCustomModifier
        {
        ...
        private class RequiredCustomModifier : LanguageCustomModifier
        {
