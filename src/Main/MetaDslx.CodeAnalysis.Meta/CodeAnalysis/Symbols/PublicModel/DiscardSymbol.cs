...
namespace MetaDslx.CodeAnalysis.Symbols.PublicModel
{
    internal sealed class DiscardSymbol : Symbol, IDiscardSymbol
    {
        ...
        protected override void Accept(Microsoft.CodeAnalysis.SymbolVisitor visitor) => visitor.VisitDiscard(this);
        protected override TResult? Accept<TResult>(Microsoft.CodeAnalysis.SymbolVisitor<TResult> visitor) where TResult : default => visitor.VisitDiscard(this);
    }
}
