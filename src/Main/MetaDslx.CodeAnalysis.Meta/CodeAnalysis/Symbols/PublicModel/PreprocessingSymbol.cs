...
namespace MetaDslx.CodeAnalysis.Symbols.PublicModel
{
    internal sealed class PreprocessingSymbol : IPreprocessingSymbol
    {
        ...
        void ISymbol.Accept(Microsoft.CodeAnalysis.SymbolVisitor visitor) => throw new System.NotSupportedException();

        TResult ISymbol.Accept<TResult>(Microsoft.CodeAnalysis.SymbolVisitor<TResult> visitor) => throw new System.NotSupportedException();
        ...
        Microsoft.CodeAnalysis.SymbolKind ISymbol.Kind => Microsoft.CodeAnalysis.SymbolKind.Preprocessing;
