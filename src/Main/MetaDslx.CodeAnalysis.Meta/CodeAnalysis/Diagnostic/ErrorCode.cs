...
namespace MetaDslx.CodeAnalysis
{
    ...
    public class ErrorCode : IEquatable<ErrorCode>, IObjectWritable
    {
        ...
        public LanguageDiagnosticInfo ToDiagnosticInfo(params object[] args)
        {
            return new LanguageDiagnosticInfo(this, args);
        }

        public LanguageDiagnostic ToDiagnosticWithNoLocation(params object[] args)
        {
