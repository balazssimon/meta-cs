...
namespace MetaDslx.Modeling
{
    public sealed class ModelErrorCode : ErrorCode
    {
        ...
        public static readonly ModelErrorCode ERR_CannotChangeDerivedProperty = new ModelErrorCode(15, "Cannot change derived property", "Cannot change derived property '{1}' of object '{2}'.", DiagnosticSeverity.Error);
        ...
        public static readonly ModelErrorCode ERR_ModelConversionError = new ModelErrorCode(44, "Model conversion error", "Model conversion error: {0}", DiagnosticSeverity.Error);
    }
}
