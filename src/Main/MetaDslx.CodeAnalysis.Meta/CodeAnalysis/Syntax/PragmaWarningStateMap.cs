...
namespace MetaDslx.CodeAnalysis.Syntax
{
    ...
    internal class PragmaWarningStateMap : AbstractWarningStateMap<PragmaWarningState>
    {
        public PragmaWarningStateMap(SyntaxTree syntaxTree) :
            base(syntaxTree)
        {
        }
        ...
        protected override WarningStateMapEntry[] CreateWarningStateMapEntries(SyntaxTree syntaxTree)
        {
            ...
            GetAllPragmaWarningDirectives((LanguageSyntaxTree)syntaxTree, directives);
        ...
        {
            /* TODO:MetaDslx
            foreach (var d in syntaxTree.GetRootNode().GetDirectives())
            {
        ...
        private static WarningStateMapEntry[] CreatePragmaWarningStateEntries(ArrayBuilder<IDirectiveTriviaSyntax> directiveList)
        {
