...
namespace MetaDslx.CodeAnalysis.Syntax.InternalSyntax
{
    ...
    public abstract class InternalSyntaxFactory
    {
        ...
        public abstract ISyntaxLexer CreateLexer(SourceText text, LanguageParseOptions options);
        public abstract ISyntaxParser CreateParser(SourceText text, LanguageParseOptions options, LanguageSyntaxNode oldTree, IEnumerable<TextChangeRange> changes, CancellationToken cancellationToken = default);
    }
}
