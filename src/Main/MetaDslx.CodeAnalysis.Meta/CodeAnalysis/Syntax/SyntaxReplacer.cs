...
namespace MetaDslx.CodeAnalysis.Syntax
{
    internal static class SyntaxReplacer
    {
        ...
        {
            return new NodeListEditor(root.Language(), originalNode, newNodes, ListEditKind.Replace).Visit(root);
        }
        ...
        {
            return new NodeListEditor(root.Language(), nodeInList, nodesToInsert, insertBefore ? ListEditKind.InsertBefore : ListEditKind.InsertAfter).Visit(root);
        }

        public static SyntaxNode ReplaceTokenInList(SyntaxNode root, SyntaxToken tokenInList, IEnumerable<SyntaxToken> newTokens)
        {
            return new TokenListEditor(root.Language(), tokenInList, newTokens, ListEditKind.Replace).Visit(root);
        }
        ...
        {
            return new TokenListEditor(root.Language(), tokenInList, newTokens, insertBefore ? ListEditKind.InsertBefore : ListEditKind.InsertAfter).Visit(root);
        }
        ...
        {
            return new TriviaListEditor(root.Language(), triviaInList, newTrivia, ListEditKind.Replace).Visit(root);
        }
        ...
        {
            return new TriviaListEditor(root.Language(), triviaInList, newTrivia, insertBefore ? ListEditKind.InsertBefore : ListEditKind.InsertAfter).Visit(root);
        }
        ...
        {
            return new TriviaListEditor(root.Language(), triviaInList, newTrivia, ListEditKind.Replace).VisitToken(root);
        }
        ...
        {
            return new TriviaListEditor(root.Language(), triviaInList, newTrivia, insertBefore ? ListEditKind.InsertBefore : ListEditKind.InsertAfter).VisitToken(root);
        }
        ...
        private class NodeListEditor : BaseListEditor
        {
            ...
            public NodeListEditor(
                ...
                ListEditKind editKind)
                : base(language, originalNode.Span, editKind, false, originalNode.IsPartOfStructuredTrivia())
            {
        ...
        private class TokenListEditor : BaseListEditor
        {
            ...
            public TokenListEditor(
                ...
                ListEditKind editKind)
                : base(language, originalToken.Span, editKind, false, originalToken.IsPartOfStructuredTrivia())
            {
        ...
        private class TriviaListEditor : BaseListEditor
        {
            ...
            public TriviaListEditor(
                ...
                ListEditKind editKind)
                : base(language, originalTrivia.Span, editKind, true, originalTrivia.IsPartOfStructuredTrivia())
            {
