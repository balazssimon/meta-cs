...
namespace MetaDslx.CodeAnalysis.Syntax
{
    internal sealed class NullableDirectiveMap
    {
        ...
        internal static NullableDirectiveMap Create(LanguageSyntaxTree tree, bool isGeneratedCode)
        {
        ...
        private static ImmutableArray<(int Position, bool? State)> GetDirectives(LanguageSyntaxTree tree)
        {
