    ...
    public class LookupConstraints
    {
            ...
            HashSet<DiagnosticInfo> useSiteDiagnostics)
        {
            if (!ReferenceEquals(qualifierOpt, this.QualifierOpt) || name != this.Name || metadataName != this.MetadataName ||
                symbolTypes != this.SymbolTypes || !ReferenceEquals(basesBeingResolved, this.BasesBeingResolved) || !ReferenceEquals(originalBinder, this.OriginalBinder) ||
            ...
            {
                return new LookupConstraints(name, metadataName, symbolTypes, qualifierOpt, basesBeingResolved, originalBinder, accessThroughType, options, diagnose, useSiteDiagnostics);
            }
            return this;
        }
        ...
        {
            return Update(name, metadataName ?? name, this.SymbolTypes, this.QualifierOpt, this.BasesBeingResolved, this.OriginalBinder, this.AccessThroughType, this.Options, this.Diagnose, this.UseSiteDiagnostics);
        }

        public LookupConstraints WithQualifier(NamespaceOrTypeSymbol qualifierOpt)
        {
            return Update(this.Name, this.MetadataName, this.SymbolTypes, qualifierOpt, this.BasesBeingResolved, this.OriginalBinder, this.AccessThroughType, this.Options, this.Diagnose, this.UseSiteDiagnostics);
        }

        public LookupConstraints WithOptions(LookupOptions options)
        {
            return Update(this.Name, this.MetadataName, this.SymbolTypes, this.QualifierOpt, this.BasesBeingResolved, this.OriginalBinder, this.AccessThroughType, options, this.Diagnose, this.UseSiteDiagnostics);
        }

        public LookupConstraints WithDiagnose(bool diagnose)
        {
            return Update(this.Name, this.MetadataName, this.SymbolTypes, this.QualifierOpt, this.BasesBeingResolved, this.OriginalBinder, this.AccessThroughType, this.Options, diagnose, this.UseSiteDiagnostics);
        }

        public LookupConstraints WithDiagnoseAndOriginalBinder(bool diagnose, Binder originalBinder)
        {
            return Update(this.Name, this.MetadataName, this.SymbolTypes, this.QualifierOpt, this.BasesBeingResolved, originalBinder, this.AccessThroughType, this.Options, diagnose, this.UseSiteDiagnostics);
        }

        public LookupConstraints WithOriginalBinder(Binder originalBinder)
        {
            return Update(this.Name, this.MetadataName, this.SymbolTypes, this.QualifierOpt, this.BasesBeingResolved, originalBinder, this.AccessThroughType, this.Options, this.Diagnose, this.UseSiteDiagnostics);
        }

        public LookupConstraints WithUseSiteDiagnostics(HashSet<DiagnosticInfo> useSiteDiagnostics)
        {
            return Update(this.Name, this.MetadataName, this.SymbolTypes, this.QualifierOpt, this.BasesBeingResolved, this.OriginalBinder, this.AccessThroughType, this.Options, this.Diagnose, useSiteDiagnostics);
        }

        public LookupConstraints WithAccessThroughType(TypeSymbol accessThroughType)
        {
            return Update(this.Name, this.MetadataName, this.SymbolTypes, this.QualifierOpt, this.BasesBeingResolved, this.OriginalBinder, accessThroughType, this.Options, this.Diagnose, this.UseSiteDiagnostics);
        }
        ...
        {
            return Update(this.Name, this.MetadataName, this.SymbolTypes, qualifierOpt, this.BasesBeingResolved, this.OriginalBinder, accessThroughType, this.Options, this.Diagnose, this.UseSiteDiagnostics);
        }
