...
namespace MetaDslx.CodeAnalysis.Binding
{
    public partial class OverloadResolution
    {
            ...
            bool expanded)
        {
            ...
            ImmutableArray<ParameterSymbol> parameters = symbol.Parameters;
            bool isVararg = symbol.IsVarArg;
            bool hasNamedArguments = arguments.HasNamedArguments;

            // The easy out is that we have no named arguments and are in normal form.
            if (!expanded && !hasNamedArguments)
            {
            ...
            if (hasNamedArguments && arguments.Arguments.Last().Name != null && isVararg)
            {
            ...
            ref bool seenOutOfPositionNamedArgument)
        {
            ...
            isNamedArgument = arguments.Arguments.Count > argumentPosition && arguments.Arguments[argumentPosition].HasName;
            ...
            else
            {
                ...
                var name = arguments.Arguments[argumentPosition].Name;
            ...
            bool isVararg)
        {
            ...
            Debug.Assert(arguments != null);
            Debug.Assert(!arguments.HasNamedArguments);
