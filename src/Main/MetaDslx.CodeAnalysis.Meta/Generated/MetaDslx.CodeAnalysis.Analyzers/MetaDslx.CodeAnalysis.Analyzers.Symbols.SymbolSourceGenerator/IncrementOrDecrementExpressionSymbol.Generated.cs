...
{
	public abstract partial class IncrementOrDecrementExpressionSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_IsPostfix = new CompletionPart(nameof(StartComputingProperty_IsPostfix));
            public static readonly CompletionPart FinishComputingProperty_IsPostfix = new CompletionPart(nameof(FinishComputingProperty_IsPostfix));
            ...
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_IsPostfix, FinishComputingProperty_IsPostfix, StartComputingProperty_IsChecked, FinishComputingProperty_IsChecked, StartComputingProperty_Target, FinishComputingProperty_Target, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
...
{
	public abstract partial class CompletionIncrementOrDecrementExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.IncrementOrDecrementExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        public CompletionIncrementOrDecrementExpressionSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override bool IsPostfix
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_IsPostfix, null, default);
                return _isPostfix;
            }
        }
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation? locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_IsPostfix || incompletePart == CompletionParts.FinishComputingProperty_IsPostfix)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_IsPostfix))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _isPostfix = CompleteSymbolProperty_IsPostfix(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_IsPostfix);
                    }
                }
        ...
        protected virtual bool CompleteSymbolProperty_IsPostfix(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(IsPostfix), diagnostics, cancellationToken, out var result);
            return result;
        }
...
{
	public partial class MetadataIncrementOrDecrementExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionIncrementOrDecrementExpressionSymbol
	{
        public MetadataIncrementOrDecrementExpressionSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        public partial class Error : MetadataIncrementOrDecrementExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceIncrementOrDecrementExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionIncrementOrDecrementExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceIncrementOrDecrementExpressionSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        public partial class Error : SourceIncrementOrDecrementExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
