...
namespace MetaDslx.CodeAnalysis.Symbols
{
	public abstract partial class LabeledStatementSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_Label = new CompletionPart(nameof(StartComputingProperty_Label));
            public static readonly CompletionPart FinishComputingProperty_Label = new CompletionPart(nameof(FinishComputingProperty_Label));
            public static readonly CompletionPart StartComputingProperty_Statement = new CompletionPart(nameof(StartComputingProperty_Statement));
            public static readonly CompletionPart FinishComputingProperty_Statement = new CompletionPart(nameof(FinishComputingProperty_Statement));
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_Label, FinishComputingProperty_Label, StartComputingProperty_Statement, FinishComputingProperty_Statement, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
            public static readonly ImmutableHashSet<CompletionPart> All = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_Label, FinishComputingProperty_Label, StartComputingProperty_Statement, FinishComputingProperty_Statement, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties, CompletionGraph.ChildrenCompleted, CompletionGraph.StartValidatingSymbol, CompletionGraph.FinishValidatingSymbol);
...
{
	public abstract partial class CompletionLabeledStatementSymbol : MetaDslx.CodeAnalysis.Symbols.LabeledStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        private global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol _label;
        private global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol _statement;

        public CompletionLabeledStatementSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol Label
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_Label, null, default);
                return _label;
            }
        }

        public override global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol Statement
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_Statement, null, default);
                return _statement;
            }
        }
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation? locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_Label || incompletePart == CompletionParts.FinishComputingProperty_Label)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_Label))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _label = CompleteSymbolProperty_Label(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_Label);
                    }
                }
                else if (incompletePart == CompletionParts.StartComputingProperty_Statement || incompletePart == CompletionParts.FinishComputingProperty_Statement)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_Statement))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _statement = CompleteSymbolProperty_Statement(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_Statement);
                    }
                }
        ...
        protected virtual global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol CompleteSymbolProperty_Label(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol>(this, nameof(Label), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol CompleteSymbolProperty_Statement(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol>(this, nameof(Statement), diagnostics, cancellationToken, out var result);
            return result;
        }
...
{
	public partial class MetadataLabeledStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionLabeledStatementSymbol
	{
        public MetadataLabeledStatementSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        public partial class Error : MetadataLabeledStatementSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceLabeledStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionLabeledStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceLabeledStatementSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        public partial class Error : SourceLabeledStatementSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
