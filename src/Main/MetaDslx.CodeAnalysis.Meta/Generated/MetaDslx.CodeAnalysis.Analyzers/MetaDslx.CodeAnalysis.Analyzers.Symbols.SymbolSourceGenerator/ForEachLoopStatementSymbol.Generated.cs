...
{
	public abstract partial class ForEachLoopStatementSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_Body = MetaDslx.CodeAnalysis.Symbols.LoopStatementSymbol.CompletionParts.StartComputingProperty_Body;
            public static readonly CompletionPart FinishComputingProperty_Body = MetaDslx.CodeAnalysis.Symbols.LoopStatementSymbol.CompletionParts.FinishComputingProperty_Body;
            public static readonly CompletionPart StartComputingProperty_ContinueLabel = MetaDslx.CodeAnalysis.Symbols.LoopStatementSymbol.CompletionParts.StartComputingProperty_ContinueLabel;
            public static readonly CompletionPart FinishComputingProperty_ContinueLabel = MetaDslx.CodeAnalysis.Symbols.LoopStatementSymbol.CompletionParts.FinishComputingProperty_ContinueLabel;
            public static readonly CompletionPart StartComputingProperty_ExitLabel = MetaDslx.CodeAnalysis.Symbols.LoopStatementSymbol.CompletionParts.StartComputingProperty_ExitLabel;
            public static readonly CompletionPart FinishComputingProperty_ExitLabel = MetaDslx.CodeAnalysis.Symbols.LoopStatementSymbol.CompletionParts.FinishComputingProperty_ExitLabel;
            ...
            public static readonly CompletionPart StartComputingProperty_Collection = new CompletionPart(nameof(StartComputingProperty_Collection));
            public static readonly CompletionPart FinishComputingProperty_Collection = new CompletionPart(nameof(FinishComputingProperty_Collection));
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_Body, FinishComputingProperty_Body, StartComputingProperty_ContinueLabel, FinishComputingProperty_ContinueLabel, StartComputingProperty_ExitLabel, FinishComputingProperty_ExitLabel, StartComputingProperty_LoopControlVariable, FinishComputingProperty_LoopControlVariable, StartComputingProperty_Collection, FinishComputingProperty_Collection, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
            public static readonly ImmutableHashSet<CompletionPart> All = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_Body, FinishComputingProperty_Body, StartComputingProperty_ContinueLabel, FinishComputingProperty_ContinueLabel, StartComputingProperty_ExitLabel, FinishComputingProperty_ExitLabel, StartComputingProperty_LoopControlVariable, FinishComputingProperty_LoopControlVariable, StartComputingProperty_Collection, FinishComputingProperty_Collection, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties, CompletionGraph.ChildrenCompleted, CompletionGraph.StartValidatingSymbol, CompletionGraph.FinishValidatingSymbol);
...
{
	public abstract partial class CompletionForEachLoopStatementSymbol : MetaDslx.CodeAnalysis.Symbols.ForEachLoopStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        private global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol _collection;

        public CompletionForEachLoopStatementSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol Collection
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_Collection, null, default);
                return _collection;
            }
        }
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation? locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_Collection || incompletePart == CompletionParts.FinishComputingProperty_Collection)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_Collection))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _collection = CompleteSymbolProperty_Collection(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_Collection);
                    }
                }
        ...
        protected virtual global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol CompleteSymbolProperty_ContinueLabel(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol>(this, nameof(ContinueLabel), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol CompleteSymbolProperty_ExitLabel(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.LabelSymbol>(this, nameof(ExitLabel), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_LoopControlVariable(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(LoopControlVariable), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_Collection(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(Collection), diagnostics, cancellationToken, out var result);
            return result;
        }
...
{
	public partial class MetadataForEachLoopStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionForEachLoopStatementSymbol
	{
        public MetadataForEachLoopStatementSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        public partial class Error : MetadataForEachLoopStatementSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceForEachLoopStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionForEachLoopStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceForEachLoopStatementSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        public partial class Error : SourceForEachLoopStatementSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
