...
{
	public abstract partial class DictionaryTypeSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_IsUnordered = new CompletionPart(nameof(StartComputingProperty_IsUnordered));
            public static readonly CompletionPart FinishComputingProperty_IsUnordered = new CompletionPart(nameof(FinishComputingProperty_IsUnordered));
            public static readonly CompletionPart StartComputingProperty_KeyType = new CompletionPart(nameof(StartComputingProperty_KeyType));
            public static readonly CompletionPart FinishComputingProperty_KeyType = new CompletionPart(nameof(FinishComputingProperty_KeyType));
            public static readonly CompletionPart StartComputingProperty_ValueType = new CompletionPart(nameof(StartComputingProperty_ValueType));
            public static readonly CompletionPart FinishComputingProperty_ValueType = new CompletionPart(nameof(FinishComputingProperty_ValueType));
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_TypeParameters, FinishComputingProperty_TypeParameters, StartComputingProperty_DeclaredAccessibility, FinishComputingProperty_DeclaredAccessibility, StartComputingProperty_IsExtern, FinishComputingProperty_IsExtern, StartComputingProperty_Members, FinishComputingProperty_Members, StartComputingProperty_BaseTypes, FinishComputingProperty_BaseTypes, StartComputingProperty_IsUnordered, FinishComputingProperty_IsUnordered, StartComputingProperty_KeyType, FinishComputingProperty_KeyType, StartComputingProperty_ValueType, FinishComputingProperty_ValueType, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
            public static readonly ImmutableHashSet<CompletionPart> All = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_TypeParameters, FinishComputingProperty_TypeParameters, StartComputingProperty_DeclaredAccessibility, FinishComputingProperty_DeclaredAccessibility, StartComputingProperty_IsExtern, FinishComputingProperty_IsExtern, StartComputingProperty_Members, FinishComputingProperty_Members, StartComputingProperty_BaseTypes, FinishComputingProperty_BaseTypes, StartComputingProperty_IsUnordered, FinishComputingProperty_IsUnordered, StartComputingProperty_KeyType, FinishComputingProperty_KeyType, StartComputingProperty_ValueType, FinishComputingProperty_ValueType, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties, CompletionGraph.ChildrenCompleted, CompletionGraph.StartValidatingSymbol, CompletionGraph.FinishValidatingSymbol);
...
{
	public abstract partial class CompletionDictionaryTypeSymbol : MetaDslx.CodeAnalysis.Symbols.DictionaryTypeSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        private global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol _keyType;
        private global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol _valueType;

        public CompletionDictionaryTypeSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override bool IsUnordered
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_IsUnordered, null, default);
                return _isUnordered;
            }
        }

        public override global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol KeyType
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_KeyType, null, default);
                return _keyType;
            }
        }

        public override global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol ValueType
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_ValueType, null, default);
                return _valueType;
            }
        }
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation? locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_IsUnordered || incompletePart == CompletionParts.FinishComputingProperty_IsUnordered)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_IsUnordered))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _isUnordered = CompleteSymbolProperty_IsUnordered(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_IsUnordered);
                    }
                }
                else if (incompletePart == CompletionParts.StartComputingProperty_KeyType || incompletePart == CompletionParts.FinishComputingProperty_KeyType)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_KeyType))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _keyType = CompleteSymbolProperty_KeyType(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_KeyType);
                    }
                }
                else if (incompletePart == CompletionParts.StartComputingProperty_ValueType || incompletePart == CompletionParts.FinishComputingProperty_ValueType)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_ValueType))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _valueType = CompleteSymbolProperty_ValueType(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_ValueType);
                    }
                }
        ...
        protected virtual bool CompleteSymbolProperty_IsUnordered(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(IsUnordered), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol CompleteSymbolProperty_KeyType(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol>(this, nameof(KeyType), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol CompleteSymbolProperty_ValueType(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol>(this, nameof(ValueType), diagnostics, cancellationToken, out var result);
            return result;
        }
...
{
	public partial class MetadataDictionaryTypeSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionDictionaryTypeSymbol
	{
        public MetadataDictionaryTypeSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        public partial class Error : MetadataDictionaryTypeSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceDictionaryTypeSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionDictionaryTypeSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceDictionaryTypeSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        public partial class Error : SourceDictionaryTypeSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
