...
{
	public abstract partial class ConstructorSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_Result = MetaDslx.CodeAnalysis.Symbols.MethodLikeSymbol.CompletionParts.StartComputingProperty_Result;
            public static readonly CompletionPart FinishComputingProperty_Result = MetaDslx.CodeAnalysis.Symbols.MethodLikeSymbol.CompletionParts.FinishComputingProperty_Result;
            ...
            public static readonly CompletionPart StartComputingProperty_NextConstructorInvocation = new CompletionPart(nameof(StartComputingProperty_NextConstructorInvocation));
            public static readonly CompletionPart FinishComputingProperty_NextConstructorInvocation = new CompletionPart(nameof(FinishComputingProperty_NextConstructorInvocation));
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_TypeParameters, FinishComputingProperty_TypeParameters, StartComputingProperty_DeclaredAccessibility, FinishComputingProperty_DeclaredAccessibility, StartComputingProperty_IsExtern, FinishComputingProperty_IsExtern, StartComputingProperty_Members, FinishComputingProperty_Members, StartComputingProperty_IsStatic, FinishComputingProperty_IsStatic, StartComputingProperty_IsVirtual, FinishComputingProperty_IsVirtual, StartComputingProperty_IsOverride, FinishComputingProperty_IsOverride, StartComputingProperty_IsAbstract, FinishComputingProperty_IsAbstract, StartComputingProperty_IsSealed, FinishComputingProperty_IsSealed, StartComputingProperty_IsAsync, FinishComputingProperty_IsAsync, StartComputingProperty_Result, FinishComputingProperty_Result, StartComputingProperty_Parameters, FinishComputingProperty_Parameters, StartComputingProperty_Body, FinishComputingProperty_Body, StartComputingProperty_NextConstructorInvocation, FinishComputingProperty_NextConstructorInvocation, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
            public static readonly ImmutableHashSet<CompletionPart> All = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_TypeParameters, FinishComputingProperty_TypeParameters, StartComputingProperty_DeclaredAccessibility, FinishComputingProperty_DeclaredAccessibility, StartComputingProperty_IsExtern, FinishComputingProperty_IsExtern, StartComputingProperty_Members, FinishComputingProperty_Members, StartComputingProperty_IsStatic, FinishComputingProperty_IsStatic, StartComputingProperty_IsVirtual, FinishComputingProperty_IsVirtual, StartComputingProperty_IsOverride, FinishComputingProperty_IsOverride, StartComputingProperty_IsAbstract, FinishComputingProperty_IsAbstract, StartComputingProperty_IsSealed, FinishComputingProperty_IsSealed, StartComputingProperty_IsAsync, FinishComputingProperty_IsAsync, StartComputingProperty_Result, FinishComputingProperty_Result, StartComputingProperty_Parameters, FinishComputingProperty_Parameters, StartComputingProperty_Body, FinishComputingProperty_Body, StartComputingProperty_NextConstructorInvocation, FinishComputingProperty_NextConstructorInvocation, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties, CompletionGraph.ChildrenCompleted, CompletionGraph.StartValidatingSymbol, CompletionGraph.FinishValidatingSymbol);
...
{
	public abstract partial class CompletionConstructorSymbol : MetaDslx.CodeAnalysis.Symbols.ConstructorSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        private global::MetaDslx.CodeAnalysis.Symbols.ParameterSymbol _result;
        private global::System.Collections.Immutable.ImmutableArray<global::MetaDslx.CodeAnalysis.Symbols.ParameterSymbol> _parameters;
        private global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol _body;
        private global::MetaDslx.CodeAnalysis.Symbols.InvocationExpressionSymbol _nextConstructorInvocation;

        public CompletionConstructorSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.ParameterSymbol Result
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_Result, null, default);
                return _result;
            }
        }
        ...
        public override global::System.Collections.Immutable.ImmutableArray<global::MetaDslx.CodeAnalysis.Symbols.ParameterSymbol> Parameters
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_Parameters, null, default);
                return _parameters;
            }
        }
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.InvocationExpressionSymbol NextConstructorInvocation
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_NextConstructorInvocation, null, default);
                return _nextConstructorInvocation;
            }
        }
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation? locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_Result || incompletePart == CompletionParts.FinishComputingProperty_Result)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_Result))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _result = CompleteSymbolProperty_Result(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_Result);
                    }
                }
                else if (incompletePart == CompletionParts.StartComputingProperty_Parameters || incompletePart == CompletionParts.FinishComputingProperty_Parameters)
                {
                    ...
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _parameters = CompleteSymbolProperty_Parameters(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_NextConstructorInvocation || incompletePart == CompletionParts.FinishComputingProperty_NextConstructorInvocation)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_NextConstructorInvocation))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _nextConstructorInvocation = CompleteSymbolProperty_NextConstructorInvocation(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_NextConstructorInvocation);
                    }
                }
        ...
        protected virtual bool CompleteSymbolProperty_IsStatic(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(IsStatic), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual bool CompleteSymbolProperty_IsVirtual(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(IsVirtual), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual bool CompleteSymbolProperty_IsOverride(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(IsOverride), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual bool CompleteSymbolProperty_IsAbstract(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(IsAbstract), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual bool CompleteSymbolProperty_IsSealed(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(IsSealed), diagnostics, cancellationToken, out var result);
            return result;
        }
        ...
        protected virtual global::MetaDslx.CodeAnalysis.Symbols.ParameterSymbol CompleteSymbolProperty_Result(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ParameterSymbol>(this, nameof(Result), diagnostics, cancellationToken, out var result);
            return result;
        }
        ...
        protected virtual global::MetaDslx.CodeAnalysis.Symbols.InvocationExpressionSymbol CompleteSymbolProperty_NextConstructorInvocation(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.InvocationExpressionSymbol>(this, nameof(NextConstructorInvocation), diagnostics, cancellationToken, out var result);
            return result;
        }
...
{
	public partial class MetadataConstructorSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionConstructorSymbol
	{
        public MetadataConstructorSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        public partial class Error : MetadataConstructorSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceConstructorSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionConstructorSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceConstructorSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        public partial class Error : SourceConstructorSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
