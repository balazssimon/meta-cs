...
{
	public abstract partial class GenericTypeReferenceTypeSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_ReferencedType = new CompletionPart(nameof(StartComputingProperty_ReferencedType));
            public static readonly CompletionPart FinishComputingProperty_ReferencedType = new CompletionPart(nameof(FinishComputingProperty_ReferencedType));
            ...
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_TypeParameters, FinishComputingProperty_TypeParameters, StartComputingProperty_DeclaredAccessibility, FinishComputingProperty_DeclaredAccessibility, StartComputingProperty_IsExtern, FinishComputingProperty_IsExtern, StartComputingProperty_Members, FinishComputingProperty_Members, StartComputingProperty_BaseTypes, FinishComputingProperty_BaseTypes, StartComputingProperty_ReferencedType, FinishComputingProperty_ReferencedType, StartComputingProperty_TypeArguments, FinishComputingProperty_TypeArguments, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
            public static readonly ImmutableHashSet<CompletionPart> All = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_TypeParameters, FinishComputingProperty_TypeParameters, StartComputingProperty_DeclaredAccessibility, FinishComputingProperty_DeclaredAccessibility, StartComputingProperty_IsExtern, FinishComputingProperty_IsExtern, StartComputingProperty_Members, FinishComputingProperty_Members, StartComputingProperty_BaseTypes, FinishComputingProperty_BaseTypes, StartComputingProperty_ReferencedType, FinishComputingProperty_ReferencedType, StartComputingProperty_TypeArguments, FinishComputingProperty_TypeArguments, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties, CompletionGraph.ChildrenCompleted, CompletionGraph.StartValidatingSymbol, CompletionGraph.FinishValidatingSymbol);
...
{
	public abstract partial class CompletionGenericTypeReferenceTypeSymbol : MetaDslx.CodeAnalysis.Symbols.GenericTypeReferenceTypeSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        private global::MetaDslx.CodeAnalysis.Symbols.NamedTypeSymbol _referencedType;
        ...
        public CompletionGenericTypeReferenceTypeSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.NamedTypeSymbol ReferencedType
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_ReferencedType, null, default);
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation? locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_ReferencedType || incompletePart == CompletionParts.FinishComputingProperty_ReferencedType)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_ReferencedType))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _referencedType = CompleteSymbolProperty_ReferencedType(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_ReferencedType);
                    }
                }
        ...
        protected virtual global::MetaDslx.CodeAnalysis.Symbols.NamedTypeSymbol CompleteSymbolProperty_ReferencedType(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.NamedTypeSymbol>(this, nameof(ReferencedType), diagnostics, cancellationToken, out var result);
            return result;
        }
...
{
	public partial class MetadataGenericTypeReferenceTypeSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionGenericTypeReferenceTypeSymbol
	{
        public MetadataGenericTypeReferenceTypeSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        public partial class Error : MetadataGenericTypeReferenceTypeSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceGenericTypeReferenceTypeSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionGenericTypeReferenceTypeSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceGenericTypeReferenceTypeSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        public partial class Error : SourceGenericTypeReferenceTypeSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
