...
namespace MetaDslx.CodeAnalysis.Symbols.Completion
{
	public abstract partial class CompletionIfStatementSymbol : MetaDslx.CodeAnalysis.Symbols.IfStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        protected virtual global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol CompleteSymbolProperty_IfTrue(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol>(this, nameof(IfTrue), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol CompleteSymbolProperty_IfFalse(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol>(this, nameof(IfFalse), diagnostics, cancellationToken, out var result);
            return result;
        }
