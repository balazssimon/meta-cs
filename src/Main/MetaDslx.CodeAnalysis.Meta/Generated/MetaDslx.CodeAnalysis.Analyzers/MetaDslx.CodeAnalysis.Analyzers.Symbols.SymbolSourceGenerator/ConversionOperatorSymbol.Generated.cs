...
{
	public abstract partial class ConversionOperatorSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_IsImplicit = new CompletionPart(nameof(StartComputingProperty_IsImplicit));
            public static readonly CompletionPart FinishComputingProperty_IsImplicit = new CompletionPart(nameof(FinishComputingProperty_IsImplicit));
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_TypeParameters, FinishComputingProperty_TypeParameters, StartComputingProperty_DeclaredAccessibility, FinishComputingProperty_DeclaredAccessibility, StartComputingProperty_IsExtern, FinishComputingProperty_IsExtern, StartComputingProperty_Members, FinishComputingProperty_Members, StartComputingProperty_IsStatic, FinishComputingProperty_IsStatic, StartComputingProperty_IsVirtual, FinishComputingProperty_IsVirtual, StartComputingProperty_IsOverride, FinishComputingProperty_IsOverride, StartComputingProperty_IsAbstract, FinishComputingProperty_IsAbstract, StartComputingProperty_IsSealed, FinishComputingProperty_IsSealed, StartComputingProperty_IsAsync, FinishComputingProperty_IsAsync, StartComputingProperty_Result, FinishComputingProperty_Result, StartComputingProperty_Parameters, FinishComputingProperty_Parameters, StartComputingProperty_Body, FinishComputingProperty_Body, StartComputingProperty_IsImplicit, FinishComputingProperty_IsImplicit, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
            public static readonly ImmutableHashSet<CompletionPart> All = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_TypeParameters, FinishComputingProperty_TypeParameters, StartComputingProperty_DeclaredAccessibility, FinishComputingProperty_DeclaredAccessibility, StartComputingProperty_IsExtern, FinishComputingProperty_IsExtern, StartComputingProperty_Members, FinishComputingProperty_Members, StartComputingProperty_IsStatic, FinishComputingProperty_IsStatic, StartComputingProperty_IsVirtual, FinishComputingProperty_IsVirtual, StartComputingProperty_IsOverride, FinishComputingProperty_IsOverride, StartComputingProperty_IsAbstract, FinishComputingProperty_IsAbstract, StartComputingProperty_IsSealed, FinishComputingProperty_IsSealed, StartComputingProperty_IsAsync, FinishComputingProperty_IsAsync, StartComputingProperty_Result, FinishComputingProperty_Result, StartComputingProperty_Parameters, FinishComputingProperty_Parameters, StartComputingProperty_Body, FinishComputingProperty_Body, StartComputingProperty_IsImplicit, FinishComputingProperty_IsImplicit, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties, CompletionGraph.ChildrenCompleted, CompletionGraph.StartValidatingSymbol, CompletionGraph.FinishValidatingSymbol);
...
{
	public abstract partial class CompletionConversionOperatorSymbol : MetaDslx.CodeAnalysis.Symbols.ConversionOperatorSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        public CompletionConversionOperatorSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override bool IsImplicit
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_IsImplicit, null, default);
                return _isImplicit;
            }
        }
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation? locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_IsImplicit || incompletePart == CompletionParts.FinishComputingProperty_IsImplicit)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_IsImplicit))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _isImplicit = CompleteSymbolProperty_IsImplicit(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_IsImplicit);
                    }
                }
        ...
        protected virtual bool CompleteSymbolProperty_IsImplicit(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<bool>(this, nameof(IsImplicit), diagnostics, cancellationToken, out var result);
            return result;
        }
...
namespace MetaDslx.CodeAnalysis.Symbols.Metadata
{
	...
	{
        public MetadataConversionOperatorSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        public partial class Error : MetadataConversionOperatorSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceConversionOperatorSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionConversionOperatorSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        ...
        public partial class Error : SourceConversionOperatorSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
