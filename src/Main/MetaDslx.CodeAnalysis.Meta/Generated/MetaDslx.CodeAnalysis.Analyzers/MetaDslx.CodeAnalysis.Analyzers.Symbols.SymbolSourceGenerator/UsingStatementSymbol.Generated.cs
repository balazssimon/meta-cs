...
{
	public abstract partial class UsingStatementSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_Resources = new CompletionPart(nameof(StartComputingProperty_Resources));
            public static readonly CompletionPart FinishComputingProperty_Resources = new CompletionPart(nameof(FinishComputingProperty_Resources));
            ...
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_Resources, FinishComputingProperty_Resources, StartComputingProperty_Body, FinishComputingProperty_Body, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
            public static readonly ImmutableHashSet<CompletionPart> All = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_Resources, FinishComputingProperty_Resources, StartComputingProperty_Body, FinishComputingProperty_Body, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties, CompletionGraph.ChildrenCompleted, CompletionGraph.StartValidatingSymbol, CompletionGraph.FinishValidatingSymbol);
...
{
	public abstract partial class CompletionUsingStatementSymbol : MetaDslx.CodeAnalysis.Symbols.UsingStatementSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        private global::System.Collections.Immutable.ImmutableArray<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol> _resources;
        private global::MetaDslx.CodeAnalysis.Symbols.StatementSymbol _body;

        public CompletionUsingStatementSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override global::System.Collections.Immutable.ImmutableArray<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol> Resources
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_Resources, null, default);
                return _resources;
            }
        }
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation? locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_Resources || incompletePart == CompletionParts.FinishComputingProperty_Resources)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_Resources))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _resources = CompleteSymbolProperty_Resources(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_Resources);
                    }
                }
        ...
        protected virtual global::System.Collections.Immutable.ImmutableArray<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol> CompleteSymbolProperty_Resources(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValues<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(Resources), diagnostics, cancellationToken, out var result);
            return result;
        }
...
{
	public partial class MetadataUsingStatementSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionUsingStatementSymbol
	{
        public MetadataUsingStatementSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        public partial class Error : MetadataUsingStatementSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
