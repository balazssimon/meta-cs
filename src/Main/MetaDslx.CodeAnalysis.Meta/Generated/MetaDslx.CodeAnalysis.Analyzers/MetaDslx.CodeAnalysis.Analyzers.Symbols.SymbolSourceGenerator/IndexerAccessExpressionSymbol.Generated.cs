...
{
	public abstract partial class IndexerAccessExpressionSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_Receiver = new CompletionPart(nameof(StartComputingProperty_Receiver));
            public static readonly CompletionPart FinishComputingProperty_Receiver = new CompletionPart(nameof(FinishComputingProperty_Receiver));
            ...
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_Receiver, FinishComputingProperty_Receiver, StartComputingProperty_IsNullConditional, FinishComputingProperty_IsNullConditional, StartComputingProperty_Arguments, FinishComputingProperty_Arguments, StartComputingProperty_Target, FinishComputingProperty_Target, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
...
{
	public abstract partial class CompletionIndexerAccessExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.IndexerAccessExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        private global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol _receiver;
        ...
        private global::MetaDslx.CodeAnalysis.Symbols.IndexerSymbol _target;

        public CompletionIndexerAccessExpressionSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol Receiver
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_Receiver, null, default);
                return _receiver;
            }
        }
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.IndexerSymbol Target
        {
            get
            {
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation? locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_Receiver || incompletePart == CompletionParts.FinishComputingProperty_Receiver)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_Receiver))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _receiver = CompleteSymbolProperty_Receiver(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_Receiver);
                    }
                }
        ...
        protected virtual global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol CompleteSymbolProperty_Receiver(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.ExpressionSymbol>(this, nameof(Receiver), diagnostics, cancellationToken, out var result);
            return result;
        }
        ...
        protected virtual global::MetaDslx.CodeAnalysis.Symbols.IndexerSymbol CompleteSymbolProperty_Target(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.IndexerSymbol>(this, nameof(Target), diagnostics, cancellationToken, out var result);
            return result;
        }
...
{
	public partial class MetadataIndexerAccessExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionIndexerAccessExpressionSymbol
	{
        public MetadataIndexerAccessExpressionSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        public partial class Error : MetadataIndexerAccessExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceIndexerAccessExpressionSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionIndexerAccessExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceIndexerAccessExpressionSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        public partial class Error : SourceIndexerAccessExpressionSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
