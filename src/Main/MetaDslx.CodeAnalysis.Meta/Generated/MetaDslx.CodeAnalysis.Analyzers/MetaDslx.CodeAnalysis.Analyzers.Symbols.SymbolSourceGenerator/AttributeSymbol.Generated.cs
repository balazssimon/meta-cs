...
{
	public abstract partial class AttributeSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart StartComputingProperty_AttributeType = new CompletionPart(nameof(StartComputingProperty_AttributeType));
            public static readonly CompletionPart FinishComputingProperty_AttributeType = new CompletionPart(nameof(FinishComputingProperty_AttributeType));
            ...
            public static readonly ImmutableHashSet<CompletionPart> AllWithLocation = CompletionPart.Combine(CompletionGraph.StartInitializing, CompletionGraph.FinishInitializing, CompletionGraph.StartCreatingChildren, CompletionGraph.FinishCreatingChildren, StartComputingProperty_Attributes, FinishComputingProperty_Attributes, StartComputingProperty_AttributeType, FinishComputingProperty_AttributeType, StartComputingProperty_Arguments, FinishComputingProperty_Arguments, StartComputingProperty_Initializers, FinishComputingProperty_Initializers, CompletionGraph.StartComputingNonSymbolProperties, CompletionGraph.FinishComputingNonSymbolProperties);
...
{
	public abstract partial class CompletionAttributeSymbol : MetaDslx.CodeAnalysis.Symbols.AttributeSymbol, MetaDslx.CodeAnalysis.Symbols.Metadata.IModelSymbol
	{
        ...
        private global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol _attributeType;
        ...
        public CompletionAttributeSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol AttributeType
        {
            get
            {
                this.ForceComplete(CompletionParts.FinishComputingProperty_AttributeType, null, default);
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation? locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_AttributeType || incompletePart == CompletionParts.FinishComputingProperty_AttributeType)
                {
                    if (_state.NotePartComplete(CompletionParts.StartComputingProperty_AttributeType))
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _attributeType = CompleteSymbolProperty_AttributeType(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_AttributeType);
                    }
                }
        ...
        protected virtual global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol CompleteSymbolProperty_AttributeType(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::MetaDslx.CodeAnalysis.Symbols.TypeSymbol>(this, nameof(AttributeType), diagnostics, cancellationToken, out var result);
            return result;
        }
...
{
	public partial class MetadataAttributeSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionAttributeSymbol
	{
        public MetadataAttributeSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        public partial class Error : MetadataAttributeSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceAttributeSymbol : MetaDslx.CodeAnalysis.Symbols.Completion.CompletionAttributeSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceAttributeSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        public partial class Error : SourceAttributeSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
