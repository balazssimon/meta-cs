...
using InternalSyntax = MetaDslx.CodeAnalysis.MetaModel.Syntax.InternalSyntax;
...
namespace MetaDslx.CodeAnalysis.MetaModel
{
    ...
    /// </summary>
    public abstract partial class MetaModelSyntaxTree : Microsoft.CodeAnalysis.CSharp.CSharpSyntaxTree
    {
        ...
        /// </summary>
        public static SyntaxTree Create(MetaModelSyntaxNode root, MetaModelParseOptions options = null, string path = "", Encoding encoding = null)
        {
            if (root == null)
            {
        ...
        internal static SyntaxTree CreateForDebugger(MetaModelSyntaxNode root, SourceText text, MetaModelParseOptions options)
        {
        ...
        /// </summary>
        internal static SyntaxTree CreateWithoutClone(MetaModelSyntaxNode root)
        {
            Debug.Assert(root != null);
