...
namespace MetaDslx.Languages.Core.Syntax
{
	public class CoreTokensSyntaxKind : SyntaxKind
	{
		...
		public const string TLessThanOrEqual = nameof(TLessThanOrEqual); // 75
		public const string TGreaterThanOrEqual = nameof(TGreaterThanOrEqual); // 76
		public const string TEqual = nameof(TEqual); // 77
		public const string TNotEqual = nameof(TNotEqual); // 78
		public const string TAsteriskAssign = nameof(TAsteriskAssign); // 79
		public const string TSlashAssign = nameof(TSlashAssign); // 80
		public const string TPercentAssign = nameof(TPercentAssign); // 81
		public const string TPlusAssign = nameof(TPlusAssign); // 82
		public const string TMinusAssign = nameof(TMinusAssign); // 83
		public const string TLeftShiftAssign = nameof(TLeftShiftAssign); // 84
		public const string TRightShiftAssign = nameof(TRightShiftAssign); // 85
		public const string TAmpersandAssign = nameof(TAmpersandAssign); // 86
		public const string THatAssign = nameof(THatAssign); // 87
		public const string TBarAssign = nameof(TBarAssign); // 88
		public const string IdentifierNormal = nameof(IdentifierNormal); // 89
		public const string IdentifierVerbatim = nameof(IdentifierVerbatim); // 90
		public const string LInteger = nameof(LInteger); // 91
		public const string LDecimal = nameof(LDecimal); // 92
		public const string LScientific = nameof(LScientific); // 93
		public const string LDateTimeOffset = nameof(LDateTimeOffset); // 94
		public const string LDateTime = nameof(LDateTime); // 95
		public const string LDate = nameof(LDate); // 96
		public const string LTime = nameof(LTime); // 97
		public const string LRegularString = nameof(LRegularString); // 98
		public const string LGuid = nameof(LGuid); // 99
		public const string LUtf8Bom = nameof(LUtf8Bom); // 100
		public const string LWhiteSpace = nameof(LWhiteSpace); // 101
		public const string LCrLf = nameof(LCrLf); // 102
		public const string LLineEnd = nameof(LLineEnd); // 103
		public const string LSingleLineComment = nameof(LSingleLineComment); // 104
		public const string LComment = nameof(LComment); // 105
		public const string LDoubleQuoteVerbatimString = nameof(LDoubleQuoteVerbatimString); // 106
		public const string LSingleQuoteVerbatimString = nameof(LSingleQuoteVerbatimString); // 107
		public const string DoubleQuoteVerbatimStringLiteralStart = nameof(DoubleQuoteVerbatimStringLiteralStart); // 108
		public const string SingleQuoteVerbatimStringLiteralStart = nameof(SingleQuoteVerbatimStringLiteralStart); // 109
		public const string LCommentStart = nameof(LCommentStart); // 110
