...
namespace MetaDslx.Languages.Core.Syntax
{
	public class CoreTokensSyntaxKind : SyntaxKind
	{
		...
		public const string TQuestionDot = nameof(TQuestionDot); // 48
		public const string TQuestionOpenBracket = nameof(TQuestionOpenBracket); // 49
		public const string TQuestionQuestion = nameof(TQuestionQuestion); // 50
		public const string TAmpersand = nameof(TAmpersand); // 51
		public const string THat = nameof(THat); // 52
		public const string TBar = nameof(TBar); // 53
		public const string TAndAlso = nameof(TAndAlso); // 54
		public const string TOrElse = nameof(TOrElse); // 55
		public const string TPlusPlus = nameof(TPlusPlus); // 56
		public const string TMinusMinus = nameof(TMinusMinus); // 57
		public const string TPlus = nameof(TPlus); // 58
		public const string TMinus = nameof(TMinus); // 59
		public const string TTilde = nameof(TTilde); // 60
		public const string TExclamation = nameof(TExclamation); // 61
		public const string TSlash = nameof(TSlash); // 62
		public const string TAsterisk = nameof(TAsterisk); // 63
		public const string TPercent = nameof(TPercent); // 64
		public const string TArrow = nameof(TArrow); // 65
		public const string TLessThanOrEqual = nameof(TLessThanOrEqual); // 66
		public const string TGreaterThanOrEqual = nameof(TGreaterThanOrEqual); // 67
		public const string TEqual = nameof(TEqual); // 68
		public const string TNotEqual = nameof(TNotEqual); // 69
		public const string TAsteriskAssign = nameof(TAsteriskAssign); // 70
		public const string TSlashAssign = nameof(TSlashAssign); // 71
		public const string TPercentAssign = nameof(TPercentAssign); // 72
		public const string TPlusAssign = nameof(TPlusAssign); // 73
		public const string TMinusAssign = nameof(TMinusAssign); // 74
		public const string TLeftShiftAssign = nameof(TLeftShiftAssign); // 75
		public const string TRightShiftAssign = nameof(TRightShiftAssign); // 76
		public const string TAmpersandAssign = nameof(TAmpersandAssign); // 77
		public const string THatAssign = nameof(THatAssign); // 78
		public const string TBarAssign = nameof(TBarAssign); // 79
		public const string TDotDot = nameof(TDotDot); // 80
		public const string TSemicolon = nameof(TSemicolon); // 81
		public const string TColon = nameof(TColon); // 82
		public const string TDot = nameof(TDot); // 83
		public const string TComma = nameof(TComma); // 84
		public const string TAssign = nameof(TAssign); // 85
		public const string TOpenParen = nameof(TOpenParen); // 86
		public const string TCloseParen = nameof(TCloseParen); // 87
		public const string TOpenBracket = nameof(TOpenBracket); // 88
		public const string TCloseBracket = nameof(TCloseBracket); // 89
		public const string TOpenBrace = nameof(TOpenBrace); // 90
		public const string TCloseBrace = nameof(TCloseBrace); // 91
		public const string TLessThan = nameof(TLessThan); // 92
		public const string TGreaterThan = nameof(TGreaterThan); // 93
		public const string TQuestion = nameof(TQuestion); // 94
