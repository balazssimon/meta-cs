...
namespace MetaDslx.Languages.Core.Syntax
{
	public class CoreSyntaxKind : CoreTokensSyntaxKind
	{
		...
		public const string AliasDeclaration = nameof(AliasDeclaration);
		public const string EnumDeclaration = nameof(EnumDeclaration);
		public const string EnumLiteralList = nameof(EnumLiteralList);
		public const string EnumLiteral = nameof(EnumLiteral);
		public const string StructDeclaration = nameof(StructDeclaration);
		public const string StructField = nameof(StructField);
		public const string FunctionDeclaration = nameof(FunctionDeclaration);
		public const string FunctionParameterList = nameof(FunctionParameterList);
		public const string FunctionParameter = nameof(FunctionParameter);
		public const string FunctionResult = nameof(FunctionResult);
		...
		public const string PostfixIncOrDecExpr = nameof(PostfixIncOrDecExpr);
		public const string PrefixIncOrDecExpr = nameof(PrefixIncOrDecExpr);
		...
		public const string PostfixIncOrDecOperator = nameof(PostfixIncOrDecOperator);
		public const string PrefixIncOrDecOperator = nameof(PrefixIncOrDecOperator);
