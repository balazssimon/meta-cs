...
public interface IMetaParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterAttribute([NotNull] MetaParser.AttributeContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="MetaParser.attribute"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitAttribute([NotNull] MetaParser.AttributeContext context);
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterMetamodelPrefixProperty([NotNull] MetaParser.MetamodelPrefixPropertyContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="MetaParser.metamodelPrefixProperty"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitMetamodelPrefixProperty([NotNull] MetaParser.MetamodelPrefixPropertyContext context);
	...
	/// <summary>
	/// Enter a parse tree produced by <see cref="MetaParser.defaultValue"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterDefaultValue([NotNull] MetaParser.DefaultValueContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="MetaParser.defaultValue"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitDefaultValue([NotNull] MetaParser.DefaultValueContext context);
