...
public interface IMetaParserVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitMajorVersionProperty([NotNull] MetaParser.MajorVersionPropertyContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="MetaParser.minorVersionProperty"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitMinorVersionProperty([NotNull] MetaParser.MinorVersionPropertyContext context);
	/// <summary>
