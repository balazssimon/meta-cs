...
public partial class MetaParser : global::MetaDslx.Languages.Antlr4Roslyn.Syntax.InternalSyntax.Antlr4Parser {
	...
	public const int
		...
		RULE_operationModifierReadonly = 58, RULE_parameterList = 59, RULE_returnParameter = 60, 
		RULE_parameter = 61, RULE_associationDeclaration = 62, RULE_identifier = 63, 
		RULE_literal = 64, RULE_nullLiteral = 65, RULE_booleanLiteral = 66, RULE_integerLiteral = 67, 
		RULE_decimalLiteral = 68, RULE_scientificLiteral = 69, RULE_stringLiteral = 70;
	public static readonly string[] ruleNames = {
		...
		"parameterList", "returnParameter", "parameter", "associationDeclaration", 
	...
	internal MetamodelDeclarationContext _DoParseMetamodelDeclaration() {
		...
		try {
			...
			if (_la==TOpenParen) {
				...
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (((((_la - 96)) & ~0x3f) == 0 && ((1L << (_la - 96)) & ((1L << (IUri - 96)) | (1L << (IPrefix - 96)) | (1L << (IMajorVersion - 96)) | (1L << (IMinorVersion - 96)))) != 0)) {
					{
					State = 229;
	...
	internal EnumBodyContext _DoParseEnumBody() {
		...
		try {
			...
			if (_la==TSemicolon) {
				...
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << KVoid) | (1L << KObject) | (1L << KString) | (1L << KInt) | (1L << KLong) | (1L << KFloat) | (1L << KDouble) | (1L << KByte) | (1L << KBool) | (1L << KList) | (1L << KSet) | (1L << KMultiList) | (1L << KMultiSet) | (1L << KEnumerable) | (1L << KReadonly) | (1L << KBuilder) | (1L << KSymbol) | (1L << TOpenBracket))) != 0) || ((((_la - 96)) & ~0x3f) == 0 && ((1L << (_la - 96)) & ((1L << (IUri - 96)) | (1L << (IPrefix - 96)) | (1L << (IMajorVersion - 96)) | (1L << (IMinorVersion - 96)) | (1L << (IdentifierNormal - 96)) | (1L << (IdentifierVerbatim - 96)))) != 0)) {
					{
					{
					State = 286;
	...
	internal ClassBodyContext _DoParseClassBody() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << KContainment) | (1L << KVoid) | (1L << KObject) | (1L << KString) | (1L << KInt) | (1L << KLong) | (1L << KFloat) | (1L << KDouble) | (1L << KByte) | (1L << KBool) | (1L << KList) | (1L << KSet) | (1L << KMultiList) | (1L << KMultiSet) | (1L << KEnumerable) | (1L << KReadonly) | (1L << KLazy) | (1L << KDerived) | (1L << KUnion) | (1L << KBuilder) | (1L << KSymbol) | (1L << TOpenBracket))) != 0) || ((((_la - 96)) & ~0x3f) == 0 && ((1L << (_la - 96)) & ((1L << (IUri - 96)) | (1L << (IPrefix - 96)) | (1L << (IMajorVersion - 96)) | (1L << (IMinorVersion - 96)) | (1L << (IdentifierNormal - 96)) | (1L << (IdentifierVerbatim - 96)))) != 0)) {
				{
				{
				State = 365;
	...
	internal RedefinitionsContext _DoParseRedefinitions() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (((((_la - 96)) & ~0x3f) == 0 && ((1L << (_la - 96)) & ((1L << (IUri - 96)) | (1L << (IPrefix - 96)) | (1L << (IMajorVersion - 96)) | (1L << (IMinorVersion - 96)) | (1L << (IdentifierNormal - 96)) | (1L << (IdentifierVerbatim - 96)))) != 0)) {
				{
				State = 433;
				nameUseList();
				}
	...
	public partial class CollectionKindContext : ParserRuleContext {
		...
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode KEnumerable() { return GetToken(MetaParser.KEnumerable, 0); }
	...
	internal CollectionKindContext _DoParseCollectionKind() {
		...
		try {
			...
			State = 485;
			_la = TokenStream.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << KList) | (1L << KSet) | (1L << KMultiList) | (1L << KMultiSet) | (1L << KEnumerable))) != 0)) ) {
			ErrorHandler.RecoverInline(this);
			}
			else {
				ErrorHandler.ReportMatch(this);
	...
	public partial class OperationDeclarationContext : ParserRuleContext {
		[System.Diagnostics.DebuggerNonUserCode] public ReturnParameterContext returnParameter() {
			return GetRuleContext<ReturnParameterContext>(0);
		}
		[System.Diagnostics.DebuggerNonUserCode] public NameContext name() {
			return GetRuleContext<NameContext>(0);
		}
	...
	internal OperationDeclarationContext _DoParseOperationDeclaration() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << KObject) | (1L << KString) | (1L << KInt) | (1L << KLong) | (1L << KFloat) | (1L << KDouble) | (1L << KByte) | (1L << KBool) | (1L << KList) | (1L << KSet) | (1L << KMultiList) | (1L << KMultiSet) | (1L << KEnumerable) | (1L << KSymbol) | (1L << TOpenBracket))) != 0) || ((((_la - 96)) & ~0x3f) == 0 && ((1L << (_la - 96)) & ((1L << (IUri - 96)) | (1L << (IPrefix - 96)) | (1L << (IMajorVersion - 96)) | (1L << (IMinorVersion - 96)) | (1L << (IdentifierNormal - 96)) | (1L << (IdentifierVerbatim - 96)))) != 0)) {
				{
				State = 502;
				parameterList();
				}
	...
	public partial class ReturnParameterContext : ParserRuleContext {
		...
		public override int RuleIndex { get { return RULE_returnParameter; } }
		[System.Diagnostics.DebuggerNonUserCode]
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			IMetaParserVisitor<TResult> typedVisitor = visitor as IMetaParserVisitor<TResult>;
			if (typedVisitor != null) return typedVisitor.VisitReturnParameter(this);
			else return visitor.VisitChildren(this);
		}
	}
	...
	public ReturnParameterContext returnParameter() {
		return this.SyntaxParser != null && this.SyntaxParser.IsIncremental ? this.SyntaxParser._Antlr4ParseReturnParameter() : _DoParseReturnParameter();
	}

	internal ReturnParameterContext _DoParseReturnParameter() {
		ReturnParameterContext _localctx = new ReturnParameterContext(Context, State);
		EnterRule(_localctx, 120, RULE_returnParameter);
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 524;
	...
	private static char[] _serializedATN = {
		...
		'\x39', '\a', '\x39', '\x1EB', '\n', '\x39', '\f', '\x39', '\xE', '\x39', 
		'\x1EE', '\v', '\x39', '\x3', '\x39', '\a', '\x39', '\x1F1', '\n', '\x39', 
		'\f', '\x39', '\xE', '\x39', '\x1F4', '\v', '\x39', '\x3', '\x39', '\x3', 
		'\x39', '\x3', '\x39', '\x3', '\x39', '\x5', '\x39', '\x1FA', '\n', '\x39', 
		...
		',', '/', '\x4', '\x2', '\x14', '\x15', '\x31', '\x31', '\x3', '\x2', 
		'\x16', '\x1B', '\x4', '\x2', '\x1C', '\x1C', ' ', '#', '\x3', '\x2', 
		'\x62', 'g', '\x3', '\x2', '\x11', '\x12', '\x2', '\x231', '\x2', '\x93', 
		...
		'\x2', '\x2', 'Z', '\x1C9', '\x3', '\x2', '\x2', '\x2', '\\', '\x1CB', 
		'\x3', '\x2', '\x2', '\x2', '^', '\x1CF', '\x3', '\x2', '\x2', '\x2', 
		'`', '\x1D5', '\x3', '\x2', '\x2', '\x2', '\x62', '\x1D7', '\x3', '\x2', 
		'\x2', '\x2', '\x64', '\x1D9', '\x3', '\x2', '\x2', '\x2', '\x66', '\x1DB', 
		'\x3', '\x2', '\x2', '\x2', 'h', '\x1DD', '\x3', '\x2', '\x2', '\x2', 
		'j', '\x1DF', '\x3', '\x2', '\x2', '\x2', 'l', '\x1E2', '\x3', '\x2', 
		'\x2', '\x2', 'n', '\x1E7', '\x3', '\x2', '\x2', '\x2', 'p', '\x1EC', 
		'\x3', '\x2', '\x2', '\x2', 'r', '\x200', '\x3', '\x2', '\x2', '\x2', 
		't', '\x202', '\x3', '\x2', '\x2', '\x2', 'v', '\x204', '\x3', '\x2', 
		'\x2', '\x2', 'x', '\x206', '\x3', '\x2', '\x2', '\x2', 'z', '\x20E', 
		'\x3', '\x2', '\x2', '\x2', '|', '\x213', '\x3', '\x2', '\x2', '\x2', 
		'~', '\x21C', '\x3', '\x2', '\x2', '\x2', '\x80', '\x225', '\x3', '\x2', 
		'\x2', '\x2', '\x82', '\x22D', '\x3', '\x2', '\x2', '\x2', '\x84', '\x22F', 
		'\x3', '\x2', '\x2', '\x2', '\x86', '\x231', '\x3', '\x2', '\x2', '\x2', 
		'\x88', '\x233', '\x3', '\x2', '\x2', '\x2', '\x8A', '\x235', '\x3', '\x2', 
		'\x2', '\x2', '\x8C', '\x237', '\x3', '\x2', '\x2', '\x2', '\x8E', '\x239', 
		...
		'\x5', '\x80', '\x41', '\x2', '\x9E', '\x9F', '\a', '\x39', '\x2', '\x2', 
		...
		'\b', '\x5', '\x2', '\xB4', '\xB5', '\a', '\x37', '\x2', '\x2', '\xB5', 
		...
		'\xBF', '\a', '\x37', '\x2', '\x2', '\xBF', '\x11', '\x3', '\x2', '\x2', 
		...
		'\x2', '\x2', '\xDC', '\xDD', '\a', '\x41', '\x2', '\x2', '\xDD', '\x17', 
		...
		'\x2', '\xED', '\xEE', '\a', '\x37', '\x2', '\x2', '\xEE', '\x19', '\x3', 
		'\x2', '\x2', '\x2', '\xEF', '\xF4', '\x5', '\x1C', '\xF', '\x2', '\xF0', 
		'\xF1', '\a', ':', '\x2', '\x2', '\xF1', '\xF3', '\x5', '\x1C', '\xF', 
		...
		'\x2', '\xFD', '\xFE', '\a', '\x62', '\x2', '\x2', '\xFE', '\xFF', '\a', 
		';', '\x2', '\x2', '\xFF', '\x100', '\x5', '\x8E', 'H', '\x2', '\x100', 
		'\x1F', '\x3', '\x2', '\x2', '\x2', '\x101', '\x102', '\a', '\x63', '\x2', 
		'\x2', '\x102', '\x103', '\a', ';', '\x2', '\x2', '\x103', '\x104', '\x5', 
		'\x8E', 'H', '\x2', '\x104', '!', '\x3', '\x2', '\x2', '\x2', '\x105', 
		'\x106', '\a', '\x64', '\x2', '\x2', '\x106', '\x107', '\a', ';', '\x2', 
		...
		'\x2', '\x11F', '\x123', '\a', '\x37', '\x2', '\x2', '\x120', '\x122', 
		...
		'\x128', '\x129', '\a', '\x41', '\x2', '\x2', '\x129', '+', '\x3', '\x2', 
		'\x2', '\x2', '\x12A', '\x12F', '\x5', '.', '\x18', '\x2', '\x12B', '\x12C', 
		'\a', ':', '\x2', '\x2', '\x12C', '\x12E', '\x5', '.', '\x18', '\x2', 
		...
		'\x2', '\x2', '\x2', '\x13A', '\x13B', '\x5', 'p', '\x39', '\x2', '\x13B', 
		...
		'\x2', '\x14A', '\x14B', '\a', '\x38', '\x2', '\x2', '\x14B', '\x14D', 
		...
		'\x31', '\x2', '\x2', '\x158', '\x159', '\a', '\x38', '\x2', '\x2', '\x159', 
		'\x15A', '\x5', '\b', '\x5', '\x2', '\x15A', '\x15B', '\a', '?', '\x2', 
		'\x2', '\x15B', '\x37', '\x3', '\x2', '\x2', '\x2', '\x15C', '\x15D', 
		'\a', '>', '\x2', '\x2', '\x15D', '\x15E', '\a', '\x32', '\x2', '\x2', 
		'\x15E', '\x15F', '\a', '\x38', '\x2', '\x2', '\x15F', '\x160', '\x5', 
		'\b', '\x5', '\x2', '\x160', '\x161', '\a', '?', '\x2', '\x2', '\x161', 
		'\x39', '\x3', '\x2', '\x2', '\x2', '\x162', '\x163', '\a', '>', '\x2', 
		'\x2', '\x163', '\x164', '\a', '\x33', '\x2', '\x2', '\x164', '\x165', 
		'\a', '\x38', '\x2', '\x2', '\x165', '\x166', '\x5', '\b', '\x5', '\x2', 
		'\x166', '\x167', '\a', '?', '\x2', '\x2', '\x167', ';', '\x3', '\x2', 
		'\x2', '\x2', '\x168', '\x169', '\a', '>', '\x2', '\x2', '\x169', '\x16A', 
		'\a', '\x34', '\x2', '\x2', '\x16A', '\x16B', '\a', '\x38', '\x2', '\x2', 
		...
		'\a', '\x41', '\x2', '\x2', '\x176', '?', '\x3', '\x2', '\x2', '\x2', 
		'\x177', '\x17C', '\x5', '\x42', '\"', '\x2', '\x178', '\x179', '\a', 
		':', '\x2', '\x2', '\x179', '\x17B', '\x5', '\x42', '\"', '\x2', '\x17A', 
		'\x178', '\x3', '\x2', '\x2', '\x2', '\x17B', '\x17E', '\x3', '\x2', '\x2', 
		'\x2', '\x17C', '\x17A', '\x3', '\x2', '\x2', '\x2', '\x17C', '\x17D', 
		'\x3', '\x2', '\x2', '\x2', '\x17D', '\x41', '\x3', '\x2', '\x2', '\x2', 
		'\x17E', '\x17C', '\x3', '\x2', '\x2', '\x2', '\x17F', '\x180', '\x5', 
		'\b', '\x5', '\x2', '\x180', '\x43', '\x3', '\x2', '\x2', '\x2', '\x181', 
		'\x184', '\x5', '\x46', '$', '\x2', '\x182', '\x184', '\x5', 'p', '\x39', 
		'\x2', '\x183', '\x181', '\x3', '\x2', '\x2', '\x2', '\x183', '\x182', 
		'\x3', '\x2', '\x2', '\x2', '\x184', '\x45', '\x3', '\x2', '\x2', '\x2', 
		'\x185', '\x187', '\x5', '\n', '\x6', '\x2', '\x186', '\x185', '\x3', 
		'\x2', '\x2', '\x2', '\x187', '\x18A', '\x3', '\x2', '\x2', '\x2', '\x188', 
		'\x186', '\x3', '\x2', '\x2', '\x2', '\x188', '\x189', '\x3', '\x2', '\x2', 
		'\x2', '\x189', '\x18C', '\x3', '\x2', '\x2', '\x2', '\x18A', '\x188', 
		'\x3', '\x2', '\x2', '\x2', '\x18B', '\x18D', '\x5', 'H', '%', '\x2', 
		'\x18C', '\x18B', '\x3', '\x2', '\x2', '\x2', '\x18C', '\x18D', '\x3', 
		'\x2', '\x2', '\x2', '\x18D', '\x18F', '\x3', '\x2', '\x2', '\x2', '\x18E', 
		'\x190', '\x5', 'J', '&', '\x2', '\x18F', '\x18E', '\x3', '\x2', '\x2', 
		'\x2', '\x18F', '\x190', '\x3', '\x2', '\x2', '\x2', '\x190', '\x192', 
		'\x3', '\x2', '\x2', '\x2', '\x191', '\x193', '\x5', 'L', '\'', '\x2', 
		'\x192', '\x191', '\x3', '\x2', '\x2', '\x2', '\x192', '\x193', '\x3', 
		'\x2', '\x2', '\x2', '\x193', '\x194', '\x3', '\x2', '\x2', '\x2', '\x194', 
		'\x195', '\x5', '^', '\x30', '\x2', '\x195', '\x197', '\x5', '\x4', '\x3', 
		'\x2', '\x196', '\x198', '\x5', 'N', '(', '\x2', '\x197', '\x196', '\x3', 
		'\x2', '\x2', '\x2', '\x197', '\x198', '\x3', '\x2', '\x2', '\x2', '\x198', 
		'\x19C', '\x3', '\x2', '\x2', '\x2', '\x199', '\x19B', '\x5', 'P', ')', 
		...
		'\x1A0', '\a', '\x37', '\x2', '\x2', '\x1A0', 'G', '\x3', '\x2', '\x2', 
		'\x2', '\x1A1', '\x1A2', '\a', '>', '\x2', '\x2', '\x1A2', '\x1A3', '\a', 
		'\x35', '\x2', '\x2', '\x1A3', '\x1A4', '\a', '\x38', '\x2', '\x2', '\x1A4', 
		'\x1A5', '\x5', '\x80', '\x41', '\x2', '\x1A5', '\x1A6', '\a', '?', '\x2', 
		'\x2', '\x1A6', 'I', '\x3', '\x2', '\x2', '\x2', '\x1A7', '\x1A8', '\a', 
		'\r', '\x2', '\x2', '\x1A8', 'K', '\x3', '\x2', '\x2', '\x2', '\x1A9', 
		'\x1AA', '\t', '\x2', '\x2', '\x2', '\x1AA', 'M', '\x3', '\x2', '\x2', 
		'\x2', '\x1AB', '\x1AC', '\a', ';', '\x2', '\x2', '\x1AC', '\x1AD', '\x5', 
		'\x8E', 'H', '\x2', '\x1AD', 'O', '\x3', '\x2', '\x2', '\x2', '\x1AE', 
		'\x1B1', '\x5', 'R', '*', '\x2', '\x1AF', '\x1B1', '\x5', 'T', '+', '\x2', 
		'\x1B0', '\x1AE', '\x3', '\x2', '\x2', '\x2', '\x1B0', '\x1AF', '\x3', 
		'\x2', '\x2', '\x2', '\x1B1', 'Q', '\x3', '\x2', '\x2', '\x2', '\x1B2', 
		'\x1B4', '\a', '*', '\x2', '\x2', '\x1B3', '\x1B5', '\x5', 'V', ',', '\x2', 
		'\x1B4', '\x1B3', '\x3', '\x2', '\x2', '\x2', '\x1B4', '\x1B5', '\x3', 
		'\x2', '\x2', '\x2', '\x1B5', 'S', '\x3', '\x2', '\x2', '\x2', '\x1B6', 
		'\x1B8', '\a', '+', '\x2', '\x2', '\x1B7', '\x1B9', '\x5', 'V', ',', '\x2', 
		'\x1B8', '\x1B7', '\x3', '\x2', '\x2', '\x2', '\x1B8', '\x1B9', '\x3', 
		'\x2', '\x2', '\x2', '\x1B9', 'U', '\x3', '\x2', '\x2', '\x2', '\x1BA', 
		'\x1BF', '\x5', '\b', '\x5', '\x2', '\x1BB', '\x1BC', '\a', ':', '\x2', 
		'\x2', '\x1BC', '\x1BE', '\x5', '\b', '\x5', '\x2', '\x1BD', '\x1BB', 
		'\x3', '\x2', '\x2', '\x2', '\x1BE', '\x1C1', '\x3', '\x2', '\x2', '\x2', 
		'\x1BF', '\x1BD', '\x3', '\x2', '\x2', '\x2', '\x1BF', '\x1C0', '\x3', 
		'\x2', '\x2', '\x2', '\x1C0', 'W', '\x3', '\x2', '\x2', '\x2', '\x1C1', 
		'\x1BF', '\x3', '\x2', '\x2', '\x2', '\x1C2', '\x1C3', '\a', ')', '\x2', 
		'\x2', '\x1C3', '\x1C4', '\x5', '^', '\x30', '\x2', '\x1C4', '\x1C5', 
		'\x5', '\x4', '\x3', '\x2', '\x1C5', '\x1C6', '\a', '\x37', '\x2', '\x2', 
		'\x1C6', 'Y', '\x3', '\x2', '\x2', '\x2', '\x1C7', '\x1CA', '\x5', '^', 
		'\x30', '\x2', '\x1C8', '\x1CA', '\x5', 'h', '\x35', '\x2', '\x1C9', '\x1C7', 
		'\x3', '\x2', '\x2', '\x2', '\x1C9', '\x1C8', '\x3', '\x2', '\x2', '\x2', 
		'\x1CA', '[', '\x3', '\x2', '\x2', '\x2', '\x1CB', '\x1CC', '\x5', '^', 
		'\x30', '\x2', '\x1CC', ']', '\x3', '\x2', '\x2', '\x2', '\x1CD', '\x1D0', 
		'\x5', 'l', '\x37', '\x2', '\x1CE', '\x1D0', '\x5', '`', '\x31', '\x2', 
		'\x1CF', '\x1CD', '\x3', '\x2', '\x2', '\x2', '\x1CF', '\x1CE', '\x3', 
		'\x2', '\x2', '\x2', '\x1D0', '_', '\x3', '\x2', '\x2', '\x2', '\x1D1', 
		'\x1D6', '\x5', '\x66', '\x34', '\x2', '\x1D2', '\x1D6', '\x5', '\x64', 
		'\x33', '\x2', '\x1D3', '\x1D6', '\x5', 'j', '\x36', '\x2', '\x1D4', '\x1D6', 
		'\x5', '\x62', '\x32', '\x2', '\x1D5', '\x1D1', '\x3', '\x2', '\x2', '\x2', 
		'\x1D5', '\x1D2', '\x3', '\x2', '\x2', '\x2', '\x1D5', '\x1D3', '\x3', 
		'\x2', '\x2', '\x2', '\x1D5', '\x1D4', '\x3', '\x2', '\x2', '\x2', '\x1D6', 
		'\x61', '\x3', '\x2', '\x2', '\x2', '\x1D7', '\x1D8', '\x5', '\b', '\x5', 
		'\x2', '\x1D8', '\x63', '\x3', '\x2', '\x2', '\x2', '\x1D9', '\x1DA', 
		'\t', '\x3', '\x2', '\x2', '\x1DA', '\x65', '\x3', '\x2', '\x2', '\x2', 
		'\x1DB', '\x1DC', '\t', '\x4', '\x2', '\x2', '\x1DC', 'g', '\x3', '\x2', 
		'\x2', '\x2', '\x1DD', '\x1DE', '\a', '\x13', '\x2', '\x2', '\x1DE', 'i', 
		'\x3', '\x2', '\x2', '\x2', '\x1DF', '\x1E0', '\x5', '\x66', '\x34', '\x2', 
		'\x1E0', '\x1E1', '\a', '\x44', '\x2', '\x2', '\x1E1', 'k', '\x3', '\x2', 
		'\x2', '\x2', '\x1E2', '\x1E3', '\x5', 'n', '\x38', '\x2', '\x1E3', '\x1E4', 
		'\a', '\x42', '\x2', '\x2', '\x1E4', '\x1E5', '\x5', '`', '\x31', '\x2', 
		'\x1E5', '\x1E6', '\a', '\x43', '\x2', '\x2', '\x1E6', 'm', '\x3', '\x2', 
		'\x2', '\x2', '\x1E7', '\x1E8', '\t', '\x5', '\x2', '\x2', '\x1E8', 'o', 
		'\x3', '\x2', '\x2', '\x2', '\x1E9', '\x1EB', '\x5', '\n', '\x6', '\x2', 
		'\x1EA', '\x1E9', '\x3', '\x2', '\x2', '\x2', '\x1EB', '\x1EE', '\x3', 
		'\x2', '\x2', '\x2', '\x1EC', '\x1EA', '\x3', '\x2', '\x2', '\x2', '\x1EC', 
		'\x1ED', '\x3', '\x2', '\x2', '\x2', '\x1ED', '\x1F2', '\x3', '\x2', '\x2', 
		'\x2', '\x1EE', '\x1EC', '\x3', '\x2', '\x2', '\x2', '\x1EF', '\x1F1', 
		'\x5', 'r', ':', '\x2', '\x1F0', '\x1EF', '\x3', '\x2', '\x2', '\x2', 
		'\x1F1', '\x1F4', '\x3', '\x2', '\x2', '\x2', '\x1F2', '\x1F0', '\x3', 
		'\x2', '\x2', '\x2', '\x1F2', '\x1F3', '\x3', '\x2', '\x2', '\x2', '\x1F3', 
		'\x1F5', '\x3', '\x2', '\x2', '\x2', '\x1F4', '\x1F2', '\x3', '\x2', '\x2', 
		'\x2', '\x1F5', '\x1F6', '\x5', 'z', '>', '\x2', '\x1F6', '\x1F7', '\x5', 
		'\x4', '\x3', '\x2', '\x1F7', '\x1F9', '\a', '<', '\x2', '\x2', '\x1F8', 
		'\x1FA', '\x5', 'x', '=', '\x2', '\x1F9', '\x1F8', '\x3', '\x2', '\x2', 
		'\x2', '\x1F9', '\x1FA', '\x3', '\x2', '\x2', '\x2', '\x1FA', '\x1FB', 
		'\x3', '\x2', '\x2', '\x2', '\x1FB', '\x1FC', '\a', '=', '\x2', '\x2', 
		'\x1FC', '\x1FD', '\a', '\x37', '\x2', '\x2', '\x1FD', 'q', '\x3', '\x2', 
		'\x2', '\x2', '\x1FE', '\x201', '\x5', 't', ';', '\x2', '\x1FF', '\x201', 
		'\x5', 'v', '<', '\x2', '\x200', '\x1FE', '\x3', '\x2', '\x2', '\x2', 
		'\x200', '\x1FF', '\x3', '\x2', '\x2', '\x2', '\x201', 's', '\x3', '\x2', 
		'\x2', '\x2', '\x202', '\x203', '\a', '\x30', '\x2', '\x2', '\x203', 'u', 
		'\x3', '\x2', '\x2', '\x2', '\x204', '\x205', '\a', ',', '\x2', '\x2', 
		'\x205', 'w', '\x3', '\x2', '\x2', '\x2', '\x206', '\x20B', '\x5', '|', 
		'?', '\x2', '\x207', '\x208', '\a', ':', '\x2', '\x2', '\x208', '\x20A', 
		'\x5', '|', '?', '\x2', '\x209', '\x207', '\x3', '\x2', '\x2', '\x2', 
		'\x20A', '\x20D', '\x3', '\x2', '\x2', '\x2', '\x20B', '\x209', '\x3', 
		'\x2', '\x2', '\x2', '\x20B', '\x20C', '\x3', '\x2', '\x2', '\x2', '\x20C', 
		'y', '\x3', '\x2', '\x2', '\x2', '\x20D', '\x20B', '\x3', '\x2', '\x2', 
		'\x2', '\x20E', '\x20F', '\x5', 'Z', '.', '\x2', '\x20F', '{', '\x3', 
		'\x2', '\x2', '\x2', '\x210', '\x212', '\x5', '\n', '\x6', '\x2', '\x211', 
		...
		'^', '\x30', '\x2', '\x217', '\x218', '\x5', '\x4', '\x3', '\x2', '\x218', 
		'}', '\x3', '\x2', '\x2', '\x2', '\x219', '\x21B', '\x5', '\n', '\x6', 
		...
		'\x220', '\a', '\f', '\x2', '\x2', '\x220', '\x221', '\x5', '\b', '\x5', 
		'\x2', '\x221', '\x222', '\a', '\xE', '\x2', '\x2', '\x222', '\x223', 
		'\x5', '\b', '\x5', '\x2', '\x223', '\x224', '\a', '\x37', '\x2', '\x2', 
		'\x224', '\x7F', '\x3', '\x2', '\x2', '\x2', '\x225', '\x226', '\t', '\x6', 
		'\x2', '\x2', '\x226', '\x81', '\x3', '\x2', '\x2', '\x2', '\x227', '\x22E', 
		'\x5', '\x84', '\x43', '\x2', '\x228', '\x22E', '\x5', '\x86', '\x44', 
		'\x2', '\x229', '\x22E', '\x5', '\x88', '\x45', '\x2', '\x22A', '\x22E', 
		'\x5', '\x8A', '\x46', '\x2', '\x22B', '\x22E', '\x5', '\x8C', 'G', '\x2', 
		'\x22C', '\x22E', '\x5', '\x8E', 'H', '\x2', '\x22D', '\x227', '\x3', 
		'\x2', '\x2', '\x2', '\x22D', '\x228', '\x3', '\x2', '\x2', '\x2', '\x22D', 
		'\x229', '\x3', '\x2', '\x2', '\x2', '\x22D', '\x22A', '\x3', '\x2', '\x2', 
		'\x2', '\x22D', '\x22B', '\x3', '\x2', '\x2', '\x2', '\x22D', '\x22C', 
		'\x3', '\x2', '\x2', '\x2', '\x22E', '\x83', '\x3', '\x2', '\x2', '\x2', 
		'\x22F', '\x230', '\a', '\x10', '\x2', '\x2', '\x230', '\x85', '\x3', 
		'\x2', '\x2', '\x2', '\x231', '\x232', '\t', '\a', '\x2', '\x2', '\x232', 
		'\x87', '\x3', '\x2', '\x2', '\x2', '\x233', '\x234', '\a', 'h', '\x2', 
		'\x2', '\x234', '\x89', '\x3', '\x2', '\x2', '\x2', '\x235', '\x236', 
		'\a', 'i', '\x2', '\x2', '\x236', '\x8B', '\x3', '\x2', '\x2', '\x2', 
		'\x237', '\x238', '\a', 'j', '\x2', '\x2', '\x238', '\x8D', '\x3', '\x2', 
		'\x2', '\x2', '\x239', '\x23A', '\a', 'o', '\x2', '\x2', '\x23A', '\x8F', 
		'\x3', '\x2', '\x2', '\x2', '\x33', '\x93', '\xA2', '\xAB', '\xB1', '\xBB', 
		...
		'\x1C9', '\x1CF', '\x1D5', '\x1EC', '\x1F2', '\x1F9', '\x200', '\x20B', 
		'\x213', '\x21C', '\x22D',
	};
