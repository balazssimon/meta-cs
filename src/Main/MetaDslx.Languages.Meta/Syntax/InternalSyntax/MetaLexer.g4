...
KUnion : 'union';
KBuilder : 'builder';
KSymbol : 'symbol' { Type= _brackets > 0 ? KSymbol : IdentifierNormal; };
KExpression : 'expression' { Type= _brackets > 0 ? KExpression : IdentifierNormal; };
KStatement : 'statement' { Type= _brackets > 0 ? KStatement : IdentifierNormal; };
KType : 'type' { Type= _brackets > 0 ? KType : IdentifierNormal; };
KProperty : 'property' { Type= _brackets > 0 ? KProperty : IdentifierNormal; };
KStatic : 'static';
