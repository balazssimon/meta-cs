...
namespace MetaDslx.Languages.Meta.Syntax.InternalSyntax
{
    ...
    internal sealed partial class GreenSkippedTokensTriviaSyntax : GreenStructuredTriviaSyntax
    {
        ...
        public override TResult Accept<TResult>(MetaSyntaxVisitor<TResult> visitor) => visitor.VisitSkippedTokensTrivia(this);
	...
	internal class MainGreen : GreenSyntaxNode
	{
	    ...
	    private GreenNode usingNamespaceOrMetamodel;
	    private NamespaceDeclarationGreen namespaceDeclaration;
	    private InternalSyntaxToken eOF;
	
	    public MainGreen(MetaSyntaxKind kind, GreenNode usingNamespaceOrMetamodel, NamespaceDeclarationGreen namespaceDeclaration, InternalSyntaxToken eOF)
	        : base(kind, null, null)
	    {
			this.SlotCount = 3;
			if (usingNamespaceOrMetamodel != null)
			{
				this.AdjustFlagsAndWidth(usingNamespaceOrMetamodel);
	    ...
	    public MainGreen(MetaSyntaxKind kind, GreenNode usingNamespaceOrMetamodel, NamespaceDeclarationGreen namespaceDeclaration, InternalSyntaxToken eOF, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations)
	        : base(kind, diagnostics, annotations)
	    {
			this.SlotCount = 3;
			if (usingNamespaceOrMetamodel != null)
	    ...
	    public Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<UsingNamespaceOrMetamodelGreen> UsingNamespaceOrMetamodel { get { return new Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<UsingNamespaceOrMetamodelGreen>(this.usingNamespaceOrMetamodel); } }
	    ...
	    public override InternalSyntaxNode WithDiagnostics(DiagnosticInfo[] diagnostics)
	    {
	        return new MainGreen(this.Kind, this.usingNamespaceOrMetamodel, this.namespaceDeclaration, this.eOF, diagnostics, this.GetAnnotations());
	    }
	
	    public override InternalSyntaxNode WithAnnotations(SyntaxAnnotation[] annotations)
	    {
	        return new MainGreen(this.Kind, this.usingNamespaceOrMetamodel, this.namespaceDeclaration, this.eOF, this.GetDiagnostics(), annotations);
	    }
	
	    public override GreenNode Clone()
	    {
			return new MainGreen(this.Kind, this.usingNamespaceOrMetamodel, this.namespaceDeclaration, this.eOF, this.GetDiagnostics(), this.GetAnnotations());
		}
	
	
	    public MainGreen Update(Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<UsingNamespaceOrMetamodelGreen> usingNamespaceOrMetamodel, NamespaceDeclarationGreen namespaceDeclaration, InternalSyntaxToken eOF)
	    {
	        if (this.UsingNamespaceOrMetamodel != usingNamespaceOrMetamodel ||
				this.NamespaceDeclaration != namespaceDeclaration ||
				this.EndOfFileToken != eOF)
	        {
	            InternalSyntaxNode newNode = MetaLanguage.Instance.InternalSyntaxFactory.Main(usingNamespaceOrMetamodel, namespaceDeclaration, eOF);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	...
	internal class UsingNamespaceOrMetamodelGreen : GreenSyntaxNode
	{
	    internal static readonly UsingNamespaceOrMetamodelGreen __Missing = new UsingNamespaceOrMetamodelGreen();
	    private UsingNamespaceGreen usingNamespace;
	    private UsingMetamodelGreen usingMetamodel;
	
	    public UsingNamespaceOrMetamodelGreen(MetaSyntaxKind kind, UsingNamespaceGreen usingNamespace, UsingMetamodelGreen usingMetamodel)
	        : base(kind, null, null)
	    {
			this.SlotCount = 2;
			...
			if (usingMetamodel != null)
			{
				this.AdjustFlagsAndWidth(usingMetamodel);
				this.usingMetamodel = usingMetamodel;
			}
	    }
	
	    public UsingNamespaceOrMetamodelGreen(MetaSyntaxKind kind, UsingNamespaceGreen usingNamespace, UsingMetamodelGreen usingMetamodel, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations)
	        : base(kind, diagnostics, annotations)
	    {
			this.SlotCount = 2;
			if (usingNamespace != null)
		...
		private UsingNamespaceOrMetamodelGreen()
			: base((MetaSyntaxKind)MetaSyntaxKind.UsingNamespaceOrMetamodel, null, null)
		{
			this.flags &= ~NodeFlags.IsNotMissing;
		}
	
	    public UsingNamespaceGreen UsingNamespace { get { return this.usingNamespace; } }
	    public UsingMetamodelGreen UsingMetamodel { get { return this.usingMetamodel; } }
	
	    protected override SyntaxNode CreateRed(SyntaxNode parent, int position)
	    {
	        return new global::MetaDslx.Languages.Meta.Syntax.UsingNamespaceOrMetamodelSyntax(this, (MetaSyntaxNode)parent, position);
	    }
	    ...
	    public override TResult Accept<TResult>(MetaSyntaxVisitor<TResult> visitor) => visitor.VisitUsingNamespaceOrMetamodelGreen(this);
	
	    public override void Accept(MetaSyntaxVisitor visitor) => visitor.VisitUsingNamespaceOrMetamodelGreen(this);
	
	    public override InternalSyntaxNode WithDiagnostics(DiagnosticInfo[] diagnostics)
	    {
	        return new UsingNamespaceOrMetamodelGreen(this.Kind, this.usingNamespace, this.usingMetamodel, diagnostics, this.GetAnnotations());
	    }
	
	    public override InternalSyntaxNode WithAnnotations(SyntaxAnnotation[] annotations)
	    {
	        return new UsingNamespaceOrMetamodelGreen(this.Kind, this.usingNamespace, this.usingMetamodel, this.GetDiagnostics(), annotations);
	    }
	
	    public override GreenNode Clone()
	    {
			return new UsingNamespaceOrMetamodelGreen(this.Kind, this.usingNamespace, this.usingMetamodel, this.GetDiagnostics(), this.GetAnnotations());
		}
	
	
	    public UsingNamespaceOrMetamodelGreen Update(UsingNamespaceGreen usingNamespace)
	    {
	        if (this.usingNamespace != usingNamespace)
	        {
	            InternalSyntaxNode newNode = MetaLanguage.Instance.InternalSyntaxFactory.UsingNamespaceOrMetamodel(usingNamespace);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (UsingNamespaceOrMetamodelGreen)newNode;
	        }
	        return this;
	    }
	
	    public UsingNamespaceOrMetamodelGreen Update(UsingMetamodelGreen usingMetamodel)
	    {
	        if (this.usingMetamodel != usingMetamodel)
	        {
	            InternalSyntaxNode newNode = MetaLanguage.Instance.InternalSyntaxFactory.UsingNamespaceOrMetamodel(usingMetamodel);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	...
	internal class UsingNamespaceGreen : GreenSyntaxNode
	{
	    ...
	    public UsingNamespaceGreen(MetaSyntaxKind kind, InternalSyntaxToken kUsing, NameGreen name, InternalSyntaxToken tAssign, QualifierGreen qualifier, InternalSyntaxToken tSemicolon)
	        : base(kind, null, null)
	    {
			this.SlotCount = 5;
			if (kUsing != null)
	    ...
	    public UsingNamespaceGreen(MetaSyntaxKind kind, InternalSyntaxToken kUsing, NameGreen name, InternalSyntaxToken tAssign, QualifierGreen qualifier, InternalSyntaxToken tSemicolon, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations)
	        : base(kind, diagnostics, annotations)
	    {
			this.SlotCount = 5;
			if (kUsing != null)
		...
		private UsingNamespaceGreen()
			: base((MetaSyntaxKind)MetaSyntaxKind.UsingNamespace, null, null)
		{
			this.flags &= ~NodeFlags.IsNotMissing;
		}
	    ...
	    protected override SyntaxNode CreateRed(SyntaxNode parent, int position)
	    {
	        return new global::MetaDslx.Languages.Meta.Syntax.UsingNamespaceSyntax(this, (MetaSyntaxNode)parent, position);
	    }
	    ...
	    public override TResult Accept<TResult>(MetaSyntaxVisitor<TResult> visitor) => visitor.VisitUsingNamespaceGreen(this);
	
	    public override void Accept(MetaSyntaxVisitor visitor) => visitor.VisitUsingNamespaceGreen(this);
	    ...
	    public UsingNamespaceGreen Update(InternalSyntaxToken kUsing, NameGreen name, InternalSyntaxToken tAssign, QualifierGreen qualifier, InternalSyntaxToken tSemicolon)
	    {
	        if (this.KUsing != kUsing ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            InternalSyntaxNode newNode = MetaLanguage.Instance.InternalSyntaxFactory.UsingNamespace(kUsing, name, tAssign, qualifier, tSemicolon);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	...
	internal class UsingMetamodelGreen : GreenSyntaxNode
	{
	    internal static readonly UsingMetamodelGreen __Missing = new UsingMetamodelGreen();
	    private InternalSyntaxToken kUsing;
	    private InternalSyntaxToken kMetamodel;
	    private NameGreen name;
	    private InternalSyntaxToken tAssign;
	    private UsingMetamodelReferenceGreen usingMetamodelReference;
	    private InternalSyntaxToken tSemicolon;
	
	    public UsingMetamodelGreen(MetaSyntaxKind kind, InternalSyntaxToken kUsing, InternalSyntaxToken kMetamodel, NameGreen name, InternalSyntaxToken tAssign, UsingMetamodelReferenceGreen usingMetamodelReference, InternalSyntaxToken tSemicolon)
	        : base(kind, null, null)
	    {
			this.SlotCount = 6;
			if (kUsing != null)
			...
			if (usingMetamodelReference != null)
			{
				this.AdjustFlagsAndWidth(usingMetamodelReference);
	    ...
	    public UsingMetamodelGreen(MetaSyntaxKind kind, InternalSyntaxToken kUsing, InternalSyntaxToken kMetamodel, NameGreen name, InternalSyntaxToken tAssign, UsingMetamodelReferenceGreen usingMetamodelReference, InternalSyntaxToken tSemicolon, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations)
	        : base(kind, diagnostics, annotations)
	    {
			this.SlotCount = 6;
			if (kUsing != null)
		...
		private UsingMetamodelGreen()
			: base((MetaSyntaxKind)MetaSyntaxKind.UsingMetamodel, null, null)
		{
			this.flags &= ~NodeFlags.IsNotMissing;
		}
	    ...
	    public NameGreen Name { get { return this.name; } }
	    public InternalSyntaxToken TAssign { get { return this.tAssign; } }
	    public UsingMetamodelReferenceGreen UsingMetamodelReference { get { return this.usingMetamodelReference; } }
	    public InternalSyntaxToken TSemicolon { get { return this.tSemicolon; } }
	
	    protected override SyntaxNode CreateRed(SyntaxNode parent, int position)
	    {
	        return new global::MetaDslx.Languages.Meta.Syntax.UsingMetamodelSyntax(this, (MetaSyntaxNode)parent, position);
	    }
	    ...
	    public override TResult Accept<TResult>(MetaSyntaxVisitor<TResult> visitor) => visitor.VisitUsingMetamodelGreen(this);
	
	    public override void Accept(MetaSyntaxVisitor visitor) => visitor.VisitUsingMetamodelGreen(this);
	
	    public override InternalSyntaxNode WithDiagnostics(DiagnosticInfo[] diagnostics)
	    {
	        return new UsingMetamodelGreen(this.Kind, this.kUsing, this.kMetamodel, this.name, this.tAssign, this.usingMetamodelReference, this.tSemicolon, diagnostics, this.GetAnnotations());
	    }
	
	    public override InternalSyntaxNode WithAnnotations(SyntaxAnnotation[] annotations)
	    {
	        return new UsingMetamodelGreen(this.Kind, this.kUsing, this.kMetamodel, this.name, this.tAssign, this.usingMetamodelReference, this.tSemicolon, this.GetDiagnostics(), annotations);
	    }
	
	    public override GreenNode Clone()
	    {
			return new UsingMetamodelGreen(this.Kind, this.kUsing, this.kMetamodel, this.name, this.tAssign, this.usingMetamodelReference, this.tSemicolon, this.GetDiagnostics(), this.GetAnnotations());
		}
	
	
	    public UsingMetamodelGreen Update(InternalSyntaxToken kUsing, InternalSyntaxToken kMetamodel, NameGreen name, InternalSyntaxToken tAssign, UsingMetamodelReferenceGreen usingMetamodelReference, InternalSyntaxToken tSemicolon)
	    {
	        if (this.KUsing != kUsing ||
				this.KMetamodel != kMetamodel ||
				this.Name != name ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            InternalSyntaxNode newNode = MetaLanguage.Instance.InternalSyntaxFactory.UsingMetamodel(kUsing, kMetamodel, name, tAssign, usingMetamodelReference, tSemicolon);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	...
	internal class UsingMetamodelReferenceGreen : GreenSyntaxNode
	{
	    internal static readonly UsingMetamodelReferenceGreen __Missing = new UsingMetamodelReferenceGreen();
	    private QualifierGreen qualifier;
	    private StringLiteralGreen stringLiteral;
	
	    public UsingMetamodelReferenceGreen(MetaSyntaxKind kind, QualifierGreen qualifier, StringLiteralGreen stringLiteral)
	        : base(kind, null, null)
	    {
			this.SlotCount = 2;
			if (qualifier != null)
	    ...
	    public UsingMetamodelReferenceGreen(MetaSyntaxKind kind, QualifierGreen qualifier, StringLiteralGreen stringLiteral, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations)
	        : base(kind, diagnostics, annotations)
	    {
			this.SlotCount = 2;
			if (qualifier != null)
		...
		private UsingMetamodelReferenceGreen()
			: base((MetaSyntaxKind)MetaSyntaxKind.UsingMetamodelReference, null, null)
		{
			this.flags &= ~NodeFlags.IsNotMissing;
		}
	    ...
	    protected override SyntaxNode CreateRed(SyntaxNode parent, int position)
	    {
	        return new global::MetaDslx.Languages.Meta.Syntax.UsingMetamodelReferenceSyntax(this, (MetaSyntaxNode)parent, position);
	    }
	    ...
	    public override TResult Accept<TResult>(MetaSyntaxVisitor<TResult> visitor) => visitor.VisitUsingMetamodelReferenceGreen(this);
	
	    public override void Accept(MetaSyntaxVisitor visitor) => visitor.VisitUsingMetamodelReferenceGreen(this);
	
	    public override InternalSyntaxNode WithDiagnostics(DiagnosticInfo[] diagnostics)
	    {
	        return new UsingMetamodelReferenceGreen(this.Kind, this.qualifier, this.stringLiteral, diagnostics, this.GetAnnotations());
	    }
	
	    public override InternalSyntaxNode WithAnnotations(SyntaxAnnotation[] annotations)
	    {
	        return new UsingMetamodelReferenceGreen(this.Kind, this.qualifier, this.stringLiteral, this.GetDiagnostics(), annotations);
	    }
	
	    public override GreenNode Clone()
	    {
			return new UsingMetamodelReferenceGreen(this.Kind, this.qualifier, this.stringLiteral, this.GetDiagnostics(), this.GetAnnotations());
		}
	
	
	    public UsingMetamodelReferenceGreen Update(QualifierGreen qualifier)
	    {
	        if (this.qualifier != qualifier)
	        {
	            InternalSyntaxNode newNode = MetaLanguage.Instance.InternalSyntaxFactory.UsingMetamodelReference(qualifier);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (UsingMetamodelReferenceGreen)newNode;
	        }
	        return this;
	    }
	
	    public UsingMetamodelReferenceGreen Update(StringLiteralGreen stringLiteral)
	    {
	        if (this.stringLiteral != stringLiteral)
	        {
	            InternalSyntaxNode newNode = MetaLanguage.Instance.InternalSyntaxFactory.UsingMetamodelReference(stringLiteral);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	...
	internal class NamespaceBodyGreen : GreenSyntaxNode
	{
	    ...
	    public NamespaceBodyGreen(MetaSyntaxKind kind, InternalSyntaxToken tOpenBrace, GreenNode usingNamespaceOrMetamodel, MetamodelDeclarationGreen metamodelDeclaration, GreenNode declaration, InternalSyntaxToken tCloseBrace)
	        : base(kind, null, null)
	    {
			this.SlotCount = 5;
			if (tOpenBrace != null)
	    ...
	    public NamespaceBodyGreen(MetaSyntaxKind kind, InternalSyntaxToken tOpenBrace, GreenNode usingNamespaceOrMetamodel, MetamodelDeclarationGreen metamodelDeclaration, GreenNode declaration, InternalSyntaxToken tCloseBrace, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations)
	        : base(kind, diagnostics, annotations)
	    {
			this.SlotCount = 5;
			if (tOpenBrace != null)
	    ...
	    public override InternalSyntaxNode WithDiagnostics(DiagnosticInfo[] diagnostics)
	    {
	        return new NamespaceBodyGreen(this.Kind, this.tOpenBrace, this.usingNamespaceOrMetamodel, this.metamodelDeclaration, this.declaration, this.tCloseBrace, diagnostics, this.GetAnnotations());
	    }
	
	    public override InternalSyntaxNode WithAnnotations(SyntaxAnnotation[] annotations)
	    {
	        return new NamespaceBodyGreen(this.Kind, this.tOpenBrace, this.usingNamespaceOrMetamodel, this.metamodelDeclaration, this.declaration, this.tCloseBrace, this.GetDiagnostics(), annotations);
	    }
	
	    public override GreenNode Clone()
	    {
			return new NamespaceBodyGreen(this.Kind, this.tOpenBrace, this.usingNamespaceOrMetamodel, this.metamodelDeclaration, this.declaration, this.tCloseBrace, this.GetDiagnostics(), this.GetAnnotations());
		}
	
	
	    public NamespaceBodyGreen Update(InternalSyntaxToken tOpenBrace, Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<UsingNamespaceOrMetamodelGreen> usingNamespaceOrMetamodel, MetamodelDeclarationGreen metamodelDeclaration, Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<DeclarationGreen> declaration, InternalSyntaxToken tCloseBrace)
	    {
	        if (this.TOpenBrace != tOpenBrace ||
				...
				this.TCloseBrace != tCloseBrace)
	        {
	            InternalSyntaxNode newNode = MetaLanguage.Instance.InternalSyntaxFactory.NamespaceBody(tOpenBrace, usingNamespaceOrMetamodel, metamodelDeclaration, declaration, tCloseBrace);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	...
	internal class MetamodelPropertyGreen : GreenSyntaxNode
	{
	    ...
	    private MajorVersionPropertyGreen majorVersionProperty;
	    private MinorVersionPropertyGreen minorVersionProperty;
	
	    public MetamodelPropertyGreen(MetaSyntaxKind kind, MetamodelUriPropertyGreen metamodelUriProperty, MetamodelPrefixPropertyGreen metamodelPrefixProperty, MajorVersionPropertyGreen majorVersionProperty, MinorVersionPropertyGreen minorVersionProperty)
	        : base(kind, null, null)
	    {
			this.SlotCount = 4;
			...
			if (majorVersionProperty != null)
			{
				this.AdjustFlagsAndWidth(majorVersionProperty);
				this.majorVersionProperty = majorVersionProperty;
			}
			if (minorVersionProperty != null)
			{
				this.AdjustFlagsAndWidth(minorVersionProperty);
				this.minorVersionProperty = minorVersionProperty;
			}
	    }
	
	    public MetamodelPropertyGreen(MetaSyntaxKind kind, MetamodelUriPropertyGreen metamodelUriProperty, MetamodelPrefixPropertyGreen metamodelPrefixProperty, MajorVersionPropertyGreen majorVersionProperty, MinorVersionPropertyGreen minorVersionProperty, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations)
	        : base(kind, diagnostics, annotations)
	    {
			this.SlotCount = 4;
			if (metamodelUriProperty != null)
	    ...
	    public MajorVersionPropertyGreen MajorVersionProperty { get { return this.majorVersionProperty; } }
	    public MinorVersionPropertyGreen MinorVersionProperty { get { return this.minorVersionProperty; } }
	    ...
	    public override InternalSyntaxNode WithDiagnostics(DiagnosticInfo[] diagnostics)
	    {
	        return new MetamodelPropertyGreen(this.Kind, this.metamodelUriProperty, this.metamodelPrefixProperty, this.majorVersionProperty, this.minorVersionProperty, diagnostics, this.GetAnnotations());
	    }
	
	    public override InternalSyntaxNode WithAnnotations(SyntaxAnnotation[] annotations)
	    {
	        return new MetamodelPropertyGreen(this.Kind, this.metamodelUriProperty, this.metamodelPrefixProperty, this.majorVersionProperty, this.minorVersionProperty, this.GetDiagnostics(), annotations);
	    }
	
	    public override GreenNode Clone()
	    {
			return new MetamodelPropertyGreen(this.Kind, this.metamodelUriProperty, this.metamodelPrefixProperty, this.majorVersionProperty, this.minorVersionProperty, this.GetDiagnostics(), this.GetAnnotations());
		}
	    ...
	    public MetamodelPropertyGreen Update(MajorVersionPropertyGreen majorVersionProperty)
	    {
	        if (this.majorVersionProperty != majorVersionProperty)
	        {
	            InternalSyntaxNode newNode = MetaLanguage.Instance.InternalSyntaxFactory.MetamodelProperty(majorVersionProperty);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	    ...
	    public MetamodelPropertyGreen Update(MinorVersionPropertyGreen minorVersionProperty)
	    {
	        if (this.minorVersionProperty != minorVersionProperty)
	        {
	            InternalSyntaxNode newNode = MetaLanguage.Instance.InternalSyntaxFactory.MetamodelProperty(minorVersionProperty);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	...
	internal class MetamodelPrefixPropertyGreen : GreenSyntaxNode
	{
	    ...
	    public MetamodelPrefixPropertyGreen(MetaSyntaxKind kind, InternalSyntaxToken iPrefix, InternalSyntaxToken tAssign, StringLiteralGreen stringLiteral)
	        : base(kind, null, null)
	    {
			this.SlotCount = 3;
			if (iPrefix != null)
	    ...
	    public MetamodelPrefixPropertyGreen(MetaSyntaxKind kind, InternalSyntaxToken iPrefix, InternalSyntaxToken tAssign, StringLiteralGreen stringLiteral, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations)
	        : base(kind, diagnostics, annotations)
	    {
			this.SlotCount = 3;
			if (iPrefix != null)
		...
		private MetamodelPrefixPropertyGreen()
			: base((MetaSyntaxKind)MetaSyntaxKind.MetamodelPrefixProperty, null, null)
		{
			this.flags &= ~NodeFlags.IsNotMissing;
		}
	    ...
	    protected override SyntaxNode CreateRed(SyntaxNode parent, int position)
	    {
	        return new global::MetaDslx.Languages.Meta.Syntax.MetamodelPrefixPropertySyntax(this, (MetaSyntaxNode)parent, position);
	    }
	    ...
	    public override TResult Accept<TResult>(MetaSyntaxVisitor<TResult> visitor) => visitor.VisitMetamodelPrefixPropertyGreen(this);
	
	    public override void Accept(MetaSyntaxVisitor visitor) => visitor.VisitMetamodelPrefixPropertyGreen(this);
	    ...
	    public MetamodelPrefixPropertyGreen Update(InternalSyntaxToken iPrefix, InternalSyntaxToken tAssign, StringLiteralGreen stringLiteral)
	    {
	        if (this.IPrefix != iPrefix ||
				...
				this.StringLiteral != stringLiteral)
	        {
	            InternalSyntaxNode newNode = MetaLanguage.Instance.InternalSyntaxFactory.MetamodelPrefixProperty(iPrefix, tAssign, stringLiteral);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	...
	internal class MajorVersionPropertyGreen : GreenSyntaxNode
	{
	    internal static readonly MajorVersionPropertyGreen __Missing = new MajorVersionPropertyGreen();
	    private InternalSyntaxToken iMajorVersion;
	    private InternalSyntaxToken tAssign;
	    private IntegerLiteralGreen integerLiteral;
	
	    public MajorVersionPropertyGreen(MetaSyntaxKind kind, InternalSyntaxToken iMajorVersion, InternalSyntaxToken tAssign, IntegerLiteralGreen integerLiteral)
	        : base(kind, null, null)
	    {
			this.SlotCount = 3;
			if (iMajorVersion != null)
			{
				this.AdjustFlagsAndWidth(iMajorVersion);
	    ...
	    public MajorVersionPropertyGreen(MetaSyntaxKind kind, InternalSyntaxToken iMajorVersion, InternalSyntaxToken tAssign, IntegerLiteralGreen integerLiteral, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations)
	        : base(kind, diagnostics, annotations)
	    {
			this.SlotCount = 3;
			if (iMajorVersion != null)
		...
		private MajorVersionPropertyGreen()
			: base((MetaSyntaxKind)MetaSyntaxKind.MajorVersionProperty, null, null)
		{
			this.flags &= ~NodeFlags.IsNotMissing;
		}
	
	    public InternalSyntaxToken IMajorVersion { get { return this.iMajorVersion; } }
	    public InternalSyntaxToken TAssign { get { return this.tAssign; } }
	    public IntegerLiteralGreen IntegerLiteral { get { return this.integerLiteral; } }
	
	    protected override SyntaxNode CreateRed(SyntaxNode parent, int position)
	    {
	        return new global::MetaDslx.Languages.Meta.Syntax.MajorVersionPropertySyntax(this, (MetaSyntaxNode)parent, position);
	    }
	    ...
	    protected override GreenNode GetSlot(int index)
	    {
	        switch (index)
	        {
	            case 0: return this.iMajorVersion;
	            case 1: return this.tAssign;
	    ...
	    public override TResult Accept<TResult>(MetaSyntaxVisitor<TResult> visitor) => visitor.VisitMajorVersionPropertyGreen(this);
	
	    public override void Accept(MetaSyntaxVisitor visitor) => visitor.VisitMajorVersionPropertyGreen(this);
	
	    public override InternalSyntaxNode WithDiagnostics(DiagnosticInfo[] diagnostics)
	    {
	        return new MajorVersionPropertyGreen(this.Kind, this.iMajorVersion, this.tAssign, this.integerLiteral, diagnostics, this.GetAnnotations());
	    }
	
	    public override InternalSyntaxNode WithAnnotations(SyntaxAnnotation[] annotations)
	    {
	        return new MajorVersionPropertyGreen(this.Kind, this.iMajorVersion, this.tAssign, this.integerLiteral, this.GetDiagnostics(), annotations);
	    }
	
	    public override GreenNode Clone()
	    {
			return new MajorVersionPropertyGreen(this.Kind, this.iMajorVersion, this.tAssign, this.integerLiteral, this.GetDiagnostics(), this.GetAnnotations());
		}
	
	
	    public MajorVersionPropertyGreen Update(InternalSyntaxToken iMajorVersion, InternalSyntaxToken tAssign, IntegerLiteralGreen integerLiteral)
	    {
	        if (this.IMajorVersion != iMajorVersion ||
				this.TAssign != tAssign ||
				this.IntegerLiteral != integerLiteral)
	        {
	            InternalSyntaxNode newNode = MetaLanguage.Instance.InternalSyntaxFactory.MajorVersionProperty(iMajorVersion, tAssign, integerLiteral);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (MajorVersionPropertyGreen)newNode;
	        }
	        return this;
	    }
	}
	
	internal class MinorVersionPropertyGreen : GreenSyntaxNode
	{
	    internal static readonly MinorVersionPropertyGreen __Missing = new MinorVersionPropertyGreen();
	    private InternalSyntaxToken iMinorVersion;
	    private InternalSyntaxToken tAssign;
	    private IntegerLiteralGreen integerLiteral;
	
	    public MinorVersionPropertyGreen(MetaSyntaxKind kind, InternalSyntaxToken iMinorVersion, InternalSyntaxToken tAssign, IntegerLiteralGreen integerLiteral)
	        : base(kind, null, null)
	    {
			this.SlotCount = 3;
			if (iMinorVersion != null)
			{
				this.AdjustFlagsAndWidth(iMinorVersion);
	    ...
	    public MinorVersionPropertyGreen(MetaSyntaxKind kind, InternalSyntaxToken iMinorVersion, InternalSyntaxToken tAssign, IntegerLiteralGreen integerLiteral, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations)
	        : base(kind, diagnostics, annotations)
	    {
			this.SlotCount = 3;
			if (iMinorVersion != null)
		...
		private MinorVersionPropertyGreen()
			: base((MetaSyntaxKind)MetaSyntaxKind.MinorVersionProperty, null, null)
		{
			this.flags &= ~NodeFlags.IsNotMissing;
		}
	
	    public InternalSyntaxToken IMinorVersion { get { return this.iMinorVersion; } }
	    public InternalSyntaxToken TAssign { get { return this.tAssign; } }
	    public IntegerLiteralGreen IntegerLiteral { get { return this.integerLiteral; } }
	
	    protected override SyntaxNode CreateRed(SyntaxNode parent, int position)
	    {
	        return new global::MetaDslx.Languages.Meta.Syntax.MinorVersionPropertySyntax(this, (MetaSyntaxNode)parent, position);
	    }
	    ...
	    protected override GreenNode GetSlot(int index)
	    {
	        switch (index)
	        {
	            case 0: return this.iMinorVersion;
	            case 1: return this.tAssign;
	            case 2: return this.integerLiteral;
	            default: return null;
	        }
	    ...
	    public override TResult Accept<TResult>(MetaSyntaxVisitor<TResult> visitor) => visitor.VisitMinorVersionPropertyGreen(this);
	
	    public override void Accept(MetaSyntaxVisitor visitor) => visitor.VisitMinorVersionPropertyGreen(this);
	
	    public override InternalSyntaxNode WithDiagnostics(DiagnosticInfo[] diagnostics)
	    {
	        return new MinorVersionPropertyGreen(this.Kind, this.iMinorVersion, this.tAssign, this.integerLiteral, diagnostics, this.GetAnnotations());
	    }
	
	    public override InternalSyntaxNode WithAnnotations(SyntaxAnnotation[] annotations)
	    {
	        return new MinorVersionPropertyGreen(this.Kind, this.iMinorVersion, this.tAssign, this.integerLiteral, this.GetDiagnostics(), annotations);
	    }
	
	    public override GreenNode Clone()
	    {
			return new MinorVersionPropertyGreen(this.Kind, this.iMinorVersion, this.tAssign, this.integerLiteral, this.GetDiagnostics(), this.GetAnnotations());
		}
	
	
	    public MinorVersionPropertyGreen Update(InternalSyntaxToken iMinorVersion, InternalSyntaxToken tAssign, IntegerLiteralGreen integerLiteral)
	    {
	        if (this.IMinorVersion != iMinorVersion ||
				this.TAssign != tAssign ||
				this.IntegerLiteral != integerLiteral)
	        {
	            InternalSyntaxNode newNode = MetaLanguage.Instance.InternalSyntaxFactory.MinorVersionProperty(iMinorVersion, tAssign, integerLiteral);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (MinorVersionPropertyGreen)newNode;
	        }
	        return this;
	    }
	}
	...
	internal class FieldDeclarationGreen : GreenSyntaxNode
	{
	    ...
	    private GreenNode attribute;
	    private FieldSymbolPropertyAttributeGreen fieldSymbolPropertyAttribute;
	        ...
	        : base(kind, null, null)
	    {
			...
			if (fieldSymbolPropertyAttribute != null)
			{
				this.AdjustFlagsAndWidth(fieldSymbolPropertyAttribute);
	    ...
	    public override InternalSyntaxNode WithDiagnostics(DiagnosticInfo[] diagnostics)
	    {
	        return new FieldDeclarationGreen(this.Kind, this.attribute, this.fieldSymbolPropertyAttribute, this.fieldContainment, this.fieldModifier, this.typeReference, this.name, this.defaultValue, this.redefinitionsOrSubsettings, this.tSemicolon, diagnostics, this.GetAnnotations());
	    }
	    ...
	    public FieldDeclarationGreen Update(Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<AttributeGreen> attribute, FieldSymbolPropertyAttributeGreen fieldSymbolPropertyAttribute, FieldContainmentGreen fieldContainment, FieldModifierGreen fieldModifier, TypeReferenceGreen typeReference, NameGreen name, DefaultValueGreen defaultValue, Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<RedefinitionsOrSubsettingsGreen> redefinitionsOrSubsettings, InternalSyntaxToken tSemicolon)
	    {
	        if (this.Attribute != attribute ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            InternalSyntaxNode newNode = MetaLanguage.Instance.InternalSyntaxFactory.FieldDeclaration(attribute, fieldSymbolPropertyAttribute, fieldContainment, fieldModifier, typeReference, name, defaultValue, redefinitionsOrSubsettings, tSemicolon);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	...
	internal class FieldSymbolPropertyAttributeGreen : GreenSyntaxNode
	{
		...
		private FieldSymbolPropertyAttributeGreen()
			: base((MetaSyntaxKind)MetaSyntaxKind.FieldSymbolPropertyAttribute, null, null)
		{
			this.flags &= ~NodeFlags.IsNotMissing;
		}
	    ...
	    protected override SyntaxNode CreateRed(SyntaxNode parent, int position)
	    {
	        return new global::MetaDslx.Languages.Meta.Syntax.FieldSymbolPropertyAttributeSyntax(this, (MetaSyntaxNode)parent, position);
	    }
	    ...
	    public override TResult Accept<TResult>(MetaSyntaxVisitor<TResult> visitor) => visitor.VisitFieldSymbolPropertyAttributeGreen(this);
	
	    public override void Accept(MetaSyntaxVisitor visitor) => visitor.VisitFieldSymbolPropertyAttributeGreen(this);
	    ...
	    public FieldSymbolPropertyAttributeGreen Update(InternalSyntaxToken tOpenBracket, InternalSyntaxToken kProperty, InternalSyntaxToken tColon, IdentifierGreen identifier, InternalSyntaxToken tCloseBracket)
	    {
				...
				this.TCloseBracket != tCloseBracket)
	        {
	            ...
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (FieldSymbolPropertyAttributeGreen)newNode;
	        }
	        return this;
	    }
	}
	...
	internal class MetaSyntaxVisitor : InternalSyntaxVisitor
	{
		...
		public virtual void VisitUsingNamespaceOrMetamodelGreen(UsingNamespaceOrMetamodelGreen node) => this.DefaultVisit(node);
		...
		public virtual void VisitUsingMetamodelReferenceGreen(UsingMetamodelReferenceGreen node) => this.DefaultVisit(node);
		...
		public virtual void VisitMajorVersionPropertyGreen(MajorVersionPropertyGreen node) => this.DefaultVisit(node);
		public virtual void VisitMinorVersionPropertyGreen(MinorVersionPropertyGreen node) => this.DefaultVisit(node);
		...
		public virtual void VisitFieldSymbolPropertyAttributeGreen(FieldSymbolPropertyAttributeGreen node) => this.DefaultVisit(node);
	...
	internal class MetaSyntaxVisitor<TResult> : InternalSyntaxVisitor<TResult>
	{
		...
		public virtual TResult VisitUsingNamespaceOrMetamodelGreen(UsingNamespaceOrMetamodelGreen node) => this.DefaultVisit(node);
		...
		public virtual TResult VisitUsingMetamodelReferenceGreen(UsingMetamodelReferenceGreen node) => this.DefaultVisit(node);
		...
		public virtual TResult VisitMajorVersionPropertyGreen(MajorVersionPropertyGreen node) => this.DefaultVisit(node);
		public virtual TResult VisitMinorVersionPropertyGreen(MinorVersionPropertyGreen node) => this.DefaultVisit(node);
		...
		public virtual TResult VisitFieldSymbolPropertyAttributeGreen(FieldSymbolPropertyAttributeGreen node) => this.DefaultVisit(node);
	...
	internal class MetaInternalSyntaxFactory : InternalSyntaxFactory, global::MetaDslx.Languages.Antlr4Roslyn.Syntax.InternalSyntax.IAntlr4SyntaxFactory
	{
		...
		{
			return new GreenSkippedTokensTriviaSyntax(ToMetaSyntaxKind(SyntaxKind.SkippedTokensTrivia), token);
		}
		...
		public MainGreen Main(Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<UsingNamespaceOrMetamodelGreen> usingNamespaceOrMetamodel, NamespaceDeclarationGreen namespaceDeclaration, InternalSyntaxToken eOF)
	    {
	#if DEBUG
	...
	#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaSyntaxKind)MetaSyntaxKind.Main, usingNamespaceOrMetamodel.Node, namespaceDeclaration, eOF, out hash);
			if (cached != null) return (MainGreen)cached;
			var result = new MainGreen(MetaSyntaxKind.Main, usingNamespaceOrMetamodel.Node, namespaceDeclaration, eOF);
			if (hash >= 0)
			{
		...
		public UsingNamespaceOrMetamodelGreen UsingNamespaceOrMetamodel(UsingNamespaceGreen usingNamespace)
	    {
	#if DEBUG
		    if (usingNamespace == null) throw new ArgumentNullException(nameof(usingNamespace));
	#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaSyntaxKind)MetaSyntaxKind.UsingNamespaceOrMetamodel, usingNamespace, out hash);
			if (cached != null) return (UsingNamespaceOrMetamodelGreen)cached;
			var result = new UsingNamespaceOrMetamodelGreen(MetaSyntaxKind.UsingNamespaceOrMetamodel, usingNamespace, null);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
		...
		public UsingNamespaceOrMetamodelGreen UsingNamespaceOrMetamodel(UsingMetamodelGreen usingMetamodel)
	    {
	#if DEBUG
		    if (usingMetamodel == null) throw new ArgumentNullException(nameof(usingMetamodel));
	#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaSyntaxKind)MetaSyntaxKind.UsingNamespaceOrMetamodel, usingMetamodel, out hash);
			if (cached != null) return (UsingNamespaceOrMetamodelGreen)cached;
			var result = new UsingNamespaceOrMetamodelGreen(MetaSyntaxKind.UsingNamespaceOrMetamodel, null, usingMetamodel);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
		...
		public UsingNamespaceGreen UsingNamespace(InternalSyntaxToken kUsing, NameGreen name, InternalSyntaxToken tAssign, QualifierGreen qualifier, InternalSyntaxToken tSemicolon)
	    {
			...
			if (kUsing.Kind != MetaSyntaxKind.KUsing) throw new ArgumentException(nameof(kUsing));
			if (tAssign != null && tAssign.Kind != MetaSyntaxKind.TAssign) throw new ArgumentException(nameof(tAssign));
			if (qualifier == null) throw new ArgumentNullException(nameof(qualifier));
			if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
			if (tSemicolon.Kind != MetaSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
	#endif
	        return new UsingNamespaceGreen(MetaSyntaxKind.UsingNamespace, kUsing, name, tAssign, qualifier, tSemicolon);
	    }
	
		public UsingMetamodelGreen UsingMetamodel(InternalSyntaxToken kUsing, InternalSyntaxToken kMetamodel, NameGreen name, InternalSyntaxToken tAssign, UsingMetamodelReferenceGreen usingMetamodelReference, InternalSyntaxToken tSemicolon)
	    {
	#if DEBUG
			if (kUsing == null) throw new ArgumentNullException(nameof(kUsing));
			if (kUsing.Kind != MetaSyntaxKind.KUsing) throw new ArgumentException(nameof(kUsing));
			...
			if (tSemicolon.Kind != MetaSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
	#endif
	        return new UsingMetamodelGreen(MetaSyntaxKind.UsingMetamodel, kUsing, kMetamodel, name, tAssign, usingMetamodelReference, tSemicolon);
	    }
	
		public UsingMetamodelReferenceGreen UsingMetamodelReference(QualifierGreen qualifier)
	    {
	#if DEBUG
		    if (qualifier == null) throw new ArgumentNullException(nameof(qualifier));
	#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaSyntaxKind)MetaSyntaxKind.UsingMetamodelReference, qualifier, out hash);
			if (cached != null) return (UsingMetamodelReferenceGreen)cached;
			var result = new UsingMetamodelReferenceGreen(MetaSyntaxKind.UsingMetamodelReference, qualifier, null);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
		...
		public UsingMetamodelReferenceGreen UsingMetamodelReference(StringLiteralGreen stringLiteral)
	    {
	#if DEBUG
		    if (stringLiteral == null) throw new ArgumentNullException(nameof(stringLiteral));
	#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaSyntaxKind)MetaSyntaxKind.UsingMetamodelReference, stringLiteral, out hash);
			if (cached != null) return (UsingMetamodelReferenceGreen)cached;
			var result = new UsingMetamodelReferenceGreen(MetaSyntaxKind.UsingMetamodelReference, null, stringLiteral);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
		...
		public NamespaceBodyGreen NamespaceBody(InternalSyntaxToken tOpenBrace, Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<UsingNamespaceOrMetamodelGreen> usingNamespaceOrMetamodel, MetamodelDeclarationGreen metamodelDeclaration, Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<DeclarationGreen> declaration, InternalSyntaxToken tCloseBrace)
	    {
	#if DEBUG
	...
	#endif
	        return new NamespaceBodyGreen(MetaSyntaxKind.NamespaceBody, tOpenBrace, usingNamespaceOrMetamodel.Node, metamodelDeclaration, declaration.Node, tCloseBrace);
	    }
	...
	#endif
			return new MetamodelPropertyGreen(MetaSyntaxKind.MetamodelProperty, metamodelUriProperty, null, null, null);
	    }
	...
	#endif
			return new MetamodelPropertyGreen(MetaSyntaxKind.MetamodelProperty, null, metamodelPrefixProperty, null, null);
	    }
	
		public MetamodelPropertyGreen MetamodelProperty(MajorVersionPropertyGreen majorVersionProperty)
	    {
	#if DEBUG
		    if (majorVersionProperty == null) throw new ArgumentNullException(nameof(majorVersionProperty));
	#endif
			return new MetamodelPropertyGreen(MetaSyntaxKind.MetamodelProperty, null, null, majorVersionProperty, null);
	    }
	
		public MetamodelPropertyGreen MetamodelProperty(MinorVersionPropertyGreen minorVersionProperty)
	    {
	#if DEBUG
		    if (minorVersionProperty == null) throw new ArgumentNullException(nameof(minorVersionProperty));
	#endif
			return new MetamodelPropertyGreen(MetaSyntaxKind.MetamodelProperty, null, null, null, minorVersionProperty);
	    }
		...
		public MetamodelPrefixPropertyGreen MetamodelPrefixProperty(InternalSyntaxToken iPrefix, InternalSyntaxToken tAssign, StringLiteralGreen stringLiteral)
	    {
			...
			if (iPrefix.Kind != MetaSyntaxKind.IPrefix) throw new ArgumentException(nameof(iPrefix));
			if (tAssign == null) throw new ArgumentNullException(nameof(tAssign));
			if (tAssign.Kind != MetaSyntaxKind.TAssign) throw new ArgumentException(nameof(tAssign));
			if (stringLiteral == null) throw new ArgumentNullException(nameof(stringLiteral));
	#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaSyntaxKind)MetaSyntaxKind.MetamodelPrefixProperty, iPrefix, tAssign, stringLiteral, out hash);
			if (cached != null) return (MetamodelPrefixPropertyGreen)cached;
			var result = new MetamodelPrefixPropertyGreen(MetaSyntaxKind.MetamodelPrefixProperty, iPrefix, tAssign, stringLiteral);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
		...
		public MajorVersionPropertyGreen MajorVersionProperty(InternalSyntaxToken iMajorVersion, InternalSyntaxToken tAssign, IntegerLiteralGreen integerLiteral)
	    {
	#if DEBUG
			if (iMajorVersion == null) throw new ArgumentNullException(nameof(iMajorVersion));
			if (iMajorVersion.Kind != MetaSyntaxKind.IMajorVersion) throw new ArgumentException(nameof(iMajorVersion));
			if (tAssign == null) throw new ArgumentNullException(nameof(tAssign));
			if (tAssign.Kind != MetaSyntaxKind.TAssign) throw new ArgumentException(nameof(tAssign));
			if (integerLiteral == null) throw new ArgumentNullException(nameof(integerLiteral));
	#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaSyntaxKind)MetaSyntaxKind.MajorVersionProperty, iMajorVersion, tAssign, integerLiteral, out hash);
			if (cached != null) return (MajorVersionPropertyGreen)cached;
			var result = new MajorVersionPropertyGreen(MetaSyntaxKind.MajorVersionProperty, iMajorVersion, tAssign, integerLiteral);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
		...
		public MinorVersionPropertyGreen MinorVersionProperty(InternalSyntaxToken iMinorVersion, InternalSyntaxToken tAssign, IntegerLiteralGreen integerLiteral)
	    {
	#if DEBUG
			if (iMinorVersion == null) throw new ArgumentNullException(nameof(iMinorVersion));
			if (iMinorVersion.Kind != MetaSyntaxKind.IMinorVersion) throw new ArgumentException(nameof(iMinorVersion));
			if (tAssign == null) throw new ArgumentNullException(nameof(tAssign));
			if (tAssign.Kind != MetaSyntaxKind.TAssign) throw new ArgumentException(nameof(tAssign));
			if (integerLiteral == null) throw new ArgumentNullException(nameof(integerLiteral));
	#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaSyntaxKind)MetaSyntaxKind.MinorVersionProperty, iMinorVersion, tAssign, integerLiteral, out hash);
			if (cached != null) return (MinorVersionPropertyGreen)cached;
			var result = new MinorVersionPropertyGreen(MetaSyntaxKind.MinorVersionProperty, iMinorVersion, tAssign, integerLiteral);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
	    ...
	    internal static IEnumerable<Type> GetNodeTypes()
	    {
	        return new Type[] {
				...
				typeof(UsingNamespaceOrMetamodelGreen),
				typeof(UsingNamespaceGreen),
				typeof(UsingMetamodelGreen),
				typeof(UsingMetamodelReferenceGreen),
				...
				typeof(MajorVersionPropertyGreen),
				typeof(MinorVersionPropertyGreen),
				...
				typeof(FieldSymbolPropertyAttributeGreen),
