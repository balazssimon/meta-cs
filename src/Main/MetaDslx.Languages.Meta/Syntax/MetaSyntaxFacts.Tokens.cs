...
namespace MetaDslx.Languages.Meta.Syntax
{
	...
	public partial class MetaSyntaxFacts : SyntaxFacts
	{
        ...
        public override SyntaxKind DefaultWhitespaceKind => (MetaSyntaxKind)MetaSyntaxKind.LWhiteSpace;
        public override SyntaxKind DefaultEndOfLineKind => (MetaSyntaxKind)MetaSyntaxKind.LCrLf;
        public override SyntaxKind DefaultSeparatorKind => (MetaSyntaxKind)MetaSyntaxKind.TComma;
        public override SyntaxKind DefaultIdentifierKind => (MetaSyntaxKind)MetaSyntaxKind.IdentifierNormal;
