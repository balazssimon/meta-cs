...
namespace MetaDslx.Languages.Meta.Syntax
{
	public class MetaTokensSyntaxKind : SyntaxKind
	{
		...
		public const string IMajorVersion = nameof(IMajorVersion); // 97
		public const string IMinorVersion = nameof(IMinorVersion); // 98
		public const string IdentifierNormal = nameof(IdentifierNormal); // 99
		public const string IdentifierVerbatim = nameof(IdentifierVerbatim); // 100
		...
		public const string LRegularString = nameof(LRegularString); // 108
		public const string LGuid = nameof(LGuid); // 109
		public const string LUtf8Bom = nameof(LUtf8Bom); // 110
		public const string LWhiteSpace = nameof(LWhiteSpace); // 111
		public const string LCrLf = nameof(LCrLf); // 112
		public const string LLineEnd = nameof(LLineEnd); // 113
		public const string LSingleLineComment = nameof(LSingleLineComment); // 114
		public const string LComment = nameof(LComment); // 115
		public const string LDoubleQuoteVerbatimString = nameof(LDoubleQuoteVerbatimString); // 116
		public const string LSingleQuoteVerbatimString = nameof(LSingleQuoteVerbatimString); // 117
		public const string DoubleQuoteVerbatimStringLiteralStart = nameof(DoubleQuoteVerbatimStringLiteralStart); // 118
		public const string SingleQuoteVerbatimStringLiteralStart = nameof(SingleQuoteVerbatimStringLiteralStart); // 119
		public const string LCommentStart = nameof(LCommentStart); // 120
