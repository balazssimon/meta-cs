...
namespace MetaDslx.Languages.Meta.Syntax
{
	public class MetaTokensSyntaxKind : SyntaxKind
	{
		...
		public const string IdentifierNormal = nameof(IdentifierNormal); // 97
		public const string IdentifierVerbatim = nameof(IdentifierVerbatim); // 98
		public const string LInteger = nameof(LInteger); // 99
		public const string LDecimal = nameof(LDecimal); // 100
		public const string LScientific = nameof(LScientific); // 101
		public const string LDateTimeOffset = nameof(LDateTimeOffset); // 102
		public const string LDateTime = nameof(LDateTime); // 103
		public const string LDate = nameof(LDate); // 104
		public const string LTime = nameof(LTime); // 105
		public const string LRegularString = nameof(LRegularString); // 106
		public const string LGuid = nameof(LGuid); // 107
		public const string LUtf8Bom = nameof(LUtf8Bom); // 108
		public const string LWhiteSpace = nameof(LWhiteSpace); // 109
		public const string LCrLf = nameof(LCrLf); // 110
		public const string LLineEnd = nameof(LLineEnd); // 111
		public const string LSingleLineComment = nameof(LSingleLineComment); // 112
		public const string LComment = nameof(LComment); // 113
		public const string LDoubleQuoteVerbatimString = nameof(LDoubleQuoteVerbatimString); // 114
		public const string LSingleQuoteVerbatimString = nameof(LSingleQuoteVerbatimString); // 115
		public const string DoubleQuoteVerbatimStringLiteralStart = nameof(DoubleQuoteVerbatimStringLiteralStart); // 116
		public const string SingleQuoteVerbatimStringLiteralStart = nameof(SingleQuoteVerbatimStringLiteralStart); // 117
		public const string LCommentStart = nameof(LCommentStart); // 118
