...
namespace MetaDslx.Languages.Meta.Binding
{
    ...
    public class MetaBoundNodeFactoryVisitor : BoundNodeFactoryVisitor, IMetaSyntaxVisitor<ArrayBuilder<object>, BoundNode>
    {
        ...
        {
            return new BoundDocumentation(MetaBoundKind.Documentation, boundTree, childBoundNodes, syntax, hasErrors);
        }
		...
		public BoundNode VisitAttribute(AttributeSyntax node, ArrayBuilder<object> childBoundNodesForParent)
		{
			...
			try
			{
				...
				{
					BoundNode resultNode;
					resultNode = this.CreateBoundAttribute(this.BoundTree, childBoundNodes.ToImmutableAndFree(), types: ImmutableArray.Create(typeof(MetaAttribute)), syntax: node, hasErrors: false);
