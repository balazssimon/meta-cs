...
using CommonAssemblyWellKnownAttributeData = MetaDslx.CodeAnalysis.CommonAssemblyWellKnownAttributeData<MetaDslx.CodeAnalysis.CSharp.Symbols.NamedTypeSymbol>;
