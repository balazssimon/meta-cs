...
public interface IMetaGeneratorParserVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitUsingDeclaration([NotNull] MetaGeneratorParser.UsingDeclarationContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitConfigProperty([NotNull] MetaGeneratorParser.ConfigPropertyContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitLoopChainExpression([NotNull] MetaGeneratorParser.LoopChainExpressionContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitAnonymousFunctionSignature([NotNull] MetaGeneratorParser.AnonymousFunctionSignatureContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitExpression([NotNull] MetaGeneratorParser.ExpressionContext context);
