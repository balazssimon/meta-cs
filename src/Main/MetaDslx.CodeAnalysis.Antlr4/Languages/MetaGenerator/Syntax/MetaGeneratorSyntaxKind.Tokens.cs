...
namespace MetaDslx.Languages.MetaGenerator.Syntax
{
	public class MetaGeneratorTokensSyntaxKind : SyntaxKind
	{
		...
		public const string TQuestionDot = nameof(TQuestionDot); // 56
		public const string TComma = nameof(TComma); // 57
		public const string TAssign = nameof(TAssign); // 58
		public const string TAssignPlus = nameof(TAssignPlus); // 59
		public const string TAssignMinus = nameof(TAssignMinus); // 60
		public const string TAssignAsterisk = nameof(TAssignAsterisk); // 61
		public const string TAssignSlash = nameof(TAssignSlash); // 62
		public const string TAssignPercent = nameof(TAssignPercent); // 63
		public const string TAssignAmp = nameof(TAssignAmp); // 64
		public const string TAssignPipe = nameof(TAssignPipe); // 65
		public const string TAssignHat = nameof(TAssignHat); // 66
		public const string TAssignLeftShift = nameof(TAssignLeftShift); // 67
		public const string TAssignRightShift = nameof(TAssignRightShift); // 68
		public const string TOpenParenthesis = nameof(TOpenParenthesis); // 69
		public const string TCloseParenthesis = nameof(TCloseParenthesis); // 70
		public const string TOpenBracket = nameof(TOpenBracket); // 71
		public const string TCloseBracket = nameof(TCloseBracket); // 72
		public const string TOpenBrace = nameof(TOpenBrace); // 73
		public const string TCloseBrace = nameof(TCloseBrace); // 74
		public const string TEquals = nameof(TEquals); // 75
		public const string TNotEquals = nameof(TNotEquals); // 76
		public const string TArrow = nameof(TArrow); // 77
		public const string TSingleArrow = nameof(TSingleArrow); // 78
		public const string TLessThan = nameof(TLessThan); // 79
		public const string TGreaterThan = nameof(TGreaterThan); // 80
		public const string TLessThanOrEquals = nameof(TLessThanOrEquals); // 81
		public const string TGreaterThanOrEquals = nameof(TGreaterThanOrEquals); // 82
		public const string TQuestion = nameof(TQuestion); // 83
		public const string TPlus = nameof(TPlus); // 84
		public const string TMinus = nameof(TMinus); // 85
		public const string TExclamation = nameof(TExclamation); // 86
		public const string TTilde = nameof(TTilde); // 87
		public const string TAsterisk = nameof(TAsterisk); // 88
		public const string TSlash = nameof(TSlash); // 89
		public const string TPercent = nameof(TPercent); // 90
		public const string TPlusPlus = nameof(TPlusPlus); // 91
		public const string TMinusMinus = nameof(TMinusMinus); // 92
		public const string TColonColon = nameof(TColonColon); // 93
		public const string TAmp = nameof(TAmp); // 94
		public const string THat = nameof(THat); // 95
		public const string TPipe = nameof(TPipe); // 96
		public const string TAnd = nameof(TAnd); // 97
		public const string TXor = nameof(TXor); // 98
		public const string TOr = nameof(TOr); // 99
		public const string TQuestionQuestion = nameof(TQuestionQuestion); // 100
		public const string IdentifierNormal = nameof(IdentifierNormal); // 101
		...
		public const string LChar = nameof(LChar); // 109
		public const string LRegularString = nameof(LRegularString); // 110
		public const string LGuid = nameof(LGuid); // 111
		public const string LUtf8Bom = nameof(LUtf8Bom); // 112
		public const string LWhitespace = nameof(LWhitespace); // 113
		public const string LCrLf = nameof(LCrLf); // 114
		public const string LLineBreak = nameof(LLineBreak); // 115
		public const string LLineComment = nameof(LLineComment); // 116
		public const string LMultiLineComment = nameof(LMultiLineComment); // 117
		public const string LDoubleQuoteVerbatimString = nameof(LDoubleQuoteVerbatimString); // 118
		public const string TH_TOpenParenthesis = nameof(TH_TOpenParenthesis); // 119
		public const string TH_TCloseParenthesis = nameof(TH_TCloseParenthesis); // 120
		public const string KEndTemplate = nameof(KEndTemplate); // 121
		public const string LTemplateLineControl = nameof(LTemplateLineControl); // 122
		public const string LTemplateOutput = nameof(LTemplateOutput); // 123
		public const string LTemplateCrLf = nameof(LTemplateCrLf); // 124
		public const string LTemplateLineBreak = nameof(LTemplateLineBreak); // 125
		public const string TTemplateStatementStart = nameof(TTemplateStatementStart); // 126
		public const string TTemplateStatementEnd = nameof(TTemplateStatementEnd); // 127
		public const string TS_TOpenBracket = nameof(TS_TOpenBracket); // 128
		public const string TS_TCloseBracket = nameof(TS_TCloseBracket); // 129
		public const string DoubleQuoteVerbatimStringLiteralStart = nameof(DoubleQuoteVerbatimStringLiteralStart); // 130
		public const string COMMENT_START = nameof(COMMENT_START); // 131
