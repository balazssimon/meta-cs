...
namespace MetaDslx.Languages.Antlr4Roslyn.Compilation
{
    public class Antlr4RoslynErrorCode : ErrorCode
    {
        ...
        public static readonly Antlr4RoslynErrorCode ERR_Antlr4Error = new Antlr4RoslynErrorCode(10, DiagnosticSeverity.Error, "ANTLR4 error", "ANTLR4 error: {0}");
        public static readonly Antlr4RoslynErrorCode WRN_Antlr4Warning = new Antlr4RoslynErrorCode(11, DiagnosticSeverity.Warning, "ANTLR4 warning", "ANTLR4 warning: {0}");
        public static readonly Antlr4RoslynErrorCode INF_Antlr4Info = new Antlr4RoslynErrorCode(12, DiagnosticSeverity.Info, "ANTLR4 info", "ANTLR4 info: {0}");
        public static readonly Antlr4RoslynErrorCode ERR_MainRuleMustEndWithEof = new Antlr4RoslynErrorCode(13, DiagnosticSeverity.Error, "Missing EOF", "The first rule (main rule) must end with EOF.");
