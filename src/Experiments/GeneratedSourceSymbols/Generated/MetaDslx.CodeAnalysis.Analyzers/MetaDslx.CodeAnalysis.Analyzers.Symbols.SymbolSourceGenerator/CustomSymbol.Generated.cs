...
namespace GeneratedSourceSymbols
{
	public abstract partial class CustomSymbol
	{
        public static new class CompletionParts
        {
            ...
            public static readonly CompletionPart CheckCustomArray = new CompletionPart(nameof(CheckCustomArray));
...
namespace GeneratedSourceSymbols.Completion
{
	public abstract partial class CompletionCustomSymbol
	{
        ...
        public CompletionCustomSymbol(Symbol container, object? modelObject, bool isError = false)
        {
        ...
        public override void ForceComplete(CompletionPart completionPart, SourceLocation? locationOpt, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_CustomArray || incompletePart == CompletionParts.FinishComputingProperty_CustomArray)
                {
                    ...
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _customArray = CompleteSymbolProperty_CustomArray(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                        _state.NotePartComplete(CompletionParts.FinishComputingProperty_CustomArray);
                    }
                }
                else if (incompletePart == CompletionParts.CheckCustomArray)
                {
                    var diagnostics = DiagnosticBag.GetInstance();
                    CheckCustomArray(diagnostics, cancellationToken);
                    AddSymbolDiagnostics(diagnostics);
                    diagnostics.Free();
                    _state.NotePartComplete(CompletionParts.CheckCustomArray);
                }
                else if (incompletePart == CompletionParts.StartComputingProperty_IntArray || incompletePart == CompletionParts.FinishComputingProperty_IntArray)
                {
                    ...
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _intArray = CompleteSymbolProperty_IntArray(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
                ...
                else if (incompletePart == CompletionParts.StartComputingProperty_Int || incompletePart == CompletionParts.FinishComputingProperty_Int)
                {
                    ...
                    {
                        var diagnostics = DiagnosticBag.GetInstance();
                        _int = CompleteSymbolProperty_Int(diagnostics, cancellationToken);
                        AddSymbolDiagnostics(diagnostics);
                        diagnostics.Free();
        ...
        protected virtual global::GeneratedSourceSymbols.CustomSymbol CompleteSymbolProperty_Left(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::GeneratedSourceSymbols.CustomSymbol>(this, nameof(Left), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual global::GeneratedSourceSymbols.CustomSymbol CompleteSymbolProperty_Right(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<global::GeneratedSourceSymbols.CustomSymbol>(this, nameof(Right), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual global::System.Collections.Immutable.ImmutableArray<global::GeneratedSourceSymbols.CustomSymbol> CompleteSymbolProperty_CustomArray(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValues<global::GeneratedSourceSymbols.CustomSymbol>(this, nameof(CustomArray), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual global::System.Collections.Immutable.ImmutableArray<int> CompleteSymbolProperty_IntArray(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValues<int>(this, nameof(IntArray), diagnostics, cancellationToken, out var result);
            return result;
        }

        protected virtual int CompleteSymbolProperty_Int(DiagnosticBag diagnostics, CancellationToken cancellationToken)
        {
            SymbolImplementation.AssignSymbolPropertyValue<int>(this, nameof(Int), diagnostics, cancellationToken, out var result);
            return result;
        }
...
{
	public partial class MetadataCustomSymbol : GeneratedSourceSymbols.Completion.CompletionCustomSymbol
	{
        public MetadataCustomSymbol(Symbol container, object? modelObject, bool isError = false)
        ...
        public partial class Error : MetadataCustomSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
...
{
	public partial class SourceCustomSymbol : GeneratedSourceSymbols.Completion.CompletionCustomSymbol, MetaDslx.CodeAnalysis.Symbols.Source.ISourceSymbol
	{
        private readonly MergedDeclaration _declaration;
        private LexicalSortKey _lazyLexicalSortKey = LexicalSortKey.NotInitialized;

		public SourceCustomSymbol(Symbol containingSymbol, MergedDeclaration declaration, object? modelObject, bool isError = false)
        ...
        public partial class Error : SourceCustomSymbol, MetaDslx.CodeAnalysis.Symbols.IErrorSymbol
        {
            private readonly string _name;
            private readonly string _metadataName;
            private DiagnosticInfo _errorInfo;
