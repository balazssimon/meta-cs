...
namespace MetaDslx.Compiler
{
    ...
    public class MetaModelCompiler : MetaCompiler
    {
        ...
        {
            this.GlobalScope = new Scope(null, MetaMofName.None, null);
            ...
            this.Lexer = new MetaLexer(inputStream);
            this.Lexer.AddErrorListener(this);
            CommonTokenStream commonTokenStream = new CommonTokenStream(this.Lexer);
            this.Parser = new MetaParser(commonTokenStream);
            this.Parser.AddErrorListener(this);
            this.ParseTree = this.Parser.main();
            MetaParserAnnotator annotator = new MetaParserAnnotator();
        ...
        public MetaParser.MainContext ParseTree { get; private set; }
        public MetaLexer Lexer { get; private set; }
        public MetaParser Parser { get; private set; }
    ...
    public class PrimitiveTypeDefinition : TypeDefinition
    {
        public PrimitiveTypeDefinition(string name, Scope parent)
            : base(name, MetaMofName.Type, parent)
        {
        }
    ...
    internal class MetaCompilerVisitor : MetaParserBaseVisitor<object>
    {
    ...
    internal class MetaMofVisitorTypeRef : MetaParserBaseVisitor<TypeDefinition>
    {
        private MetaModelCompiler compiler;
        private Scope global;
        private Scope currentScope;
        ...
        public override TypeDefinition VisitTypeReference(MetaParser.TypeReferenceContext context)
        {
        ...
        public override TypeDefinition VisitPrimitiveType(MetaParser.PrimitiveTypeContext context)
        {
            return this.global.GetType(context.GetText(), this.kind);
        }

        public override TypeDefinition VisitObjectType(MetaParser.ObjectTypeContext context)
        {
            return this.global.GetType(context.GetText(), this.kind);
        }

        public override TypeDefinition VisitVoidType(MetaParser.VoidTypeContext context)
        {
            return this.global.GetType(context.GetText(), this.kind);
        }

        public override TypeDefinition VisitNullableType(MetaParser.NullableTypeContext context)
        {
        ...
        public override TypeDefinition VisitCollectionType(MetaParser.CollectionTypeContext context)
        {
        ...
        public override TypeDefinition VisitSimpleType(MetaParser.SimpleTypeContext context)
        {
        ...
        public override TypeDefinition VisitQualifiedName(MetaParser.QualifiedNameContext context)
        {
            return this.currentScope.ResolveType(context.identifier().Select(i => i.GetText()).ToList(), this.kind, this.position);
        }

        public override TypeDefinition VisitIdentifier(MetaParser.IdentifierContext context)
        {
