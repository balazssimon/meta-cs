...
namespace MetaDslx.Compiler
{
    public abstract class LexerAdaptor : Lexer
    {
        ...
        protected void handleBeginArgument()
        {
            if (inLexerRule())
            {
                PushMode(AnnotatedAntlr4Lexer.LexerCharSet);
                More();
            }
            else
            {
                PushMode(AnnotatedAntlr4Lexer.Argument);
            }
        }
        ...
        protected void handleEndArgument()
        {
            ...
            {
                Type = AnnotatedAntlr4Lexer.ARGUMENT_CONTENT;
            }
        }
        ...
        protected void handleEndAction()
        {
            ...
            if (this.ModeStack.Count > 0)
            {
                Type = AnnotatedAntlr4Lexer.ACTION_CONTENT;
            }
        }

        public override IToken Emit()
        {
            if (Type == AnnotatedAntlr4Lexer.ID)
            {
                String firstChar = this.Text;
                if (char.IsUpper(firstChar[0]))
                {
                    Type = AnnotatedAntlr4Lexer.TOKEN_REF;
                }
                else
                {
                    Type = AnnotatedAntlr4Lexer.RULE_REF;
                }
            ...
            else if (Type == AnnotatedAntlr4Lexer.SEMI)
            { // exit rule def
        ...
        {
            return _currentRuleType == AnnotatedAntlr4Lexer.TOKEN_REF;
        }
        ...
        { 
            ...
            return _currentRuleType == AnnotatedAntlr4Lexer.RULE_REF;
        }
    }
}
