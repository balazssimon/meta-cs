...
namespace MetaDslx.Compiler.Binding.SymbolBinding
{
    public abstract class SymbolBinder : Binder<ISymbolBinder>, ISymbolBinder
    {
        ...
        public virtual ISymbol ContainingSymbol => Parent.ContainingSymbol;

        public virtual bool IsSubmissionClass => Parent.IsSubmissionClass;

        public virtual bool IgnoreAccessibility => Parent.IgnoreAccessibility;

        public virtual OverloadResolution OverloadResolution => Parent.OverloadResolution;

        public virtual Conversions Conversions => Parent.Conversions;


        public virtual bool GetImportsCore(LookupResult<Imports> result, ConsList<ISymbol> basesBeingResolved)
        {
            return false;
        }

        public virtual bool LookupMembersCore(LookupResult<ISymbol> result, ISymbol qualifierOpt, string name, SymbolBindingOptions options)
        {
            return false;
        }

        public virtual bool LookupSymbolsCore(LookupResult<ISymbol> result, string name, SymbolBindingOptions options)
        {
            return false;
        }

        public virtual bool LookupSymbolsCore(LookupResult<ISymbol> result, Qualifier qualifier, SymbolBindingOptions options)
        {
            return false;
        }

        public virtual bool IsAccessibleCore(LookupResult<bool> result, ISymbol symbol)
        {
            if (this.IgnoreAccessibility)
            {
                result.SetFrom(new SingleLookupResult<bool>(LookupResultKind.Viable, true, null));
                return true;
            }
            return false;
        }

        public virtual bool AddLookupSymbolsInfoCore(LookupResult<ISymbol> result, SymbolBindingOptions options)
        {
            return false;
        }

        public virtual bool AddMemberLookupSymbolsInfoCore(LookupResult<ISymbol> result, ISymbol container, SymbolBindingOptions options)
        {
            return false;
        }


        public Imports GetImports(ConsList<ISymbol> basesBeingResolved)
        {
            LookupResult<Imports> result = LookupResult<Imports>.GetInstance();
            try
            {
                this.ExecuteCurrentOrInherited(binder => binder.GetImportsCore(result, basesBeingResolved));
                return result.GetResults().Aggregate(Imports.Empty, (i1, i2) => i1.Concat(i2));
            }
            finally
            {
                result.Free();
        ...
        public void LookupMembers(LookupResult<ISymbol> result, ISymbol qualifierOpt, string name, SymbolBindingOptions options)
        {
            this.ExecuteCurrentOrInherited(binder => binder.LookupMembersCore(result, qualifierOpt, name, options));
        }

        public void LookupSymbols(LookupResult<ISymbol> result, string name, SymbolBindingOptions options)
        {
            this.ExecuteCurrentOrInherited(binder => binder.LookupSymbolsCore(result, name, options));
        }

        public void LookupSymbols(LookupResult<ISymbol> result, Qualifier qualifier, SymbolBindingOptions options)
        {
            this.ExecuteCurrentOrInherited(binder => binder.LookupSymbolsCore(result, qualifier, options));
        }

        public bool IsAccessible(ISymbol symbol)
        {
            LookupResult<bool> result = LookupResult<bool>.GetInstance();
            try
            {
                this.ExecuteCurrentOrInherited(binder => binder.IsAccessibleCore(result, symbol));
        ...
        public void AddLookupSymbolsInfo(LookupResult<ISymbol> result, SymbolBindingOptions options)
        {
            this.ExecuteCurrentOrInherited(binder => binder.AddLookupSymbolsInfoCore(result, options));
        }

        public void AddMemberLookupSymbolsInfo(LookupResult<ISymbol> result, ISymbol container, SymbolBindingOptions options)
        {
            this.ExecuteCurrentOrInherited(binder => binder.AddMemberLookupSymbolsInfoCore(result, container, options));
        }


        public virtual bool GetIdentifier(LookupResult<string> result)
        {
            return false;
        }

        public virtual bool GetName(LookupResult<Qualifier> result)
        {
            return false;
        }

        public virtual bool GetProperty(LookupResult<Property> result)
        {
            return false;
        }

        public virtual bool GetQualifier(LookupResult<Qualifier> result)
        {
            return false;
        }

        public virtual bool GetValue(LookupResult<object> result)
        {
            return false;
        }

        public virtual bool GetSymbol(LookupResult<ISymbol> result)
        {
            return false;
        }

        protected virtual SingleLookupResult<ISymbol> CheckViability(ISymbol symbol, SymbolBindingOptions options, ISymbol accessThroughType, bool diagnose)
        {
            ...
            if (!isViableKind)
            {
                return LookupResult<ISymbol>.Wrong(symbol, kindError);
            }
            else if (!isViableType)
            {
                return LookupResult<ISymbol>.Wrong(symbol, typeError);
            }
            else
            {
                return LookupResult<ISymbol>.Good(symbol);
            }
        }
