...
namespace MetaDslx.Compiler.Declarations
{
    ...
    public sealed partial class DeclarationTable
    {
        ...
        private readonly Lazy<MergedDeclaration> _mergedRoot;
        ...
        public IEnumerable<RootSingleDeclaration> AllRootNamespacesUnordered()
        {
            if (_latestLazyRootDeclaration == null)
            {
        ...
        private MergedDeclaration GetMergedRoot()
        {
            ...
            {
                return MergedDeclaration.Create(oldRoot, _latestLazyRootDeclaration.Value);
            }
        }
        ...
        public MergedDeclaration MergedRoot
        {
            get
            {
