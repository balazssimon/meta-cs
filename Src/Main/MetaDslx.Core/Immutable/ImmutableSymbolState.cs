...
namespace MetaDslx.Core.Immutable.V6
{
    ...
    public sealed class GreenDerivedValue
    {
    ...
    internal class GreenSymbol
    {
        ...
        public GreenSymbol RemoveProperty(GreenSymbolContext context, ModelProperty property)
        {
            if (this.properties.ContainsKey(property))
            {
                bool declared = ModelProperty.GetDeclaredPropertiesForType(id.MutableType).Contains(property);
        ...
        public bool TryGetStoredValue(ModelProperty property, out object value)
        {
        ...
        public bool HasStoredValue(ModelProperty property)
        {
            object value;
            return this.TryGetValueCore(property, false, false, out value);
        }

        public bool HasStoredLazyValue(ModelProperty property)
        {
            object value;
        ...
        public object GetStoredValue(ModelProperty property)
        {
            object value;
            if (this.TryGetValueCore(property, false, false, out value))
            {
        ...
        public GreenLazyValue GetStoredLazyValue(ModelProperty property)
        {
            object value;
            if (this.TryGetValueCore(property, false, true, out value))
            {
        ...
        public GreenSymbol GetValue(GreenSymbolContext context, ModelProperty property, bool lazyEval, out object value)
        {
            GreenSymbol result = this;
            ...
            value = result.GetStoredValue(property);
            if (value is GreenDerivedValue)
            {
                value = ((GreenDerivedValue)value).CreateRedValue();
            }
            return result;
        }

        public GreenSymbol SetValue(GreenSymbolContext context, ModelProperty property, bool reassign, object value)
        {
        ...
        public GreenSymbol AddItem(GreenSymbolContext context, ModelProperty property, bool reassign, bool replace, int index, object value)
        {
            Debug.Assert(property != null);
            Debug.Assert(property.IsCollection);
            if (!this.properties.ContainsKey(property)) return this;
        ...
        public GreenSymbol AddItems(GreenSymbolContext context, ModelProperty property, bool reassign, IEnumerable<object> values)
        {
            Debug.Assert(property != null);
            Debug.Assert(property.IsCollection);
            if (!this.properties.ContainsKey(property)) return this;
        ...
        public GreenSymbol RemoveItem(GreenSymbolContext context, ModelProperty property, bool reassign, int index, bool removeAll, object value)
        {
            Debug.Assert(property != null);
            Debug.Assert(property.IsCollection);
            if (!this.properties.ContainsKey(property)) return this;
        ...
        public GreenSymbol ClearItems(GreenSymbolContext context, ModelProperty property, bool reassign)
        {
            Debug.Assert(property.IsCollection);
            object listValue;
            GreenSymbol result = this;
        ...
        public GreenSymbol ClearLazyItems(GreenSymbolContext context, ModelProperty property, bool reassign)
        {
            Debug.Assert(property.IsCollection);
            object listValue;
            GreenSymbol result = this;
        ...
        public GreenSymbol ChildSetValue(GreenSymbolContext context, ModelProperty child, ModelProperty property, bool reassign, object value)
        {
            Debug.Assert(!property.IsCollection);
        ...
        public GreenSymbol ChildAddItem(GreenSymbolContext context, ModelProperty child, ModelProperty property, object value)
        {
            Debug.Assert(property.IsCollection);
            if (!child.IsContainment)
            {
        ...
        public GreenSymbol ChildAddItems(GreenSymbolContext context, ModelProperty child, ModelProperty property, IEnumerable<object> values)
        {
            Debug.Assert(property.IsCollection);
            if (!child.IsContainment)
            {
        ...
        public GreenSymbol ChildClear(GreenSymbolContext context, ModelProperty child)
        {
            if (!child.IsContainment)
            {
                throw new ModelException("The child property " + this.PropertyRef(child) + " must be a containment.");
        ...
        public GreenSymbol ChildClear(GreenSymbolContext context, ModelProperty child, ModelProperty property)
        {
            Debug.Assert(property.IsCollection);
            if (!child.IsContainment)
            {
