...
namespace MetaDslx.Languages.Meta.Syntax
{
    ...
    {
        protected MetaSyntaxNode(InternalSyntaxNode green, SyntaxTree syntaxTree, int position)
            : base(green, syntaxTree, position)
        {
        }

        protected MetaSyntaxNode(InternalSyntaxNode green, SyntaxNode parent, int position)
        ...
        {
            IMetaSyntaxVisitor<TResult> typedVisitor = visitor as IMetaSyntaxVisitor<TResult>;
        ...
        {
            IMetaSyntaxVisitor typedVisitor = visitor as IMetaSyntaxVisitor;
            if (typedVisitor != null)
            {
    ...
    public class MetaSyntaxTrivia : SyntaxTrivia
    {
        public MetaSyntaxTrivia(InternalSyntaxTrivia green, SyntaxToken token, int position, int index)
    ...
    public class MetaSyntaxToken : SyntaxToken
    {
        public MetaSyntaxToken(InternalSyntaxToken green, SyntaxNode parent, int position, int index)
        ...
        {
            return new MetaSyntaxToken(this.GreenToken.WithLeadingTrivia(new InternalSyntaxTriviaList(leading, null, null)), null, 0, 0);
        }

        protected override SyntaxToken WithTrailingTriviaCore(InternalSyntaxTrivia[] trailing)
        {
            return new MetaSyntaxToken(this.GreenToken.WithTrailingTrivia(new InternalSyntaxTriviaList(trailing, null, null)), null, 0, 0);
        }
    }
	...
	public sealed class NameSyntax : MetaSyntaxNode
	{
	    ...
	    public NameSyntax Update(IdentifierSyntax identifier)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Name(identifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class QualifiedNameSyntax : MetaSyntaxNode
	{
	    ...
	    public QualifiedNameSyntax Update(QualifierSyntax qualifier)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.QualifiedName(qualifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class QualifierSyntax : MetaSyntaxNode
	{
	    ...
	    public QualifierSyntax Update(SeparatedSyntaxNodeList<IdentifierSyntax> identifier)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Qualifier(identifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class AnnotationSyntax : MetaSyntaxNode
	{
		...
		{ 
			...
			{ 
				...
				return greenToken == null ? null : new MetaSyntaxToken(greenToken, this, this.GetChildPosition(2), this.GetChildIndex(2)); 
			}
		}
	    ...
	    public AnnotationSyntax Update(SyntaxToken tOpenBracket, NameSyntax name, SyntaxToken tCloseBracket)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Annotation(tOpenBracket, name, tCloseBracket);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceDeclarationSyntax : MetaSyntaxNode
	{
	    ...
	    public NamespaceDeclarationSyntax Update(SyntaxNodeList<AnnotationSyntax> annotation, SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBodySyntax namespaceBody)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.NamespaceDeclaration(annotation, kNamespace, qualifiedName, namespaceBody);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NamespaceBodySyntax : MetaSyntaxNode
	{
		...
		{ 
			...
			{ 
				...
				return greenToken == null ? null : new MetaSyntaxToken(greenToken, this, this.GetChildPosition(3), this.GetChildIndex(3)); 
			}
		}
	    ...
	    public NamespaceBodySyntax Update(SyntaxToken tOpenBrace, MetamodelDeclarationSyntax metamodelDeclaration, SyntaxNodeList<DeclarationSyntax> declaration, SyntaxToken tCloseBrace)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.NamespaceBody(tOpenBrace, metamodelDeclaration, declaration, tCloseBrace);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class MetamodelDeclarationSyntax : MetaSyntaxNode
	{
		...
		{ 
			...
			{ 
				...
				return greenToken == null ? null : new MetaSyntaxToken(greenToken, this, this.GetChildPosition(5), this.GetChildIndex(5)); 
			}
		}
		...
		{ 
			...
			{ 
				...
				return greenToken == null ? null : new MetaSyntaxToken(greenToken, this, this.GetChildPosition(6), this.GetChildIndex(6)); 
			}
		}
	    ...
	    public MetamodelDeclarationSyntax Update(SyntaxNodeList<AnnotationSyntax> annotation, SyntaxToken kMetamodel, NameSyntax name, SyntaxToken tOpenParen, MetamodelPropertyListSyntax metamodelPropertyList, SyntaxToken tCloseParen, SyntaxToken tSemicolon)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.MetamodelDeclaration(annotation, kMetamodel, name, tOpenParen, metamodelPropertyList, tCloseParen, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class MetamodelPropertyListSyntax : MetaSyntaxNode
	{
	    ...
	    public MetamodelPropertyListSyntax Update(SeparatedSyntaxNodeList<MetamodelPropertySyntax> metamodelProperty)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.MetamodelPropertyList(metamodelProperty);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class MetamodelPropertySyntax : MetaSyntaxNode
	{
	    ...
	    public MetamodelPropertySyntax Update(MetamodelUriPropertySyntax metamodelUriProperty)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.MetamodelProperty(metamodelUriProperty);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class MetamodelUriPropertySyntax : MetaSyntaxNode
	{
	    ...
	    public MetamodelUriPropertySyntax Update(SyntaxToken iUri, SyntaxToken tAssign, StringLiteralSyntax stringLiteral)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.MetamodelUriProperty(iUri, tAssign, stringLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class DeclarationSyntax : MetaSyntaxNode
	{
	    ...
	    public DeclarationSyntax Update(EnumDeclarationSyntax enumDeclaration)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Declaration(enumDeclaration);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public DeclarationSyntax Update(ClassDeclarationSyntax classDeclaration)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Declaration(classDeclaration);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (DeclarationSyntax)newNode;
	    ...
	    public DeclarationSyntax Update(AssociationDeclarationSyntax associationDeclaration)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Declaration(associationDeclaration);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (DeclarationSyntax)newNode;
	...
	public sealed class EnumDeclarationSyntax : MetaSyntaxNode
	{
	    ...
	    public EnumDeclarationSyntax Update(SyntaxNodeList<AnnotationSyntax> annotation, SyntaxToken kEnum, NameSyntax name, EnumBodySyntax enumBody)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.EnumDeclaration(annotation, kEnum, name, enumBody);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class EnumBodySyntax : MetaSyntaxNode
	{
	    ...
	    public EnumBodySyntax Update(SyntaxToken tOpenBrace, EnumValuesSyntax enumValues, SyntaxToken tSemicolon, SyntaxNodeList<EnumMemberDeclarationSyntax> enumMemberDeclaration, SyntaxToken tCloseBrace)
	    {
	        if (this.TOpenBrace != tOpenBrace ||
				...
				this.TCloseBrace != tCloseBrace)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.EnumBody(tOpenBrace, enumValues, tSemicolon, enumMemberDeclaration, tCloseBrace);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class EnumValuesSyntax : MetaSyntaxNode
	{
	    ...
	    public EnumValuesSyntax Update(SeparatedSyntaxNodeList<EnumValueSyntax> enumValue)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.EnumValues(enumValue);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class EnumValueSyntax : MetaSyntaxNode
	{
	    ...
	    public EnumValueSyntax Update(SyntaxNodeList<AnnotationSyntax> annotation, NameSyntax name)
	    {
	        if (this.Annotation.Node != annotation.Node ||
				this.Name != name)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.EnumValue(annotation, name);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class EnumMemberDeclarationSyntax : MetaSyntaxNode
	{
	    ...
	    public EnumMemberDeclarationSyntax Update(OperationDeclarationSyntax operationDeclaration)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.EnumMemberDeclaration(operationDeclaration);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class ClassDeclarationSyntax : MetaSyntaxNode
	{
	    ...
	    public ClassDeclarationSyntax Update(SyntaxNodeList<AnnotationSyntax> annotation, SyntaxToken kAbstract, SyntaxToken kClass, NameSyntax name, SyntaxToken tColon, ClassAncestorsSyntax classAncestors, ClassBodySyntax classBody)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.ClassDeclaration(annotation, kAbstract, kClass, name, tColon, classAncestors, classBody);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class ClassBodySyntax : MetaSyntaxNode
	{
	    ...
	    public ClassBodySyntax Update(SyntaxToken tOpenBrace, SyntaxNodeList<ClassMemberDeclarationSyntax> classMemberDeclaration, SyntaxToken tCloseBrace)
	    {
	        if (this.TOpenBrace != tOpenBrace ||
				...
				this.TCloseBrace != tCloseBrace)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.ClassBody(tOpenBrace, classMemberDeclaration, tCloseBrace);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class ClassAncestorsSyntax : MetaSyntaxNode
	{
	    ...
	    public ClassAncestorsSyntax Update(SeparatedSyntaxNodeList<ClassAncestorSyntax> classAncestor)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.ClassAncestors(classAncestor);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class ClassAncestorSyntax : MetaSyntaxNode
	{
	    ...
	    public ClassAncestorSyntax Update(QualifierSyntax qualifier)
	    {
	        if (this.Qualifier != qualifier)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.ClassAncestor(qualifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class ClassMemberDeclarationSyntax : MetaSyntaxNode
	{
	    ...
	    public ClassMemberDeclarationSyntax Update(FieldDeclarationSyntax fieldDeclaration)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.ClassMemberDeclaration(fieldDeclaration);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public ClassMemberDeclarationSyntax Update(OperationDeclarationSyntax operationDeclaration)
	    {
	        if (this.OperationDeclaration != operationDeclaration)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.ClassMemberDeclaration(operationDeclaration);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (ClassMemberDeclarationSyntax)newNode;
	...
	public sealed class FieldDeclarationSyntax : MetaSyntaxNode
	{
	    ...
	    public FieldDeclarationSyntax Update(SyntaxNodeList<AnnotationSyntax> annotation, FieldModifierSyntax fieldModifier, TypeReferenceSyntax typeReference, NameSyntax name, RedefinitionsOrSubsettingsSyntax redefinitionsOrSubsettings, SyntaxToken tSemicolon)
	    {
	        if (this.Annotation.Node != annotation.Node ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.FieldDeclaration(annotation, fieldModifier, typeReference, name, redefinitionsOrSubsettings, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class FieldModifierSyntax : MetaSyntaxNode
	{
	    ...
	    public FieldModifierSyntax Update(SyntaxToken fieldModifier)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.FieldModifier(fieldModifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class RedefinitionsOrSubsettingsSyntax : MetaSyntaxNode
	{
	    ...
	    public RedefinitionsOrSubsettingsSyntax Update(RedefinitionsSyntax redefinitions)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.RedefinitionsOrSubsettings(redefinitions);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public RedefinitionsOrSubsettingsSyntax Update(SubsettingsSyntax subsettings)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.RedefinitionsOrSubsettings(subsettings);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (RedefinitionsOrSubsettingsSyntax)newNode;
	...
	public sealed class RedefinitionsSyntax : MetaSyntaxNode
	{
	    ...
	    public RedefinitionsSyntax Update(SyntaxToken kRedefines, NameUseListSyntax nameUseList)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Redefinitions(kRedefines, nameUseList);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class SubsettingsSyntax : MetaSyntaxNode
	{
	    ...
	    public SubsettingsSyntax Update(SyntaxToken kSubsets, NameUseListSyntax nameUseList)
	    {
	        if (this.KSubsets != kSubsets ||
				this.NameUseList != nameUseList)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Subsettings(kSubsets, nameUseList);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NameUseListSyntax : MetaSyntaxNode
	{
	    ...
	    public NameUseListSyntax Update(SeparatedSyntaxNodeList<QualifierSyntax> qualifier)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.NameUseList(qualifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class ConstDeclarationSyntax : MetaSyntaxNode
	{
	    ...
	    public ConstDeclarationSyntax Update(SyntaxToken kConst, TypeReferenceSyntax typeReference, NameSyntax name, SyntaxToken tSemicolon)
	    {
	        if (this.KConst != kConst ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.ConstDeclaration(kConst, typeReference, name, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class ReturnTypeSyntax : MetaSyntaxNode
	{
	    ...
	    public ReturnTypeSyntax Update(TypeReferenceSyntax typeReference)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.ReturnType(typeReference);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public ReturnTypeSyntax Update(VoidTypeSyntax voidType)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.ReturnType(voidType);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (ReturnTypeSyntax)newNode;
	...
	public sealed class TypeOfReferenceSyntax : MetaSyntaxNode
	{
	    ...
	    public TypeOfReferenceSyntax Update(TypeReferenceSyntax typeReference)
	    {
	        if (this.TypeReference != typeReference)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.TypeOfReference(typeReference);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class TypeReferenceSyntax : MetaSyntaxNode
	{
	    ...
	    public TypeReferenceSyntax Update(CollectionTypeSyntax collectionType)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.TypeReference(collectionType);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public TypeReferenceSyntax Update(SimpleTypeSyntax simpleType)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.TypeReference(simpleType);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (TypeReferenceSyntax)newNode;
	...
	public sealed class SimpleTypeSyntax : MetaSyntaxNode
	{
	    ...
	    public SimpleTypeSyntax Update(PrimitiveTypeSyntax primitiveType)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.SimpleType(primitiveType);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public SimpleTypeSyntax Update(ObjectTypeSyntax objectType)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.SimpleType(objectType);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (SimpleTypeSyntax)newNode;
	    ...
	    public SimpleTypeSyntax Update(NullableTypeSyntax nullableType)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.SimpleType(nullableType);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (SimpleTypeSyntax)newNode;
	...
	public sealed class ClassTypeSyntax : MetaSyntaxNode
	{
	    ...
	    public ClassTypeSyntax Update(QualifierSyntax qualifier)
	    {
	        if (this.Qualifier != qualifier)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.ClassType(qualifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class ObjectTypeSyntax : MetaSyntaxNode
	{
	    ...
	    public ObjectTypeSyntax Update(SyntaxToken objectType)
	    {
	        if (this.ObjectType != objectType)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.ObjectType(objectType);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class PrimitiveTypeSyntax : MetaSyntaxNode
	{
	    ...
	    public PrimitiveTypeSyntax Update(SyntaxToken primitiveType)
	    {
	        if (this.PrimitiveType != primitiveType)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.PrimitiveType(primitiveType);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class VoidTypeSyntax : MetaSyntaxNode
	{
	    ...
	    public VoidTypeSyntax Update(SyntaxToken kVoid)
	    {
	        if (this.KVoid != kVoid)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.VoidType(kVoid);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class NullableTypeSyntax : MetaSyntaxNode
	{
	    ...
	    public NullableTypeSyntax Update(PrimitiveTypeSyntax primitiveType, SyntaxToken tQuestion)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.NullableType(primitiveType, tQuestion);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class CollectionTypeSyntax : MetaSyntaxNode
	{
	    ...
	    public CollectionTypeSyntax Update(CollectionKindSyntax collectionKind, SyntaxToken tLessThan, SimpleTypeSyntax simpleType, SyntaxToken tGreaterThan)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.CollectionType(collectionKind, tLessThan, simpleType, tGreaterThan);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class CollectionKindSyntax : MetaSyntaxNode
	{
	    ...
	    public CollectionKindSyntax Update(SyntaxToken collectionKind)
	    {
	        if (this.CollectionKind != collectionKind)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.CollectionKind(collectionKind);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class OperationDeclarationSyntax : MetaSyntaxNode
	{
		...
		{ 
			...
			{ 
				var green = (global::MetaDslx.Languages.Meta.Syntax.InternalSyntax.OperationDeclarationGreen)this.Green;
				var greenToken = green.TSemicolon;
				return greenToken == null ? null : new MetaSyntaxToken(greenToken, this, this.GetChildPosition(7), this.GetChildIndex(7)); 
			}
		}
	    ...
	    public OperationDeclarationSyntax Update(SyntaxNodeList<AnnotationSyntax> annotation, SyntaxToken kStatic, ReturnTypeSyntax returnType, NameSyntax name, SyntaxToken tOpenParen, ParameterListSyntax parameterList, SyntaxToken tCloseParen, SyntaxToken tSemicolon)
	    {
	        if (this.Annotation.Node != annotation.Node ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.OperationDeclaration(annotation, kStatic, returnType, name, tOpenParen, parameterList, tCloseParen, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class ParameterListSyntax : MetaSyntaxNode
	{
	    ...
	    public ParameterListSyntax Update(SeparatedSyntaxNodeList<ParameterSyntax> parameter)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.ParameterList(parameter);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class ParameterSyntax : MetaSyntaxNode
	{
	    ...
	    public ParameterSyntax Update(SyntaxNodeList<AnnotationSyntax> annotation, TypeReferenceSyntax typeReference, NameSyntax name)
	    {
	        if (this.Annotation.Node != annotation.Node ||
				...
				this.Name != name)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Parameter(annotation, typeReference, name);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class AssociationDeclarationSyntax : MetaSyntaxNode
	{
	    ...
	    public AssociationDeclarationSyntax Update(SyntaxNodeList<AnnotationSyntax> annotation, SyntaxToken kAssociation, QualifierSyntax source, SyntaxToken kWith, QualifierSyntax target, SyntaxToken tSemicolon)
	    {
	        if (this.Annotation.Node != annotation.Node ||
				...
				this.TSemicolon != tSemicolon)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.AssociationDeclaration(annotation, kAssociation, source, kWith, target, tSemicolon);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class IdentifierSyntax : MetaSyntaxNode
	{
	    ...
	    public IdentifierSyntax Update(SyntaxToken identifier)
	    {
	        if (this.Identifier != identifier)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Identifier(identifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class LiteralSyntax : MetaSyntaxNode
	{
	    ...
	    public LiteralSyntax Update(NullLiteralSyntax nullLiteral)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Literal(nullLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	    ...
	    public LiteralSyntax Update(BooleanLiteralSyntax booleanLiteral)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Literal(booleanLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (LiteralSyntax)newNode;
	    ...
	    public LiteralSyntax Update(IntegerLiteralSyntax integerLiteral)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Literal(integerLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (LiteralSyntax)newNode;
	    ...
	    public LiteralSyntax Update(DecimalLiteralSyntax decimalLiteral)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Literal(decimalLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (LiteralSyntax)newNode;
	    ...
	    public LiteralSyntax Update(ScientificLiteralSyntax scientificLiteral)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Literal(scientificLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (LiteralSyntax)newNode;
	    ...
	    public LiteralSyntax Update(StringLiteralSyntax stringLiteral)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.Literal(stringLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (LiteralSyntax)newNode;
	...
	public sealed class NullLiteralSyntax : MetaSyntaxNode
	{
	    ...
	    public NullLiteralSyntax Update(SyntaxToken kNull)
	    {
	        if (this.KNull != kNull)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.NullLiteral(kNull);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class BooleanLiteralSyntax : MetaSyntaxNode
	{
	    ...
	    public BooleanLiteralSyntax Update(SyntaxToken booleanLiteral)
	    {
	        if (this.BooleanLiteral != booleanLiteral)
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.BooleanLiteral(booleanLiteral);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class IntegerLiteralSyntax : MetaSyntaxNode
	{
	    ...
	    public IntegerLiteralSyntax Update(SyntaxToken lInteger)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.IntegerLiteral(lInteger);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class DecimalLiteralSyntax : MetaSyntaxNode
	{
	    ...
	    public DecimalLiteralSyntax Update(SyntaxToken lDecimal)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.DecimalLiteral(lDecimal);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class ScientificLiteralSyntax : MetaSyntaxNode
	{
	    ...
	    public ScientificLiteralSyntax Update(SyntaxToken lScientific)
	    {
	        ...
	        {
	            SyntaxNode newNode = MetaLanguage.Instance.SyntaxFactory.ScientificLiteral(lScientific);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
...
namespace MetaDslx.Languages.Meta
{
	...
	public class MetaDetailedSyntaxVisitor : DetailedSyntaxVisitor, IMetaSyntaxVisitor
	{
	    public MetaDetailedSyntaxVisitor(bool visitIntoStructuredToken = false, bool visitIntoStructuredTrivia = false)
	...
	{
	    public MetaSyntaxRewriter(bool visitIntoStructuredToken = false, bool visitIntoStructuredTrivia = false)
			: base(visitIntoStructuredToken, visitIntoStructuredTrivia)
	    {
	    }
	...
	{
	    internal static readonly MetaSyntaxFactory Instance = new MetaSyntaxFactory();
	
		public MetaSyntaxFactory() 
		{
			this.CarriageReturnLineFeed = (MetaSyntaxTrivia)MetaGreenFactory.Instance.CarriageReturnLineFeed.CreateRed();
			this.LineFeed = (MetaSyntaxTrivia)MetaGreenFactory.Instance.LineFeed.CreateRed();
			this.CarriageReturn = (MetaSyntaxTrivia)MetaGreenFactory.Instance.CarriageReturn.CreateRed();
			this.Space = (MetaSyntaxTrivia)MetaGreenFactory.Instance.Space.CreateRed();
			this.Tab = (MetaSyntaxTrivia)MetaGreenFactory.Instance.Tab.CreateRed();
			this.ElasticCarriageReturnLineFeed = (MetaSyntaxTrivia)MetaGreenFactory.Instance.ElasticCarriageReturnLineFeed.CreateRed();
			this.ElasticLineFeed = (MetaSyntaxTrivia)MetaGreenFactory.Instance.ElasticLineFeed.CreateRed();
			this.ElasticCarriageReturn = (MetaSyntaxTrivia)MetaGreenFactory.Instance.ElasticCarriageReturn.CreateRed();
			this.ElasticSpace = (MetaSyntaxTrivia)MetaGreenFactory.Instance.ElasticSpace.CreateRed();
			this.ElasticTab = (MetaSyntaxTrivia)MetaGreenFactory.Instance.ElasticTab.CreateRed();
			this.ElasticZeroSpace = (MetaSyntaxTrivia)MetaGreenFactory.Instance.ElasticZeroSpace.CreateRed();
		}
	    ...
	    public MetaSyntaxTrivia CarriageReturnLineFeed { get; }
	    public MetaSyntaxTrivia LineFeed { get; }
	    public MetaSyntaxTrivia CarriageReturn { get; }
	    public MetaSyntaxTrivia Space { get; }
	    public MetaSyntaxTrivia Tab { get; }
	    public MetaSyntaxTrivia ElasticCarriageReturnLineFeed { get; }
	    public MetaSyntaxTrivia ElasticLineFeed { get; }
	    public MetaSyntaxTrivia ElasticCarriageReturn { get; }
	    public MetaSyntaxTrivia ElasticSpace { get; }
	    public MetaSyntaxTrivia ElasticTab { get; }
	    public MetaSyntaxTrivia ElasticZeroSpace { get; }
	    ...
	    protected override SyntaxToken DefaultToken
	    {
	        get 
			{
			    ...
			    Interlocked.CompareExchange(ref defaultToken, this.Token(MetaSyntaxKind.None), null);
				return defaultToken;
			}
	    }
	    ...
	    protected override SyntaxTrivia DefaultTrivia
	    {
	        get 
			{
			    ...
			    Interlocked.CompareExchange(ref defaultTrivia, this.Trivia(MetaSyntaxKind.None, string.Empty), null);
	    ...
	    protected override SyntaxToken DefaultSeparator
	    {
	        get 
			{
			    ...
			    Interlocked.CompareExchange(ref defaultSeparator, this.Token(MetaSyntaxKind.TComma), null);
		...
		/// <returns></returns>
		public SyntaxToken Token(MetaSyntaxKind kind)
		{
			return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.Token(kind).CreateRed();
		}
	
		public SyntaxTrivia Trivia(MetaSyntaxKind kind, string text)
		{
			return (SyntaxTrivia)MetaLanguage.Instance.InternalSyntaxFactory.Trivia(kind, text).CreateRed();
		}
	    ...
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.TAsterisk(text).CreateRed();
	    }
	
	    public SyntaxToken TAsterisk(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.TAsterisk(text, value).CreateRed();
	    }
	
	    public SyntaxToken IdentifierNormal(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.IdentifierNormal(text).CreateRed();
	    }
	
	    public SyntaxToken IdentifierNormal(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.IdentifierNormal(text, value).CreateRed();
	    }
	
	    public SyntaxToken IdentifierVerbatim(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.IdentifierVerbatim(text).CreateRed();
	    }
	
	    public SyntaxToken IdentifierVerbatim(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.IdentifierVerbatim(text, value).CreateRed();
	    }
	
	    public SyntaxToken LInteger(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LInteger(text).CreateRed();
	    }
	
	    public SyntaxToken LInteger(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LInteger(text, value).CreateRed();
	    }
	
	    public SyntaxToken LDecimal(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LDecimal(text).CreateRed();
	    }
	
	    public SyntaxToken LDecimal(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LDecimal(text, value).CreateRed();
	    }
	
	    public SyntaxToken LScientific(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LScientific(text).CreateRed();
	    }
	
	    public SyntaxToken LScientific(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LScientific(text, value).CreateRed();
	    }
	
	    public SyntaxToken LDateTimeOffset(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LDateTimeOffset(text).CreateRed();
	    }
	
	    public SyntaxToken LDateTimeOffset(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LDateTimeOffset(text, value).CreateRed();
	    }
	
	    public SyntaxToken LDateTime(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LDateTime(text).CreateRed();
	    }
	
	    public SyntaxToken LDateTime(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LDateTime(text, value).CreateRed();
	    }
	
	    public SyntaxToken LDate(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LDate(text).CreateRed();
	    }
	
	    public SyntaxToken LDate(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LDate(text, value).CreateRed();
	    }
	
	    public SyntaxToken LTime(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LTime(text).CreateRed();
	    }
	
	    public SyntaxToken LTime(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LTime(text, value).CreateRed();
	    }
	
	    public SyntaxToken LRegularString(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LRegularString(text).CreateRed();
	    }
	
	    public SyntaxToken LRegularString(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LRegularString(text, value).CreateRed();
	    }
	
	    public SyntaxToken LGuid(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LGuid(text).CreateRed();
	    }
	
	    public SyntaxToken LGuid(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LGuid(text, value).CreateRed();
	    }
	
	    public SyntaxToken LUtf8Bom(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LUtf8Bom(text).CreateRed();
	    }
	
	    public SyntaxToken LUtf8Bom(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LUtf8Bom(text, value).CreateRed();
	    }
	
	    public SyntaxToken LWhiteSpace(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LWhiteSpace(text).CreateRed();
	    }
	
	    public SyntaxToken LWhiteSpace(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LWhiteSpace(text, value).CreateRed();
	    }
	
	    public SyntaxToken LCrLf(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LCrLf(text).CreateRed();
	    }
	
	    public SyntaxToken LCrLf(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LCrLf(text, value).CreateRed();
	    }
	
	    public SyntaxToken LLineEnd(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LLineEnd(text).CreateRed();
	    }
	
	    public SyntaxToken LLineEnd(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LLineEnd(text, value).CreateRed();
	    }
	
	    public SyntaxToken LSingleLineComment(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LSingleLineComment(text).CreateRed();
	    }
	
	    public SyntaxToken LSingleLineComment(string text, object value)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LSingleLineComment(text, value).CreateRed();
	    }
	
	    public SyntaxToken LComment(string text)
	    {
	        return (SyntaxToken)MetaLanguage.Instance.InternalSyntaxFactory.LComment(text).CreateRed();
	    }
		...
		{
		    if (identifier == null) throw new ArgumentNullException(nameof(identifier));
		    return (QualifierSyntax)MetaLanguage.Instance.InternalSyntaxFactory.Qualifier(identifier.Green).CreateRed();
		}
		...
		public AnnotationSyntax Annotation(SyntaxToken tOpenBracket, NameSyntax name, SyntaxToken tCloseBracket)
		{
		    ...
		    return (AnnotationSyntax)MetaLanguage.Instance.InternalSyntaxFactory.Annotation((InternalSyntaxToken)tOpenBracket.Green, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tCloseBracket.Green).CreateRed();
		}
		...
		public NamespaceDeclarationSyntax NamespaceDeclaration(SyntaxNodeList<AnnotationSyntax> annotation, SyntaxToken kNamespace, QualifiedNameSyntax qualifiedName, NamespaceBodySyntax namespaceBody)
		{
		    ...
		    return (NamespaceDeclarationSyntax)MetaLanguage.Instance.InternalSyntaxFactory.NamespaceDeclaration(annotation == null ? null : annotation.Green, (InternalSyntaxToken)kNamespace.Green, (Syntax.InternalSyntax.QualifiedNameGreen)qualifiedName.Green, (Syntax.InternalSyntax.NamespaceBodyGreen)namespaceBody.Green).CreateRed();
		}
		...
		{
			return this.NamespaceDeclaration(null, this.Token(MetaSyntaxKind.KNamespace), qualifiedName, namespaceBody);
		}
		...
		public NamespaceBodySyntax NamespaceBody(SyntaxToken tOpenBrace, MetamodelDeclarationSyntax metamodelDeclaration, SyntaxNodeList<DeclarationSyntax> declaration, SyntaxToken tCloseBrace)
		{
		    ...
		    return (NamespaceBodySyntax)MetaLanguage.Instance.InternalSyntaxFactory.NamespaceBody((InternalSyntaxToken)tOpenBrace.Green, (Syntax.InternalSyntax.MetamodelDeclarationGreen)metamodelDeclaration.Green, declaration == null ? null : declaration.Green, (InternalSyntaxToken)tCloseBrace.Green).CreateRed();
		}
		
		public NamespaceBodySyntax NamespaceBody(MetamodelDeclarationSyntax metamodelDeclaration)
		{
			return this.NamespaceBody(this.Token(MetaSyntaxKind.TOpenBrace), metamodelDeclaration, null, this.Token(MetaSyntaxKind.TCloseBrace));
		}
		...
		public MetamodelDeclarationSyntax MetamodelDeclaration(SyntaxNodeList<AnnotationSyntax> annotation, SyntaxToken kMetamodel, NameSyntax name, SyntaxToken tOpenParen, MetamodelPropertyListSyntax metamodelPropertyList, SyntaxToken tCloseParen, SyntaxToken tSemicolon)
		{
		    ...
		    return (MetamodelDeclarationSyntax)MetaLanguage.Instance.InternalSyntaxFactory.MetamodelDeclaration(annotation == null ? null : annotation.Green, (InternalSyntaxToken)kMetamodel.Green, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tOpenParen.Green, metamodelPropertyList == null ? null : (Syntax.InternalSyntax.MetamodelPropertyListGreen)metamodelPropertyList.Green, (InternalSyntaxToken)tCloseParen.Green, (InternalSyntaxToken)tSemicolon.Green).CreateRed();
		}
		
		public MetamodelDeclarationSyntax MetamodelDeclaration(NameSyntax name)
		{
			return this.MetamodelDeclaration(null, this.Token(MetaSyntaxKind.KMetamodel), name, this.Token(MetaSyntaxKind.TOpenParen), null, this.Token(MetaSyntaxKind.TCloseParen), this.Token(MetaSyntaxKind.TSemicolon));
		}
		...
		public MetamodelPropertyListSyntax MetamodelPropertyList(SeparatedSyntaxNodeList<MetamodelPropertySyntax> metamodelProperty)
		{
		    ...
		    return (MetamodelPropertyListSyntax)MetaLanguage.Instance.InternalSyntaxFactory.MetamodelPropertyList(metamodelProperty.Green).CreateRed();
		}
		...
		public MetamodelUriPropertySyntax MetamodelUriProperty(SyntaxToken iUri, SyntaxToken tAssign, StringLiteralSyntax stringLiteral)
		{
		    ...
		    return (MetamodelUriPropertySyntax)MetaLanguage.Instance.InternalSyntaxFactory.MetamodelUriProperty((InternalSyntaxToken)iUri.Green, (InternalSyntaxToken)tAssign.Green, (Syntax.InternalSyntax.StringLiteralGreen)stringLiteral.Green).CreateRed();
		}
		...
		public EnumDeclarationSyntax EnumDeclaration(SyntaxNodeList<AnnotationSyntax> annotation, SyntaxToken kEnum, NameSyntax name, EnumBodySyntax enumBody)
		{
		    ...
		    return (EnumDeclarationSyntax)MetaLanguage.Instance.InternalSyntaxFactory.EnumDeclaration(annotation == null ? null : annotation.Green, (InternalSyntaxToken)kEnum.Green, (Syntax.InternalSyntax.NameGreen)name.Green, (Syntax.InternalSyntax.EnumBodyGreen)enumBody.Green).CreateRed();
		}
		
		public EnumDeclarationSyntax EnumDeclaration(NameSyntax name, EnumBodySyntax enumBody)
		{
			return this.EnumDeclaration(null, this.Token(MetaSyntaxKind.KEnum), name, enumBody);
		}
		...
		{
			return this.EnumBody(this.Token(MetaSyntaxKind.TOpenBrace), enumValues, this.Token(MetaSyntaxKind.TSemicolon), null, this.Token(MetaSyntaxKind.TCloseBrace));
		}
		...
		public EnumValuesSyntax EnumValues(SeparatedSyntaxNodeList<EnumValueSyntax> enumValue)
		{
		    ...
		    return (EnumValuesSyntax)MetaLanguage.Instance.InternalSyntaxFactory.EnumValues(enumValue.Green).CreateRed();
		}
		
		public EnumValueSyntax EnumValue(SyntaxNodeList<AnnotationSyntax> annotation, NameSyntax name)
		{
		    if (name == null) throw new ArgumentNullException(nameof(name));
		    return (EnumValueSyntax)MetaLanguage.Instance.InternalSyntaxFactory.EnumValue(annotation == null ? null : annotation.Green, (Syntax.InternalSyntax.NameGreen)name.Green).CreateRed();
		}
		...
		{
			return this.ClassDeclaration(null, null, this.Token(MetaSyntaxKind.KClass), name, this.Token(MetaSyntaxKind.TColon), classAncestors, classBody);
		}
		...
		public ClassBodySyntax ClassBody(SyntaxToken tOpenBrace, SyntaxNodeList<ClassMemberDeclarationSyntax> classMemberDeclaration, SyntaxToken tCloseBrace)
		{
		    ...
		    if (tCloseBrace == null) throw new ArgumentNullException(nameof(tCloseBrace));
		    if (tCloseBrace.RawKind != (int)MetaSyntaxKind.TCloseBrace) throw new ArgumentException(nameof(tCloseBrace));
		    return (ClassBodySyntax)MetaLanguage.Instance.InternalSyntaxFactory.ClassBody((InternalSyntaxToken)tOpenBrace.Green, classMemberDeclaration == null ? null : classMemberDeclaration.Green, (InternalSyntaxToken)tCloseBrace.Green).CreateRed();
		}
		
		public ClassBodySyntax ClassBody()
		{
			return this.ClassBody(this.Token(MetaSyntaxKind.TOpenBrace), null, this.Token(MetaSyntaxKind.TCloseBrace));
		}
		...
		public ClassAncestorsSyntax ClassAncestors(SeparatedSyntaxNodeList<ClassAncestorSyntax> classAncestor)
		{
		    ...
		    return (ClassAncestorsSyntax)MetaLanguage.Instance.InternalSyntaxFactory.ClassAncestors(classAncestor.Green).CreateRed();
		}
		...
		{
			return this.FieldDeclaration(null, null, typeReference, name, null, this.Token(MetaSyntaxKind.TSemicolon));
		}
		...
		public FieldModifierSyntax FieldModifier(SyntaxToken fieldModifier)
		{
		    ...
		    return (FieldModifierSyntax)MetaLanguage.Instance.InternalSyntaxFactory.FieldModifier((InternalSyntaxToken)fieldModifier.Green).CreateRed();
		}
		...
		public RedefinitionsSyntax Redefinitions(SyntaxToken kRedefines, NameUseListSyntax nameUseList)
		{
		    ...
		    return (RedefinitionsSyntax)MetaLanguage.Instance.InternalSyntaxFactory.Redefinitions((InternalSyntaxToken)kRedefines.Green, nameUseList == null ? null : (Syntax.InternalSyntax.NameUseListGreen)nameUseList.Green).CreateRed();
		}
		
		public RedefinitionsSyntax Redefinitions()
		{
			return this.Redefinitions(this.Token(MetaSyntaxKind.KRedefines), null);
		}
		...
		public SubsettingsSyntax Subsettings(SyntaxToken kSubsets, NameUseListSyntax nameUseList)
		{
		    ...
		    return (SubsettingsSyntax)MetaLanguage.Instance.InternalSyntaxFactory.Subsettings((InternalSyntaxToken)kSubsets.Green, nameUseList == null ? null : (Syntax.InternalSyntax.NameUseListGreen)nameUseList.Green).CreateRed();
		}
		
		public SubsettingsSyntax Subsettings()
		{
			return this.Subsettings(this.Token(MetaSyntaxKind.KSubsets), null);
		}
		
		public NameUseListSyntax NameUseList(SeparatedSyntaxNodeList<QualifierSyntax> qualifier)
		{
		    if (qualifier == null) throw new ArgumentNullException(nameof(qualifier));
		    return (NameUseListSyntax)MetaLanguage.Instance.InternalSyntaxFactory.NameUseList(qualifier.Green).CreateRed();
		}
		...
		public ConstDeclarationSyntax ConstDeclaration(SyntaxToken kConst, TypeReferenceSyntax typeReference, NameSyntax name, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.RawKind != (int)MetaSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (ConstDeclarationSyntax)MetaLanguage.Instance.InternalSyntaxFactory.ConstDeclaration((InternalSyntaxToken)kConst.Green, (Syntax.InternalSyntax.TypeReferenceGreen)typeReference.Green, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tSemicolon.Green).CreateRed();
		}
		...
		{
		    if (objectType == null) throw new ArgumentNullException(nameof(objectType));
		    return (ObjectTypeSyntax)MetaLanguage.Instance.InternalSyntaxFactory.ObjectType((InternalSyntaxToken)objectType.Green).CreateRed();
		}
		
		public PrimitiveTypeSyntax PrimitiveType(SyntaxToken primitiveType)
		{
		    if (primitiveType == null) throw new ArgumentNullException(nameof(primitiveType));
		    return (PrimitiveTypeSyntax)MetaLanguage.Instance.InternalSyntaxFactory.PrimitiveType((InternalSyntaxToken)primitiveType.Green).CreateRed();
		}
		...
		public VoidTypeSyntax VoidType(SyntaxToken kVoid)
		{
		    ...
		    return (VoidTypeSyntax)MetaLanguage.Instance.InternalSyntaxFactory.VoidType((InternalSyntaxToken)kVoid.Green).CreateRed();
		}
		...
		public NullableTypeSyntax NullableType(PrimitiveTypeSyntax primitiveType, SyntaxToken tQuestion)
		{
		    ...
		    return (NullableTypeSyntax)MetaLanguage.Instance.InternalSyntaxFactory.NullableType((Syntax.InternalSyntax.PrimitiveTypeGreen)primitiveType.Green, (InternalSyntaxToken)tQuestion.Green).CreateRed();
		}
		...
		public CollectionTypeSyntax CollectionType(CollectionKindSyntax collectionKind, SyntaxToken tLessThan, SimpleTypeSyntax simpleType, SyntaxToken tGreaterThan)
		{
		    ...
		    return (CollectionTypeSyntax)MetaLanguage.Instance.InternalSyntaxFactory.CollectionType((Syntax.InternalSyntax.CollectionKindGreen)collectionKind.Green, (InternalSyntaxToken)tLessThan.Green, (Syntax.InternalSyntax.SimpleTypeGreen)simpleType.Green, (InternalSyntaxToken)tGreaterThan.Green).CreateRed();
		}
		...
		{
		    if (collectionKind == null) throw new ArgumentNullException(nameof(collectionKind));
		    return (CollectionKindSyntax)MetaLanguage.Instance.InternalSyntaxFactory.CollectionKind((InternalSyntaxToken)collectionKind.Green).CreateRed();
		}
		...
		public OperationDeclarationSyntax OperationDeclaration(SyntaxNodeList<AnnotationSyntax> annotation, SyntaxToken kStatic, ReturnTypeSyntax returnType, NameSyntax name, SyntaxToken tOpenParen, ParameterListSyntax parameterList, SyntaxToken tCloseParen, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.RawKind != (int)MetaSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (OperationDeclarationSyntax)MetaLanguage.Instance.InternalSyntaxFactory.OperationDeclaration(annotation == null ? null : annotation.Green, kStatic == null ? null : (InternalSyntaxToken)kStatic.Green, (Syntax.InternalSyntax.ReturnTypeGreen)returnType.Green, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tOpenParen.Green, parameterList == null ? null : (Syntax.InternalSyntax.ParameterListGreen)parameterList.Green, (InternalSyntaxToken)tCloseParen.Green, (InternalSyntaxToken)tSemicolon.Green).CreateRed();
		}
		
		public OperationDeclarationSyntax OperationDeclaration(ReturnTypeSyntax returnType, NameSyntax name)
		{
			return this.OperationDeclaration(null, null, returnType, name, this.Token(MetaSyntaxKind.TOpenParen), null, this.Token(MetaSyntaxKind.TCloseParen), this.Token(MetaSyntaxKind.TSemicolon));
		}
		
		public ParameterListSyntax ParameterList(SeparatedSyntaxNodeList<ParameterSyntax> parameter)
		{
		    if (parameter == null) throw new ArgumentNullException(nameof(parameter));
		    return (ParameterListSyntax)MetaLanguage.Instance.InternalSyntaxFactory.ParameterList(parameter.Green).CreateRed();
		}
		...
		public ParameterSyntax Parameter(SyntaxNodeList<AnnotationSyntax> annotation, TypeReferenceSyntax typeReference, NameSyntax name)
		{
		    if (typeReference == null) throw new ArgumentNullException(nameof(typeReference));
		    if (name == null) throw new ArgumentNullException(nameof(name));
		    return (ParameterSyntax)MetaLanguage.Instance.InternalSyntaxFactory.Parameter(annotation == null ? null : annotation.Green, (Syntax.InternalSyntax.TypeReferenceGreen)typeReference.Green, (Syntax.InternalSyntax.NameGreen)name.Green).CreateRed();
		}
		...
		public AssociationDeclarationSyntax AssociationDeclaration(SyntaxNodeList<AnnotationSyntax> annotation, SyntaxToken kAssociation, QualifierSyntax source, SyntaxToken kWith, QualifierSyntax target, SyntaxToken tSemicolon)
		{
		    ...
		    if (tSemicolon == null) throw new ArgumentNullException(nameof(tSemicolon));
		    if (tSemicolon.RawKind != (int)MetaSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
		    return (AssociationDeclarationSyntax)MetaLanguage.Instance.InternalSyntaxFactory.AssociationDeclaration(annotation == null ? null : annotation.Green, (InternalSyntaxToken)kAssociation.Green, (Syntax.InternalSyntax.QualifierGreen)source.Green, (InternalSyntaxToken)kWith.Green, (Syntax.InternalSyntax.QualifierGreen)target.Green, (InternalSyntaxToken)tSemicolon.Green).CreateRed();
		}
		
		public AssociationDeclarationSyntax AssociationDeclaration(QualifierSyntax source, QualifierSyntax target)
		{
			return this.AssociationDeclaration(null, this.Token(MetaSyntaxKind.KAssociation), source, this.Token(MetaSyntaxKind.KWith), target, this.Token(MetaSyntaxKind.TSemicolon));
		}
		
		public IdentifierSyntax Identifier(SyntaxToken identifier)
		{
		    if (identifier == null) throw new ArgumentNullException(nameof(identifier));
		    return (IdentifierSyntax)MetaLanguage.Instance.InternalSyntaxFactory.Identifier((InternalSyntaxToken)identifier.Green).CreateRed();
		}
		...
		public NullLiteralSyntax NullLiteral(SyntaxToken kNull)
		{
		    ...
		    return (NullLiteralSyntax)MetaLanguage.Instance.InternalSyntaxFactory.NullLiteral((InternalSyntaxToken)kNull.Green).CreateRed();
		}
		...
		{
		    if (booleanLiteral == null) throw new ArgumentNullException(nameof(booleanLiteral));
		    return (BooleanLiteralSyntax)MetaLanguage.Instance.InternalSyntaxFactory.BooleanLiteral((InternalSyntaxToken)booleanLiteral.Green).CreateRed();
		}
		...
		public IntegerLiteralSyntax IntegerLiteral(SyntaxToken lInteger)
		{
		    ...
		    return (IntegerLiteralSyntax)MetaLanguage.Instance.InternalSyntaxFactory.IntegerLiteral((InternalSyntaxToken)lInteger.Green).CreateRed();
		}
		...
		public DecimalLiteralSyntax DecimalLiteral(SyntaxToken lDecimal)
		{
		    ...
		    return (DecimalLiteralSyntax)MetaLanguage.Instance.InternalSyntaxFactory.DecimalLiteral((InternalSyntaxToken)lDecimal.Green).CreateRed();
		}
