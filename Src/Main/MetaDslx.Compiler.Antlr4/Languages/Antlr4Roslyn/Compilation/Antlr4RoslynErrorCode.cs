...
namespace MetaDslx.Languages.Antlr4Roslyn.Compilation
{
    public class Antlr4RoslynErrorCode : ErrorCode
    {
        ...
        public static readonly Antlr4RoslynErrorCode ERR_Antlr4Error = new Antlr4RoslynErrorCode(11, DiagnosticSeverity.Error, 0, "ANTLR4 error: {0}");
        public static readonly Antlr4RoslynErrorCode WRN_Antlr4Warning = new Antlr4RoslynErrorCode(12, DiagnosticSeverity.Warning, 1, "ANTLR4 warning: {0}");
        public static readonly Antlr4RoslynErrorCode INF_Antlr4Info = new Antlr4RoslynErrorCode(13, DiagnosticSeverity.Info, 0, "ANTLR4 info: {0}");
