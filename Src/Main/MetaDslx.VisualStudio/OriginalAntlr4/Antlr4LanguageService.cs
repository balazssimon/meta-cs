...
{
    public class Antlr4LanguageAuthoringScope : AuthoringScope
    {
	...
	public class Antlr4LanguageColorizer : Colorizer
    {
        public Antlr4LanguageColorizer(LanguageService svc, IVsTextLines buffer, IScanner scanner)
        ...
        public override int GetStateAtEndOfLine(int iLine, int iLength, IntPtr pText, int iState)
        {
            ...
            {
                this.Scanner.SetSource(text, 0);
                ((Antlr4LanguageScanner)this.Scanner).ScanLine(ref iState);
            }
            return iState;
        }
    ...
    public abstract class Antlr4LanguageConfigBase
    {
        private static Antlr4LanguageConfig instance = null;
        public static Antlr4LanguageConfig Instance
        {
            get 
            {
                if (instance == null)
                {
					// If there is a compile error in the following line, create a class Antlr4LanguageConfig
					// which is a subclass of Antlr4LanguageConfigBase
                    instance = new Antlr4LanguageConfig();
                }
                return instance;
            }
        }
        private List<Antlr4LanguageColorableItem> colorableItems = new List<Antlr4LanguageColorableItem>();
        public IList<Antlr4LanguageColorableItem> ColorableItems
        {
        ...
        {
            colorableItems.Add(new Antlr4LanguageColorableItem(name, type, (COLORINDEX)(-1), COLORINDEX.CI_USERTEXT_BK, foregroundColor, Color.White, bold, strikethrough));
        ...
        {
            colorableItems.Add(new Antlr4LanguageColorableItem(name, type, foregroundIndex, COLORINDEX.CI_USERTEXT_BK, Color.Black, Color.White, bold, strikethrough));
            return (TokenColor)colorableItems.Count;
        }
        ...
        {
            colorableItems.Add(new Antlr4LanguageColorableItem(name, type, foregroundIndex, backgroundIndex, foregroundColor, backgroundColor, bold, strikethrough));
            return (TokenColor)colorableItems.Count;
        }
    }
    public class Antlr4LanguageColorableItem : IVsColorableItem, IVsHiColorItem
    {
        ...
        public Antlr4LanguageColorableItem(string displayName, TokenType tokenType, COLORINDEX foregroundIndex, COLORINDEX backgroundIndex, Color foregroundColor, Color backgroundColor, bool bold, bool strikethrough)
        {
    ...
    [ComVisible(true)]
    [Guid(Antlr4LanguageConfig.Antlr4GeneratorServiceGuid)]
    [ProvideObject(typeof(Antlr4GeneratorService), RegisterUsing = RegistrationMethod.CodeBase)]
    [CodeGeneratorRegistration(typeof(Antlr4GeneratorService), Antlr4LanguageConfig.GeneratorName, "{fae04ec1-301f-11d3-bf4b-00c04f79efbc}", GeneratorRegKeyName = Antlr4LanguageConfig.FileExtension)]
    [CodeGeneratorRegistration(typeof(Antlr4GeneratorService), Antlr4LanguageConfig.GeneratorServiceName, "{fae04ec1-301f-11d3-bf4b-00c04f79efbc}", GeneratorRegKeyName = Antlr4LanguageConfig.GeneratorName, GeneratesDesignTimeSource = true)]
    public class Antlr4GeneratorService : VsMultipleFileGenerator<object>
    {
        protected override MultipleFileGenerator<object> CreateGenerator(string inputFilePath, string inputFileContents, string defaultNamespace)
        {
            ...
            return new Antlr4Generator(inputFilePath, inputFileContents, defaultNamespace);
        }

        public override string GetDefaultFileExtension()
        {
            return Antlr4Generator.DefaultExtension;
        }
    }
    public class Antlr4LanguageScanner : IScanner
    {
        ...
        public bool ScanTokenAndProvideInfoAboutIt(TokenInfo tokenInfo, ref int state)
        {
            try
            {
                ...
                if (tokenType >= 0 && tokenType < Antlr4LanguageConfig.Instance.ColorableItems.Count)
                {
                    Antlr4LanguageColorableItem colorItem = Antlr4LanguageConfig.Instance.ColorableItems[tokenType];
    ...
    [ComVisible(true)]
    [Guid(Antlr4LanguageConfig.Antlr4LanguageServiceGuid)]
    public class Antlr4LanguageService : LanguageService
    {
        private LanguagePreferences preferences;
        private Antlr4LanguageScanner scanner;
        public Antlr4LanguageService()
        {
			// Creating the config instance
			Antlr4LanguageConfigBase.Instance.ToString();
        }
        public override string GetFormatFilterList()
        {
            return Antlr4LanguageConfig.FilterList;
        }
        public override LanguagePreferences GetLanguagePreferences()
        {
            if (preferences == null)
            {
                preferences = new LanguagePreferences(this.Site, typeof(Antlr4LanguageService).GUID, this.Name);
                preferences.Init();
            }
            return preferences;
        }
        public override IScanner GetScanner(IVsTextLines buffer)
        {
            if (scanner == null)
            {
                scanner = new Antlr4LanguageScanner();
            }
            return scanner;
        }
        public override Microsoft.VisualStudio.Package.Source CreateSource(IVsTextLines buffer)
        {
            return new Antlr4LanguageSource(this, buffer, this.GetColorizer(buffer));
        }
        #region Custom Colors
        public override int GetColorableItem(int index, out IVsColorableItem item)
        {
            if (index >= 0 && index < Antlr4LanguageConfig.Instance.ColorableItems.Count)
            {
                item = Antlr4LanguageConfig.Instance.ColorableItems[index];
                return Microsoft.VisualStudio.VSConstants.S_OK;
            }
            else
            {
                item = Antlr4LanguageConfig.Instance.ColorableItems[0];
                return Microsoft.VisualStudio.VSConstants.S_OK;
            }
        }
        public override int GetItemCount(out int count)
        {
            count = Antlr4LanguageConfig.Instance.ColorableItems.Count;
            return Microsoft.VisualStudio.VSConstants.S_OK;
        }
        #endregion
        public override void OnIdle(bool periodic)
        {
            ...
            Antlr4LanguageSource src = (Antlr4LanguageSource)GetSource(this.LastActiveTextView);
        ...
        {
            get { return Antlr4LanguageConfig.LanguageName; }
        }
        public override ViewFilter CreateViewFilter(CodeWindowManager mgr, IVsTextView newView)
        {
            return new Antlr4LanguageViewFilter(mgr, newView);
        }
        public override Colorizer GetColorizer(IVsTextLines buffer)
        {
            return new Antlr4LanguageColorizer(this, buffer, this.GetScanner(buffer));
        }
        public override AuthoringScope ParseSource(ParseRequest req)
        {
			try
			{
				Antlr4LanguageSource source = (Antlr4LanguageSource)this.GetSource(req.FileName);
				switch (req.Reason)
				{
					case ParseReason.Check:
						...
						var compilation = new MetaDslx.Languages.Antlr4Roslyn.Compilation.OriginalAntlr4Compiler(req.Text, "", inputDir, null, req.FileName);
                        compilation.Compile();
            ...
            return new Antlr4LanguageAuthoringScope();
        }
    }
	public class Antlr4LanguageSource : Microsoft.VisualStudio.Package.Source
    {
        public Antlr4LanguageSource(LanguageService service, IVsTextLines textLines, Colorizer colorizer)
            : base(service, textLines, colorizer)
        {
        }
    }
    public class Antlr4LanguageViewFilter : ViewFilter
    {
        public Antlr4LanguageViewFilter(CodeWindowManager mgr, IVsTextView view)
            : base(mgr, view)
        {
        }
