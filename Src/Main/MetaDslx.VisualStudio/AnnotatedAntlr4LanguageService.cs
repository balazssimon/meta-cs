...
namespace MetaDslx.VisualStudio
{
    ...
    public abstract class AnnotatedAntlr4LanguageConfigBase
    {
        ...
        {
            colorableItems.Add(new AnnotatedAntlr4LanguageColorableItem(name, type, foreground, background, bold, strikethrough));
    ...
    public class AnnotatedAntlr4LanguageColorableItem : Microsoft.VisualStudio.TextManager.Interop.IVsColorableItem
    {
        ...
        public AnnotatedAntlr4LanguageColorableItem(string displayName, TokenType tokenType, COLORINDEX foreground, COLORINDEX background, bool bold, bool strikethrough)
        {
