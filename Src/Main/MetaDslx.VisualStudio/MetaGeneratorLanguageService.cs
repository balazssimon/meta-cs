...
namespace MetaDslx.VisualStudio
{
    ...
    public abstract class MetaGeneratorLanguageConfigBase
    {
        ...
        {
            colorableItems.Add(new MetaGeneratorLanguageColorableItem(name, type, foreground, background, bold, strikethrough));
            return (TokenColor)colorableItems.Count;
        }
    }
    public class MetaGeneratorLanguageColorableItem : Microsoft.VisualStudio.TextManager.Interop.IVsColorableItem
    {
        ...
        public MetaGeneratorLanguageColorableItem(string displayName, TokenType tokenType, COLORINDEX foreground, COLORINDEX background, bool bold, bool strikethrough)
        {
