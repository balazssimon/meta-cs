...
namespace MetaDslx.VisualStudio
{
    ...
    public abstract class MetaGeneratorLanguageConfigBase
    {
        ...
        {
            colorableItems.Add(new MetaGeneratorLanguageColorableItem(name, foreground, background, bold, strikethrough));
    ...
    public class MetaGeneratorLanguageColorableItem : Microsoft.VisualStudio.TextManager.Interop.IVsColorableItem
    {
        ...
        public MetaGeneratorLanguageColorableItem(string displayName, COLORINDEX foreground, COLORINDEX background, bool bold, bool strikethrough)
        {
