...
namespace MetaDslx.VisualStudio
{
    ...
    public abstract class AnnotatedAntlr4LanguageConfigBase
    {
        ...
        {
            colorableItems.Add(new AnnotatedAntlr4LanguageColorableItem(name, foreground, background, bold, strikethrough));
    ...
    public class AnnotatedAntlr4LanguageColorableItem : Microsoft.VisualStudio.TextManager.Interop.IVsColorableItem
    {
        private string displayName;
        private COLORINDEX background;
        private COLORINDEX foreground;
        private uint fontFlags = (uint)FONTFLAGS.FF_DEFAULT;
        public AnnotatedAntlr4LanguageColorableItem(string displayName, COLORINDEX foreground, COLORINDEX background, bool bold, bool strikethrough)
        {
    ...
    public class AnnotatedAntlr4LanguageScanner : IScanner
    {
        ...
        public AnnotatedAntlr4LanguageScanner()
        {
            ...
            this.lastState = 0;
            AnnotatedAntlr4LexerAnnotator annotator = new MetaDslx.Compiler.AnnotatedAntlr4LexerAnnotator();
